...
public class CustomerCustomPersistenceHandlerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerCustomPersistenceHandler} (default constructor).
  ...
  public void testCanHandleAdd_givenCustomerCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    CustomerCustomPersistenceHandler customerCustomPersistenceHandler =
        new CustomerCustomPersistenceHandler();
  ...
  public void testCanHandleUpdate_givenCustomerCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    CustomerCustomPersistenceHandler customerCustomPersistenceHandler =
        new CustomerCustomPersistenceHandler();
  ...
  public void testCanHandleRemove_givenCustomerCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    CustomerCustomPersistenceHandler customerCustomPersistenceHandler =
        new CustomerCustomPersistenceHandler();
  ...
  public void testAdd_givenCustomerCustomPersistenceHandler_thenThrowServiceException()
  ...
  public void testValidateUniqueUsername_givenCustomerCustomPersistenceHandler() {
    // Arrange
    CustomerCustomPersistenceHandler customerCustomPersistenceHandler =
        new CustomerCustomPersistenceHandler();
  ...
  public void testValidateUniqueUsername_givenPropertyWithNameAndValueIs42() {
    // Arrange
    when(customerService.readCustomerByUsername(Mockito.<String>any()))
        .thenReturn(new CustomerImpl());
  ...
  public void testValidateUniqueUsername_thenReturnEntity() {
    // Arrange
    when(customerService.readCustomerByUsername(Mockito.<String>any()))
        .thenReturn(new CustomerImpl());
  ...
  public void testRemove_givenCustomerCustomPersistenceHandler() throws ServiceException {
    // Arrange
    CustomerCustomPersistenceHandler customerCustomPersistenceHandler =
        new CustomerCustomPersistenceHandler();
