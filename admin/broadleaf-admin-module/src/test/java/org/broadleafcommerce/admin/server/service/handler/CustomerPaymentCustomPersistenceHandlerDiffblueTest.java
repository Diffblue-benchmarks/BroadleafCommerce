...
public class CustomerPaymentCustomPersistenceHandlerDiffblueTest {
  ...
  public void testCanHandleInspect_thenReturnFalse() {
    // Arrange
    CustomerPaymentCustomPersistenceHandler customerPaymentCustomPersistenceHandler =
        new CustomerPaymentCustomPersistenceHandler();
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerPaymentCustomPersistenceHandler} (default constructor).
   *   <li>Then return {@code false}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testCanHandleFetch_givenCustomerPaymentCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    CustomerPaymentCustomPersistenceHandler customerPaymentCustomPersistenceHandler =
        new CustomerPaymentCustomPersistenceHandler();
  ...
  public void testBuildPropertyValueIfAvailable_whenEmptyString_thenReturn42() {
    ...
    assertEquals(
        "42",
        new CustomerPaymentCustomPersistenceHandler().buildPropertyValueIfAvailable("", "42"));
  }
  ...
  public void testBuildPropertyValueIfAvailable_whenNull_thenReturnEmptyString() {
    ...
    assertEquals(
        "",
        new CustomerPaymentCustomPersistenceHandler()
            .buildPropertyValueIfAvailable("", "****null"));
  }
  ...
  public void testBuildPropertyValueIfAvailable_whenNull_thenReturnEmptyString2() {
    // Arrange, Act and Assert
    assertEquals(
        "", new CustomerPaymentCustomPersistenceHandler().buildPropertyValueIfAvailable("", null));
  }
}
