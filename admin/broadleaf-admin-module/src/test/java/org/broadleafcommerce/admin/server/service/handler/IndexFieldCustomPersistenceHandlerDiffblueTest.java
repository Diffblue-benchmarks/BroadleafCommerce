...
public class IndexFieldCustomPersistenceHandlerDiffblueTest {
  ...
  private IndexFieldCustomPersistenceHandlerExtensionManager indexFieldCustomPersistenceHandlerExtensionManager;
   ...
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#canHandleAdd(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.lang.Boolean IndexFieldCustomPersistenceHandler.canHandleAdd(PersistencePackage)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#canHandleUpdate(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.lang.Boolean IndexFieldCustomPersistenceHandler.canHandleUpdate(PersistencePackage)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#canHandleRemove(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.lang.Boolean IndexFieldCustomPersistenceHandler.canHandleRemove(PersistencePackage)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#canHandleFetch(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.lang.Boolean IndexFieldCustomPersistenceHandler.canHandleFetch(PersistencePackage)"})
  ...
  /**
   * Test {@link IndexFieldCustomPersistenceHandler#remove(PersistencePackage, DynamicEntityDao, RecordHelper)}.
   * <ul>
   *   <li>Then throw {@link ServiceException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#remove(PersistencePackage, DynamicEntityDao, RecordHelper)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testRemove_thenThrowServiceException() throws ServiceException {
    ...
    verify(helper).getSimpleMergedProperties(eq("org.broadleafcommerce.core.search.domain.IndexField"), isNull());
  }

  /**
   * Test {@link IndexFieldCustomPersistenceHandler#update(PersistencePackage, DynamicEntityDao, RecordHelper)}.
   * <ul>
   *   <li>Then throw {@link ServiceException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#update(PersistencePackage, DynamicEntityDao, RecordHelper)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link IndexFieldCustomPersistenceHandler#add(PersistencePackage, DynamicEntityDao, RecordHelper)}.
   * <ul>
   *   <li>Given {@link Entity} {@link Entity#getType()} return array of {@link String} with {@code Type}.</li>
   *   <li>Then throw {@link ServiceException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#add(PersistencePackage, DynamicEntityDao, RecordHelper)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link IndexFieldCustomPersistenceHandler#fetch(PersistencePackage, CriteriaTransferObject, DynamicEntityDao, RecordHelper)}.
   * <ul>
   *   <li>Then return {@link DynamicResultSet#DynamicResultSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IndexFieldCustomPersistenceHandler#fetch(PersistencePackage, CriteriaTransferObject, DynamicEntityDao, RecordHelper)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
