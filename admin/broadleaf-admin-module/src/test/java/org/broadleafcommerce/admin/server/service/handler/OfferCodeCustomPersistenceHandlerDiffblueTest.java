...
public class OfferCodeCustomPersistenceHandlerDiffblueTest {
  ...
  public void testCanHandleAdd_thenThrowRuntimeException() {
    // Arrange
    OfferCodeCustomPersistenceHandler offerCodeCustomPersistenceHandler =
        new OfferCodeCustomPersistenceHandler();
   ...
   *
   * <ul>
   *   <li>Given {@link OfferCodeCustomPersistenceHandler} (default constructor).
  ...
  public void testAdd_givenOfferCodeCustomPersistenceHandler_thenThrowServiceException()
    ...
    validationErrors.put("offerCode", new ArrayList<>());

    Entity entity = mock(Entity.class);
    when(entity.getType()).thenReturn(new String[] {"Type"});
    doNothing().when(entity).setPropertyValidationErrors(Mockito.<Map<String, List<String>>>any());
    ...
    verify(entity).setPropertyValidationErrors(isA(Map.class));
  }
  ...
  public void testUpdate_givenOfferCodeCustomPersistenceHandler_thenThrowServiceException()
      throws ServiceException {
    // Arrange
    OfferCodeCustomPersistenceHandler offerCodeCustomPersistenceHandler =
        new OfferCodeCustomPersistenceHandler();
  ...
  public void testValidateOfferCode_givenOfferCodeCustomPersistenceHandler() {
    // Arrange
    OfferCodeCustomPersistenceHandler offerCodeCustomPersistenceHandler =
        new OfferCodeCustomPersistenceHandler();
    Entity entity = new Entity();
  ...
  public void testCheckIfOfferHasAdditionStatusNew() {
    ...
    assertTrue(
        new OfferCodeCustomPersistenceHandler().checkIfOfferHasAdditionStatusNew(1L).isEmpty());
  }
}
