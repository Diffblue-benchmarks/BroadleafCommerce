...
public class OfferCustomPersistenceHandlerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link OfferCustomPersistenceHandler} (default constructor).
  ...
  public void testCanHandleInspect_givenOfferCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    OfferCustomPersistenceHandler offerCustomPersistenceHandler =
        new OfferCustomPersistenceHandler();
  ...
  public void testCanHandleFetch_givenOfferCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    OfferCustomPersistenceHandler offerCustomPersistenceHandler =
        new OfferCustomPersistenceHandler();
    Entity entity = new Entity();
    ...
    Boolean actualCanHandleFetchResult =
        offerCustomPersistenceHandler.canHandleFetch(persistencePackage);
  ...
  public void testCanHandleUpdate_givenOfferCustomPersistenceHandler_thenReturnFalse() {
    // Arrange
    OfferCustomPersistenceHandler offerCustomPersistenceHandler =
        new OfferCustomPersistenceHandler();
    Entity entity = new Entity();
    ...
    Boolean actualCanHandleUpdateResult =
        offerCustomPersistenceHandler.canHandleUpdate(persistencePackage);
  ...
  public void testStripTrailingZeros_givenOfferCustomPersistenceHandler_when42_thenReturn42() {
    ...
    assertEquals(
        "42", new OfferCustomPersistenceHandler().stripTrailingZeros("42", "Decimal Separator"));
  }
   ...
   *
   * <ul>
   *   <li>Then return RawValue is {@link Boolean#TRUE} toString.
   * </ul>
   *
   * <p>Method under test: {@link
   * OfferCustomPersistenceHandler#buildAdvancedVisibilityOptionsProperty(Property)}
  ...
  public void testBuildAdvancedVisibilityOptionsProperty_whenPropertyWithNameAndValueIs42() {
    // Arrange
    OfferCustomPersistenceHandler offerCustomPersistenceHandler =
        new OfferCustomPersistenceHandler();
  ...
  public void testBuildQualifiersCanBeQualifiersProperty_whenNull() {
    // Arrange and Act
    Property actualBuildQualifiersCanBeQualifiersPropertyResult =
        new OfferCustomPersistenceHandler().buildQualifiersCanBeQualifiersProperty(null);
  ...
  public void testBuildQualifiersCanBeTargetsProperty_whenNull() {
    // Arrange and Act
    Property actualBuildQualifiersCanBeTargetsPropertyResult =
        new OfferCustomPersistenceHandler().buildQualifiersCanBeTargetsProperty(null);
  ...
  public void testBuildStackableProperty_whenNull_thenMetadataReturnBasicFieldMetadata() {
    // Arrange and Act
    Property actualBuildStackablePropertyResult =
        new OfferCustomPersistenceHandler().buildStackableProperty(null);
  ...
  public void testUpdate_givenOfferCustomPersistenceHandler_thenThrowNumberFormatException()
  ...
  public void testValidateOfferValue_givenPropertyWithNameAndValueIs42()
    ...
    // Assert
    verify(entity).findProperty("discountType");
  }
  ...
  public void testBuildOfferItemTargetRuleTypeProperty_whenNull_thenReturnRawValueIsNone() {
    // Arrange and Act
    Property actualBuildOfferItemTargetRuleTypePropertyResult =
        new OfferCustomPersistenceHandler().buildOfferItemTargetRuleTypeProperty(null);
