...
public class ProductOptionsCustomPersistenceHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.lang.Boolean ProductOptionsCustomPersistenceHandler.canHandleUpdate(PersistencePackage)"
  })
  public void testCanHandleUpdate_thenReturnFalse() {
    ...
    // Act and Assert
    assertFalse(productOptionsCustomPersistenceHandler.canHandleUpdate(persistencePackage));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.lang.Boolean ProductOptionsCustomPersistenceHandler.canHandleFetch(PersistencePackage)"
  })
  public void testCanHandleFetch_thenReturnFalse() {
    ...
    // Act and Assert
    assertFalse(productOptionsCustomPersistenceHandler.canHandleFetch(persistencePackage));
  }
  ...
  public void testValidateProductOption() {
    ...
    verify(productOptionDao).countAllowedValuesForProductOptionById(isNull());
  ...
  public void testValidateProductOption3() {
    // Arrange
    when(productOptionDao.countAllowedValuesForProductOptionById(Mockito.<Long>any()))
        .thenReturn(0L);
    when(sandBoxHelper.isReplayOperation()).thenReturn(false);
  ...
  public void testValidateProductOption_givenProductOptionsCustomPersistenceHandler() {
    // Arrange
