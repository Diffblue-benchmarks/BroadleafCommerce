...
public class SkuCustomPersistenceHandlerDiffblueTest {
   ...
   *       is {@link AdornedTargetList#AdornedTargetList()}.
   * </ul>
   *
   * <p>Method under test: {@link SkuCustomPersistenceHandler#canHandle(PersistencePackage,
   * OperationType)}
  ...
  public void testCanHandle_givenHashMapAdornedtargetlistIsAdornedTargetList() {
    // Arrange
    SkuCustomPersistenceHandler skuCustomPersistenceHandler = new SkuCustomPersistenceHandler();
  ...
  public void testGetOwningProductId_whenNull_thenReturnNull() {
    ...
    assertNull(new SkuCustomPersistenceHandler().getOwningProductId(null));
  }
  ...
  public void testCreateIndividualOptionField() {
    ...
    option.setProductOptionValidationType(new ProductOptionValidationType());
    option.setProductXrefs(new ArrayList<>());
    option.setRequired(true);
    option.setType(new ProductOptionType());
   ...
   *
   * <ul>
   *   <li>Given {@link SkuCustomPersistenceHandler} (default constructor).
   *   <li>Then return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testCreateIndividualOptionField_givenSkuCustomPersistenceHandler_thenReturnNull() {
    // Arrange
    SkuCustomPersistenceHandler skuCustomPersistenceHandler = new SkuCustomPersistenceHandler();
  ...
  public void testAdd_givenSkuCustomPersistenceHandler_thenThrowServiceException()
      throws ServiceException {
    // Arrange
    SkuCustomPersistenceHandler skuCustomPersistenceHandler = new SkuCustomPersistenceHandler();
  ...
  public void testGetPolymorphicClasses_thenReturnArrayLengthIsZero() {
    // Arrange
    SkuCustomPersistenceHandler skuCustomPersistenceHandler = new SkuCustomPersistenceHandler();
