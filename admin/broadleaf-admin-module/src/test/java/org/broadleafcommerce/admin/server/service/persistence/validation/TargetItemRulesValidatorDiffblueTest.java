...
public class TargetItemRulesValidatorDiffblueTest {
  @Autowired
  private TargetItemRulesValidator targetItemRulesValidator;

  /**
   * Test
   * {@link TargetItemRulesValidator#validate(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)}.
   * <p>
   * Method under test:
   * {@link TargetItemRulesValidator#validate(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)}
   */
  ...
  public void testValidate() {
    ...
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.admin.server.service.persistence.validation.TargetItemRulesValidator targetItemRulesValidator;
    ...
    // Arrange
    TargetItemRulesValidator targetItemRulesValidator2 = new TargetItemRulesValidator();
    ...
    // Act
    targetItemRulesValidator2.validate(entity, instance, entityFieldMetadata, validationConfiguration,
