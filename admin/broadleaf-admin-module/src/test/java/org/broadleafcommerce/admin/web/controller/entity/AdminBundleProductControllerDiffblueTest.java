...
@ContextConfiguration(classes = {AdminBundleProductController.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class AdminBundleProductControllerDiffblueTest {
  ...
  @Autowired
  private AdminBundleProductController adminBundleProductController;
  ...
  /**
   * Test
   * {@link AdminBundleProductController#viewEntityForm(HttpServletRequest, HttpServletResponse, Model, Map, String)}.
   * <p>
   * Method under test:
   * {@link AdminBundleProductController#viewEntityForm(HttpServletRequest, HttpServletResponse, Model, Map, String)}
   */
  ...
  public void testViewEntityForm() throws Exception {
    ...
    //   when running class:
    //   package org.broadleafcommerce.admin.web.controller.entity;
    //   @org.springframework.test.context.ContextConfiguration(classes = {org.broadleafcommerce.admin.web.controller.entity.AdminBundleProductController.class})
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass350 {
    ...
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.admin.web.controller.entity.AdminBundleProductController adminBundleProductController;
    ...
    // Arrange
    MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/product:bundle/{id}", "42");

    // Act
    MockMvcBuilders.standaloneSetup(adminBundleProductController).build().perform(requestBuilder);
  }
}
