...
public class FulfillmentTypeEnumOptionsExtensionListenerDiffblueTest {
  ...
  /**
   * Test
   * {@link FulfillmentTypeEnumOptionsExtensionListener#getValuesToGenerate()}.
   * <p>
   * Method under test:
   * {@link FulfillmentTypeEnumOptionsExtensionListener#getValuesToGenerate()}
   */
  ...
  public void testGetValuesToGenerate() {
    ...
    // Arrange and Act
    Map<String, Class<? extends BroadleafEnumerationType>> actualValuesToGenerate = (new FulfillmentTypeEnumOptionsExtensionListener())
        .getValuesToGenerate();
  ...
  public void testGetValuesToGenerate2() {
    ...
    //   public class DiffblueFakeClass293 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.admin.web.rulebuilder.service.options.FulfillmentTypeEnumOptionsExtensionListener fulfillmentTypeEnumOptionsExtensionListener;
    ...
    // Arrange and Act
    (new FulfillmentTypeEnumOptionsExtensionListener()).getValuesToGenerate();
  }
}
