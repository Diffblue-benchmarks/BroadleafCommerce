...
public class TemplateTypeEnumOptionsExtensionListenerDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link TemplateTypeEnumOptionsExtensionListener#getValuesToGenerate()}
   */
  @Test
  public void testGetValuesToGenerate() {
    ...
    // Arrange and Act
    Map<String, Class<? extends BroadleafEnumerationType>> actualValuesToGenerate = (new TemplateTypeEnumOptionsExtensionListener())
        .getValuesToGenerate();
  ...
  public void testGetValuesToGenerate2() {
    ...
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.admin.web.rulebuilder.service.options.TemplateTypeEnumOptionsExtensionListener templateTypeEnumOptionsExtensionListener;
    ...
    // Arrange and Act
    (new TemplateTypeEnumOptionsExtensionListener()).getValuesToGenerate();
  }
}
