...
public class NonAutoconfigMultiPartConfigurationDiffblueTest {
   ...
   * <ul>
   *   <li>Then FileUpload return {@link ServletFileUpload}.</li>
   * </ul>
   * <p>
   * Method under test: {@link NonAutoconfigMultiPartConfiguration#multipartResolver(Environment)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"MultipartResolver NonAutoconfigMultiPartConfiguration.multipartResolver(Environment)"})
  public void testMultipartResolver_thenFileUploadReturnServletFileUpload() {
    // Arrange
