...
public class ImageStaticAssetImplDiffblueTest {
  ...
  @MethodsUnderTest({"void ImageStaticAssetImpl.<init>()", "Integer ImageStaticAssetImpl.getHeight()",
      "Integer ImageStaticAssetImpl.getWidth()", "void ImageStaticAssetImpl.setHeight(Integer)",
