...
public class StaticAssetStorageServiceImplDiffblueTest {
  ...
  public void testShouldUseSharedFile_thenReturnFalse() throws UnsupportedEncodingException {
    // Arrange
    StaticAssetStorageServiceImpl staticAssetStorageServiceImpl =
        new StaticAssetStorageServiceImpl();

    // Act
    boolean actualShouldUseSharedFileResult =
        staticAssetStorageServiceImpl.shouldUseSharedFile(
            new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));

    // Assert
    assertFalse(actualShouldUseSharedFileResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean StaticAssetStorageServiceImpl.shouldUseSharedFile(InputStream)"})
  public void testShouldUseSharedFile_thenReturnTrue() throws UnsupportedEncodingException {
    // Arrange
    StaticAssetStorageServiceImpl staticAssetStorageServiceImpl =
        new StaticAssetStorageServiceImpl();
    ...
    // Assert
    assertTrue(actualShouldUseSharedFileResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean StaticAssetStorageServiceImpl.shouldUseSharedFile(InputStream)"})
  public void testShouldUseSharedFile_whenNull_thenReturnFalse() {
  ...
  public void testLookupAssetAndCreateLocalFile2() throws Throwable {
    // Arrange
  ...
  public void testLookupAssetAndCreateLocalFile4() throws IOException, SQLException {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then calls {@link StaticAsset#getFullUrl()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * StaticAssetStorageServiceImpl#lookupAssetAndCreateLocalFile(StaticAsset, File)}
  ...
  public void testLookupAssetAndCreateLocalFile_thenCallsGetFullUrl()
    ...
    when(staticAsset.getFullUrl()).thenThrow(new RuntimeException());
    when(staticAsset.getStorageType()).thenReturn(StorageType.FILESYSTEM);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Map StaticAssetStorageServiceImpl.getCacheFileModel(String, Map)"})
  public void testGetCacheFileModel6() throws Exception {
    // Arrange
    when(broadleafFileService.getLocalResource(Mockito.<String>any()))
        .thenThrow(new RuntimeException());
    when(broadleafFileService.getSharedLocalResource(Mockito.<String>any()))
  ...
  public void testShouldRecompress_whenImagePng_thenReturnTrue() {
    // Arrange, Act and Assert
    assertTrue(new StaticAssetStorageServiceImpl().shouldRecompress("image/png"));
  }
  ...
  public void testShouldRecompress_whenTextPlain_thenReturnFalse() {
    // Arrange, Act and Assert
    assertFalse(new StaticAssetStorageServiceImpl().shouldRecompress("text/plain"));
  }
  ...
  public void testBuildModel() {
    ...
    Map<String, String> actualBuildModelResult =
        new StaticAssetStorageServiceImpl().buildModel("/directory/foo.txt", "text/plain");
  ...
  public void testCreateStaticAssetStorageFromFile() throws IOException {
    // Arrange
    when(broadleafFileService.initializeWorkArea()).thenThrow(new RuntimeException());
   ...
   *
   * <ul>
   *   <li>Then calls {@link StaticAssetStorageDao#create()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * StaticAssetStorageServiceImpl#createStaticAssetStorageFromFile(MultipartFile, StaticAsset)}
  ...
  public void testCreateStaticAssetStorageFromFile_thenCallsCreate() throws IOException {
    // Arrange
    when(staticAssetStorageDao.create()).thenThrow(new RuntimeException());
    MockMultipartFile file =
        new MockMultipartFile("Name", new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    ...
    assertThrows(
        RuntimeException.class,
        () ->
            staticAssetStorageServiceImpl.createStaticAssetStorageFromFile(
                file, new ImageStaticAssetImpl()));
    verify(staticAssetStorageDao).create();
  }
  ...
  public void testCreateStaticAssetStorage() throws IOException {
    ...
    assertThrows(
        RuntimeException.class,
        () ->
            staticAssetStorageServiceImpl.createStaticAssetStorage(
                fileInputStream, new ImageStaticAssetImpl()));
    verify(staticAssetStorageDao).create();
  }
  ...
  public void testCreateStaticAssetStorage_thenThrowAssetNotFoundException() throws IOException {
    // Arrange
    when(staticAssetStorageDao.create()).thenThrow(new AssetNotFoundException("An error occurred"));
    ByteArrayInputStream fileInputStream = new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8"));

    ImageStaticAssetImpl staticAsset = mock(ImageStaticAssetImpl.class);
    when(staticAsset.getStorageType()).thenReturn(new StorageType("DATABASE", "Friendly Type"));
  ...
  public void testGetMaxUploadSizeForFile() {
    // Arrange
    when(multipartProperties.createMultipartConfig()).thenThrow(new RuntimeException());
    ...
    verify(multipartProperties).createMultipartConfig();
    verify(environment)
        .getProperty(
  ...
  public void testGetMaxUploadSizeForFile_givenEnvironmentGetPropertyReturnOne_thenReturnOne() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(1L);
    when(environment.getProperty(Mockito.<String>any(), eq(String.class), Mockito.<String>any()))
        .thenReturn("Property");
  ...
  public void testGetMaxUploadSizeForFile_givenEnvironmentGetPropertyThrowRuntimeException2() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class)))
        .thenThrow(new RuntimeException());
    when(environment.getProperty(Mockito.<String>any(), eq(String.class), Mockito.<String>any()))
        .thenReturn("Property");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadSizeForFile(String)"})
  public void testGetMaxUploadSizeForFile_thenReturnMinusOne() {
    // Arrange
    when(multipartProperties.createMultipartConfig())
        .thenReturn(new MultipartConfigElement("Location"));
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(null);
    when(environment.getProperty(Mockito.<String>any(), eq(String.class), Mockito.<String>any()))
        .thenReturn("Property");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadSizeForFile(String)"})
  public void testGetMaxUploadSizeForFile_thenReturnMinusOne2() {
    // Arrange
    when(multipartProperties.createMultipartConfig())
        .thenReturn(new MultipartConfigElement("Location"));
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(null);
    ...
    // Act
    long actualMaxUploadSizeForFile = staticAssetStorageServiceImpl.getMaxUploadSizeForFile(".");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadSizeForFile(String)"})
  public void testGetMaxUploadSizeForFile_thenReturnOne() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(1L);
    when(environment.getProperty(Mockito.<String>any(), eq(String.class), Mockito.<String>any()))
        .thenReturn("");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadableFileSize()"})
  public void testGetMaxUploadableFileSize_givenEnvironmentGetPropertyThrowRuntimeException() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class)))
        .thenThrow(new RuntimeException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadableFileSize()"})
  public void testGetMaxUploadableFileSize_thenReturnMinusOne() {
    // Arrange
    when(multipartProperties.createMultipartConfig())
        .thenReturn(new MultipartConfigElement("Location"));
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadableImageSize()"})
  public void testGetMaxUploadableImageSize_givenEnvironmentGetPropertyThrowRuntimeException() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class)))
        .thenThrow(new RuntimeException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"long StaticAssetStorageServiceImpl.getMaxUploadableImageSize()"})
  public void testGetMaxUploadableImageSize_thenReturnMinusOne() {
    // Arrange
    when(multipartProperties.createMultipartConfig())
        .thenReturn(new MultipartConfigElement("Location"));
    when(environment.getProperty(Mockito.<String>any(), eq(Long.class))).thenReturn(null);
