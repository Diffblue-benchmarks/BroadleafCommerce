...
public class PageRuleImplDiffblueTest {
  ...
  public void testCloneEntity() {
    ...
    // Act
    PageRule actualCloneEntityResult = pageRuleImpl2.cloneEntity();

    // Assert
    assertTrue(actualCloneEntityResult instanceof PageRuleImpl);
    assertEquals(pageRuleImpl2, actualCloneEntityResult);
  }

  /**
   * Test {@link PageRuleImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.
   * <p>
   * Method under test: {@link PageRuleImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"CreateResponse PageRuleImpl.createOrRetrieveCopyInstance(MultiTenantCopyContext)"})
  public void testCreateOrRetrieveCopyInstance() throws CloneNotSupportedException {
    ...
    // Act
    CreateResponse<PageRule> actualCreateOrRetrieveCopyInstanceResult = pageRuleImpl2
  ...
  public void testCreateOrRetrieveCopyInstance_givenJavaLangObject_thenCloneReturnPageRuleImpl()
    ...
    assertEquals(pageRuleImpl2, clone);
  }
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PageRuleImpl.<init>()", "Long PageRuleImpl.getId()", "String PageRuleImpl.getMatchRule()",
      "void PageRuleImpl.setId(Long)", "void PageRuleImpl.setMatchRule(String)"})
