...
public class PageTemplateFieldGroupXrefImplDiffblueTest {
  ...
  /**
   * Test {@link PageTemplateFieldGroupXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.
   * <p>
   * Method under test: {@link PageTemplateFieldGroupXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
