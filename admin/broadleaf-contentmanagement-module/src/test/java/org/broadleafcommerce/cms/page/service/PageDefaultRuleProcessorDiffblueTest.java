...
public class PageDefaultRuleProcessorDiffblueTest {
  ...
  public void testCheckForMatchWithPageDTOMap() {
    ...
    when(page.getRuleExpression()).thenReturn("getCategoryAttributesMap()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetAdditionalAttributesXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getAdditionalAttributes()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetAdditionalFieldsXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getAdditionalFields()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetCustomerAttributesXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getCustomerAttributes()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetOrderItemAttributesXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getOrderItemAttributes()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetProductAttributesXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getProductAttributes()[xx]");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_givenGetSkuAttributesXx() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getSkuAttributes()[xx]");
   ...
   *
   * <ul>
   *   <li>When {@link HashMap#HashMap()} {@code getCategoryAttributesMap()[xx]} is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link PageDefaultRuleProcessor#checkForMatch(PageDTO, Map)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean PageDefaultRuleProcessor.checkForMatch(PageDTO, Map)"})
  public void testCheckForMatchWithPageDTOMap_whenHashMapGetCategoryAttributesMapXxIs42() {
    // Arrange
    NullPageDTO page = mock(NullPageDTO.class);
    when(page.getRuleExpression()).thenReturn("getProductAttributes()[xx]");

    HashMap<String, Object> vars = new HashMap<>();
    vars.put("getCategoryAttributesMap()[xx]", "42");
