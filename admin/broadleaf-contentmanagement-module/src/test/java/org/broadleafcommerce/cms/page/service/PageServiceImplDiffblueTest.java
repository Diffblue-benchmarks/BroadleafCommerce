...
public class PageServiceImplDiffblueTest {
  ...
  public void testGetPageDTOListForURI_givenPageServiceImpl_thenReturnNull() {
    // Arrange
    ...
    // Act and Assert
    assertNull(pageServiceImpl.getPageDTOListForURI(locale, null, true));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link PageTemplateImpl} (default constructor) FieldGroupXrefs is {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link PageServiceImpl#addPageListToPageDTOList(List, boolean, List)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void PageServiceImpl.addPageListToPageDTOList(List, boolean, List)"})
  public void testAddPageListToPageDTOList_givenPageTemplateImplFieldGroupXrefsIsArrayList() {
    // Arrange
    PageDTO pageDTO = new PageDTO();
    when(pageServiceUtility.buildPageDTO(Mockito.<Page>any(), anyBoolean())).thenReturn(pageDTO);

    PageTemplateImpl pageTemplate = new PageTemplateImpl();
    pageTemplate.setFieldGroupXrefs(new ArrayList<>());
  ...
  public void testGetPageListFromCache_givenPageServiceImpl_whenNull_thenReturnNull() {
   ...
   *
   * <ul>
   *   <li>Then calls {@link PageQueryExtensionManager#getProxy()}.
   * </ul>
   *
  ...
  public void testBuildKeyWithIdentifierLocaleCodeSecureResultType_thenCallsGetProxy() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildKey(String, String, Boolean, ResultType)"})
  public void testBuildKeyWithIdentifierLocaleCodeSecureResultType_thenReturn42En() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildKey(String, String, Boolean, ResultType)"})
  public void testBuildKeyWithIdentifierLocaleCodeSecureResultType_thenReturn42EnTrue2() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildKey(String, String, Boolean, ResultType)"})
  public void testBuildKeyWithIdentifierLocaleCodeSecureResultType_thenReturn42True() {
    // Arrange, Act and Assert
  ...
  public void testBuildKeyWithIdentifierLocaleSecure_givenBroadleafCurrencyImpl_thenReturn42En() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
    ...
    // Act and Assert
    assertEquals("42-en", pageServiceImpl.buildKey("42", locale, null));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildKey(String, Locale, Boolean)"})
  public void testBuildKeyWithIdentifierLocaleSecure_thenCallsGetProxy() {
    // Arrange
    SparselyPopulatedQueryExtensionHandler sparselyPopulatedQueryExtensionHandler =
        mock(SparselyPopulatedQueryExtensionHandler.class);
    when(sparselyPopulatedQueryExtensionHandler.getCacheKey(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildKey(String, Locale, Boolean)"})
  public void testBuildKeyWithIdentifierLocaleSecure_thenReturn42EnTrue() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
    ...
    // Act and Assert
    assertEquals("42-en-true", pageServiceImpl.buildKey("42", locale, true));
  }
  ...
  public void testBuildBaseKey_givenPageServiceImpl_when42_thenReturn42En() {
    // Arrange, Act and Assert
    assertEquals("42-en", new PageServiceImpl().buildBaseKey("42", "en", null));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildBaseKey(String, String, Boolean)"})
  public void testBuildBaseKey_givenPageServiceImpl_when42_thenReturn42EnTrue() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String PageServiceImpl.buildBaseKey(String, String, Boolean)"})
  public void testBuildBaseKey_givenPageServiceImpl_when42_thenReturn42True() {
    // Arrange, Act and Assert
    assertEquals("42-true", new PageServiceImpl().buildBaseKey("42", null, true));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Locale PageServiceImpl.findLanguageOnlyLocale(Locale)"})
  public void testFindLanguageOnlyLocale_givenPageServiceImpl_whenNull_thenReturnNull() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List PageServiceImpl.copyDTOList(List)"})
  public void testCopyDTOList_givenPageServiceImpl_whenArrayList_thenReturnEmpty() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link LocaleImpl} (default constructor) LocaleCode is {@code null}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageDTO PageServiceImpl.evaluatePageRules(List, Locale, Map)"})
  public void testEvaluatePageRules_givenNull_whenLocaleImplLocaleCodeIsNull_thenReturnPageDTO() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageDTO PageServiceImpl.evaluatePageRules(List, Locale, Map)"})
  public void testEvaluatePageRules_givenPageDTOLocaleCodeIsEn_thenReturnPageDTO() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"PageDTO PageServiceImpl.evaluatePageRules(List, Locale, Map)"})
  public void testEvaluatePageRules_givenPageDTO_whenArrayListAddPageDTO_thenReturnPageDTO() {
    // Arrange
    PageServiceImpl pageServiceImpl = new PageServiceImpl();
   ...
   * <ul>
   *   <li>When {@link ArrayList#ArrayList()}.
   *   <li>Then return {@link PageServiceImpl} (default constructor) {@link
  ...
  public void testEvaluatePageRules_whenNull_thenReturnPageServiceImplNull_page() {
    ...
    // Act
    PageDTO actualEvaluatePageRulesResult =
        pageServiceImpl.evaluatePageRules(null, locale, new HashMap<>());
  ...
  public void testRemovePageFromCache_givenPageServiceImpl_whenNull_thenReturnFalse() {
    // Arrange, Act and Assert
