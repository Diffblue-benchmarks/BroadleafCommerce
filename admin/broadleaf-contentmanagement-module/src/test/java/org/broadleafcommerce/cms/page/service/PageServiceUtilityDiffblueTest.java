...
public class PageServiceUtilityDiffblueTest {
  ...
  public void testBuildPageDTO() {
    ...
    //   public class DiffblueFakeClass2552 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.cms.page.service.PageServiceUtility pageServiceUtility;
    ...
    // Arrange
    PageServiceUtility pageServiceUtility2 = new PageServiceUtility();

    // Act
    pageServiceUtility2.buildPageDTO(new PageImpl(), true);
  }
  ...
  /**
   * Test
   * {@link PageServiceUtility#addPageFieldToDTO(Page, boolean, PageDTO, String)}
   * with {@code page}, {@code secure}, {@code pageDTO}, {@code fieldKey}.
   * <p>
   * Method under test:
   * {@link PageServiceUtility#addPageFieldToDTO(Page, boolean, PageDTO, String)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testAddPageFieldToDTOWithPageSecurePageDTOFieldKey() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing beans when creating Spring context.
    //   Failed to create Spring context due to missing beans
    //   in the current Spring profile:
    ...
    // Act
    pageServiceUtility2.addPageFieldToDTO(page, true, new PageDTO(), "Field Key");
  }

  /**
   * Test
   * {@link PageServiceUtility#addPageFieldToDTO(Page, boolean, PageDTO, String, String)}
   * with {@code page}, {@code secure}, {@code pageDTO}, {@code fieldKey},
   * {@code originalValue}.
   * <p>
   * Method under test:
  ...
  public void testAddPageFieldToDTOWithPageSecurePageDTOFieldKeyOriginalValue() {
    ...
    // Act
    pageServiceUtility2.addPageFieldToDTO(page, true, new PageDTO(), "Field Key", "42");
  }
   ...
   * <p>
   * Method under test:
   * {@link PageServiceUtility#getFieldDefinition(Page, String)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetFieldDefinition() {
    ...
    // Act
    pageServiceUtility2.getFieldDefinition(new PageImpl(), "Field Key");
  }
  ...
  public void testBuildRuleExpression2() {
    ...
    // Act
    pageServiceUtility2.buildRuleExpression(new PageImpl());
  }
  ...
  public void testBuildItemCriteriaDTOList() {
    ...
    // Act
    pageServiceUtility2.buildItemCriteriaDTOList(new PageImpl());
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testHydrateForeignLookups() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing beans when creating Spring context.
    //   Failed to create Spring context due to missing beans
    //   in the current Spring profile:
    ...
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass2632 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.cms.page.service.PageServiceUtility pageServiceUtility;
    //     @org.junit.Test // if JUnit 4
    //     @org.junit.jupiter.api.Test // if JUnit 5
    //     public void testSpringContextLoads() {}
    ...
    // Act
    pageServiceUtility2.hydrateForeignLookups(new PageDTO());
  }
