...
public class PageServiceUtilityDiffblueTest {
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"PageDTO PageServiceUtility.buildPageDTO(Page, boolean)"})
  public void testBuildPageDTO_givenHashSet_thenReturnPageFieldsEmpty() {
    // Arrange
    PageImpl page = mock(PageImpl.class);
    when(page.getPriority()).thenReturn(1);
    when(page.getId()).thenReturn(1L);
   ...
   * <p>
   * Method under test: {@link PageServiceUtility#getFieldDefinition(Page, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testGetFieldDefinition() {
    ...
    // Act
    FieldDefinition actualFieldDefinition = pageServiceUtility.getFieldDefinition(new PageImpl(), "Field Key");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"FieldDefinition PageServiceUtility.getFieldDefinition(Page, String)"})
  public void testGetFieldDefinition_givenPageTemplateImpl_thenCallsGetPageTemplate() {
    // Arrange
    PageServiceExtensionHandler pageServiceExtensionHandler = mock(PageServiceExtensionHandler.class);
    when(pageServiceExtensionHandler.getFieldDefinition(Mockito.<ExtensionResultHolder<FieldDefinition>>any(),
        Mockito.<Page>any(), Mockito.<String>any())).thenReturn(ExtensionResultStatusType.HANDLED_CONTINUE);
    when(pageServiceExtensionManager.getProxy()).thenReturn(pageServiceExtensionHandler);
    Page page = mock(Page.class);
    when(page.getPageTemplate()).thenReturn(new PageTemplateImpl());

    // Act
    FieldDefinition actualFieldDefinition = pageServiceUtility.getFieldDefinition(page, "Field Key");
   ...
   * Test {@link PageServiceUtility#buildRuleExpression(Page)}.
   * <ul>
   *   <li>Given {@link HashMap#HashMap()} {@code 42} is {@link PageRuleImpl} (default constructor).</li>
