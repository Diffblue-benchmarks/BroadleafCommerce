...
public class PageServiceUtilityDiffblueTest {
  ...
  public void testBuildPageDTO() {
    ...
    assertNull(actualBuildPageDTOResult.getLocaleCode());
    ...
    assertTrue(actualBuildPageDTOResult.getForeignPageFields().isEmpty());
   ...
   */
  @Test
  public void testHydrateForeignLookups2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testHydrateForeignLookups3() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
