...
public class StructuredContentFieldGroupXrefImplDiffblueTest {
  /**
   * Test {@link StructuredContentFieldGroupXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.
   * <p>
   * Method under test: {@link StructuredContentFieldGroupXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void StructuredContentFieldGroupXrefImpl.<init>()",
