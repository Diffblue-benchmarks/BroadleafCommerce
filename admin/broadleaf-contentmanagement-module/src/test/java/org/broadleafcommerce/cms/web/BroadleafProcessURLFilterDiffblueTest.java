...
public class BroadleafProcessURLFilterDiffblueTest {
  ...
  /**
   * Test {@link BroadleafProcessURLFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}.
   * <ul>
   *   <li>Then throw {@link NumberFormatException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BroadleafProcessURLFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link BroadleafProcessURLFilter#shouldProcessURL(HttpServletRequest, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean BroadleafProcessURLFilter.shouldProcessURL(HttpServletRequest, String)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"int BroadleafProcessURLFilter.getCacheExpirationSeconds()",
      "int BroadleafProcessURLFilter.getMaxCacheConcurrency()", "int BroadleafProcessURLFilter.getMaxCacheElements()",
