...
public class HrefUrlRewriteProcessorDiffblueTest {
  ...
  public void testGetModifiedAttributes_givenHrefUrlRewriteProcessor() {
    // Arrange
  ...
  public void testGetModifiedAttributes_givenHrefUrlRewriteProcessor2() {
    // Arrange
    HrefUrlRewriteProcessor hrefUrlRewriteProcessor = new HrefUrlRewriteProcessor();
    HashMap<String, String> tagAttributes = new HashMap<>();
  ...
  public void testGetModifiedAttributes_givenHrefUrlRewriteProcessor_whenHashMapUseCDNIsUseCDN() {
    // Arrange
    HrefUrlRewriteProcessor hrefUrlRewriteProcessor = new HrefUrlRewriteProcessor();
