...
public class UrlRewriteProcessorDiffblueTest {
  ...
  /**
   * Test {@link UrlRewriteProcessor#getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)}.
   * <ul>
   *   <li>Given {@code Parse Expression}.</li>
   *   <li>Then return Added size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link UrlRewriteProcessor#getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "BroadleafAttributeModifier UrlRewriteProcessor.getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)"})
  public void testGetModifiedAttributes_givenParseExpression_thenReturnAddedSizeIsOne() {
    // Arrange
    ...
    // Act
    BroadleafAttributeModifier actualModifiedAttributes = urlRewriteProcessor.getModifiedAttributes(
  ...
  @MethodsUnderTest({
      "BroadleafAttributeModifier UrlRewriteProcessor.getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)"})
  public void testGetModifiedAttributes_givenParseExpression_whenImg_thenReturnAddedSizeIsOne() {
    // Arrange
    when(staticAssetPathService.convertAssetPath(Mockito.<String>any(), Mockito.<String>any(), anyBoolean()))
        .thenReturn("Convert Asset Path");
    HashMap<String, String> tagAttributes = new HashMap<>();
    ...
    // Act
    BroadleafAttributeModifier actualModifiedAttributes = urlRewriteProcessor.getModifiedAttributes("img",
   ...
   * </ul>
   * <p>
   * Method under test: {@link UrlRewriteProcessor#getFullAssetPath(String, String, BroadleafTemplateContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String UrlRewriteProcessor.getFullAssetPath(String, String, BroadleafTemplateContext)"})
  public void testGetFullAssetPath_givenParseExpression_thenReturnConvertAssetPath() {
    ...
    // Act
    String actualFullAssetPath = urlRewriteProcessor.getFullAssetPath("https://example.org/example",
        "https://example.org/example", context);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String UrlRewriteProcessor.getFullAssetPath(String, String, BroadleafTemplateContext)"})
  public void testGetFullAssetPath_givenParseExpression_whenImg_thenReturnConvertAssetPath() {
    // Arrange
    when(staticAssetPathService.convertAssetPath(Mockito.<String>any(), Mockito.<String>any(), anyBoolean()))
        .thenReturn("Convert Asset Path");
    BroadleafTemplateContext context = mock(BroadleafTemplateContext.class);
    ...
    // Act
    String actualFullAssetPath = urlRewriteProcessor.getFullAssetPath("img", "https://example.org/example", context);
  ...
  public void testGetFullAssetPath_givenParseExpression_whenSlash_thenReturnConvertAssetPath() {
    ...
    // Act
    String actualFullAssetPath = urlRewriteProcessor.getFullAssetPath("https://example.org/example", "/", context);
