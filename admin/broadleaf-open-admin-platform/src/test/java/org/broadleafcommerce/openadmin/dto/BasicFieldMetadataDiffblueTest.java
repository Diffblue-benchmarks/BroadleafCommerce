...
public class BasicFieldMetadataDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link BasicFieldMetadata} (default constructor) DefaultValue is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link BasicFieldMetadata#getAllowNoValueEnumOption()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Boolean BasicFieldMetadata.getAllowNoValueEnumOption()"})
  public void testGetAllowNoValueEnumOption_givenBasicFieldMetadataDefaultValueIs42() {
    // Arrange
    BasicFieldMetadata basicFieldMetadata = new BasicFieldMetadata();
    basicFieldMetadata.setDefaultValue("42");
   ...
   *
   * <ul>
   *   <li>Given {@link BasicFieldMetadata} (default constructor) Required is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link BasicFieldMetadata#getAllowNoValueEnumOption()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Boolean BasicFieldMetadata.getAllowNoValueEnumOption()"})
  public void testGetAllowNoValueEnumOption_givenBasicFieldMetadataRequiredIsNull() {
    // Arrange
    BasicFieldMetadata basicFieldMetadata = new BasicFieldMetadata();
    basicFieldMetadata.setAllowNoValueEnumOption(null);
    basicFieldMetadata.setDefaultValue("");
   ...
   *
   * <ul>
   *   <li>Then return EnumerationValues is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link BasicFieldMetadata#cloneFieldMetadata()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldMetadata BasicFieldMetadata.cloneFieldMetadata()"})
  public void testCloneFieldMetadata_thenReturnEnumerationValuesIsNull() {
    // Arrange
    BasicFieldMetadata basicFieldMetadata = new BasicFieldMetadata();
