...
public class BatchPersistencePackageDiffblueTest {
  /**
   * Test {@link BatchPersistencePackage#equals(Object)}, and {@link BatchPersistencePackage#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean BatchPersistencePackage.equals(Object)", "int BatchPersistencePackage.hashCode()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void BatchPersistencePackage.<init>()",
