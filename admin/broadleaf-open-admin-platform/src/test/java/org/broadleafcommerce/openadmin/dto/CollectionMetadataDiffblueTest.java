...
public class CollectionMetadataDiffblueTest {
  ...
  /**
   * Test {@link CollectionMetadata#setMutable(boolean)}.
   * <p>
   * Method under test: {@link CollectionMetadata#setMutable(boolean)}
   */
  @Test
  public void testSetMutable() {
    ...
    // Arrange and Act
    (new AdornedTargetCollectionMetadata()).setMutable(true);
  }
