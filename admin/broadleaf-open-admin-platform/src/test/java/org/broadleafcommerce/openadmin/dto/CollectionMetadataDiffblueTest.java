...
public class CollectionMetadataDiffblueTest {
   ...
   * <p>
   * Method under test: {@link CollectionMetadata#setPersistencePerspective(PersistencePerspective)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link CollectionMetadata#setCollectionCeilingEntity(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <ul>
   *   <li>Given {@link AdornedTargetCollectionMetadata} (default constructor) Mutable is {@code false}.</li>
   ...
   * Test {@link CollectionMetadata#populate(FieldMetadata)}.
   * <ul>
   *   <li>Then return PersistencePerspective PersistencePerspectiveItems Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link CollectionMetadata#populate(FieldMetadata)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"FieldMetadata CollectionMetadata.populate(FieldMetadata)"})
  public void testPopulate_thenReturnPersistencePerspectivePersistencePerspectiveItemsEmpty() {
    // Arrange
    PersistencePerspective persistencePerspective = new PersistencePerspective();
    persistencePerspective.setAdditionalNonPersistentProperties(null);
    persistencePerspective.setAdditionalForeignKeys(null);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"FieldMetadata CollectionMetadata.populate(FieldMetadata)"})
  public void testPopulate_thenReturnPersistencePerspectivePersistencePerspectiveItemsEmpty2() {
    // Arrange
    PersistencePerspective persistencePerspective = new PersistencePerspective();
    persistencePerspective.setAdditionalNonPersistentProperties(null);
    persistencePerspective.setAdditionalForeignKeys(null);
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean CollectionMetadata.equals(Object)", "int CollectionMetadata.hashCode()"})
