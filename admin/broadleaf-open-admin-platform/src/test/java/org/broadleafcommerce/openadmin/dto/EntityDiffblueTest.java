...
public class EntityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Entity} (default constructor) PropertyValidationErrors is {@link
   *       HashMap#HashMap()}.
   * </ul>
   *
   * <p>Method under test: {@link Entity#isValidationFailure()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean Entity.isValidationFailure()"})
  public void testIsValidationFailure_givenEntityPropertyValidationErrorsIsHashMap() {
    // Arrange
    Entity entity = new Entity();
