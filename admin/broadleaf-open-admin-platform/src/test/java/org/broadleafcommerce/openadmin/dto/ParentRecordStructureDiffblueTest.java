...
public class ParentRecordStructureDiffblueTest {
  ...
  public void testToString() {
    // Arrange
    ParentRecordStructure parentRecordStructure = new ParentRecordStructure(new Entity(), null);
  ...
  public void testToString2() {
    ...
    parentMetadata.setSecurityCeilingType("Security Ceiling Type");
    parentMetadata.setTabAndGroupMetadata(new HashMap<>());
    ParentRecordStructure parentRecordStructure = new ParentRecordStructure(null, parentMetadata);
  ...
  public void testToString_givenClassMetadataPropertiesIsArrayOfPropertyWithProperty() {
    ...
    // Act and Assert
    assertEquals(
        "ParentRecordStructure{, parentMetadata=[Property{name='null', value='null', isDirty=false,"
            + " enabled=true}]}",
        parentRecordStructure.toString());
  }
   ...
   *
   * <ul>
   *   <li>Given {@link ClassMetadata} (default constructor) Properties is {@code null}.
   ...
   *
   * <ul>
   *   <li>Then return {@code ParentRecordStructure{, parentMetadata=[null]}}.
   * </ul>
   *
   * <p>Method under test: {@link ParentRecordStructure#toString()}
   */
  ...
  public void testToString_thenReturnParentRecordStructureParentMetadataNull() {
    ...
    // Act and Assert
    assertEquals(
        "ParentRecordStructure{, parentMetadata=[null]}", parentRecordStructure.toString());
  }
