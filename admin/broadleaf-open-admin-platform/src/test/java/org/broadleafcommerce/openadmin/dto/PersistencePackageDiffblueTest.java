...
public class PersistencePackageDiffblueTest {
  ...
  public void testGetPMap() {
    ...
    // Act
    Map<String, Property> actualPMap = persistencePackage.getPMap();
   ...
   */
  @Test
  public void testGetSecurityCeilingEntityFullyQualifiedClassname2() {
    // Arrange
    PersistencePackage persistencePackage = new PersistencePackage();
   ...
   */
  @Test
  public void testGetPersistencePerspectiveItems2() {
    // Arrange
    PersistencePackage persistencePackage = new PersistencePackage();
    ...
    // Act
    Map<PersistencePerspectiveItemType, PersistencePerspectiveItem> actualPersistencePerspectiveItems = persistencePackage
        .getPersistencePerspectiveItems();

    // Assert
    assertTrue(actualPersistencePerspectiveItems.isEmpty());
    assertSame(persistencePerspective.persistencePerspectiveItems, actualPersistencePerspectiveItems);
  }
   ...
   */
  @Test
  public void testGetBottomCrumb() {
    // Arrange and Act
   ...
   */
  @Test
  public void testGetBottomCrumb2() {
    // Arrange
