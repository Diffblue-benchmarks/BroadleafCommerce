...
public class TabMetadataDiffblueTest {
   ...
   * Test {@link TabMetadata#getFirstGroup()}.
   * <ul>
   *   <li>Given {@link GroupMetadata} (default constructor) GroupOrder is zero.</li>
   *   <li>Then return {@link GroupMetadata} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link TabMetadata#getFirstGroup()}
   ...
   * Test {@link TabMetadata#getFirstGroup()}.
   * <ul>
   *   <li>Given {@link HashMap#HashMap()} {@code 42} is {@link GroupMetadata} (default constructor).</li>
   *   <li>Then return {@link GroupMetadata} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link TabMetadata#getFirstGroup()}
   ...
   * Test {@link TabMetadata#getFirstGroup()}.
   * <ul>
   *   <li>Given {@link TabMetadata} (default constructor) GroupMetadata is {@link HashMap#HashMap()}.</li>
   ...
   * <ul>
   *   <li>When {@link MetadataVisitorAdapter} {@link MetadataVisitorAdapter#visit(TabMetadata)} does nothing.</li>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void TabMetadata.<init>()", "Map TabMetadata.getGroupMetadata()",
      "String TabMetadata.getOwningClass()", "String TabMetadata.getTabName()", "Integer TabMetadata.getTabOrder()",
      "void TabMetadata.setGroupMetadata(Map)", "void TabMetadata.setOwningClass(String)",
      "void TabMetadata.setTabName(String)", "void TabMetadata.setTabOrder(Integer)"})
