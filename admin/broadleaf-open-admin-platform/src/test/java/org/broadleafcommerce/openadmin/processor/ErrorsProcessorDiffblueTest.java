...
public class ErrorsProcessorDiffblueTest {
  ...
  /**
   * Test {@link ErrorsProcessor#populateModelVariables(String, Map, String, String, BroadleafTemplateContext)}.
   * <ul>
   *   <li>Then return size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link ErrorsProcessor#populateModelVariables(String, Map, String, String, BroadleafTemplateContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ErrorsProcessor.addFieldError(String, String, Map)"})
  public void testAddFieldError_whenFieldName_thenHashMapFieldNameSizeIsOne() {
    // Arrange
    HashMap<String, List<String>> tabErrors = new HashMap<>();
