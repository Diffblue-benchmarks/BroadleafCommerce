...
public class BasicEntityMetadataProviderDiffblueTest {
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#addTabAndGroupMetadata(AddMetadataRequest, Map)}.
   * <ul>
   *   <li>Then return {@code NOT_HANDLED}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#addTabAndGroupMetadata(AddMetadataRequest, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.addTabAndGroupMetadata(AddMetadataRequest, Map)"})
  public void testAddTabAndGroupMetadata_thenReturnNotHandled() {
    // Arrange
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#overrideMetadataViaAnnotation(OverrideViaAnnotationRequest, Map)}.
   * <ul>
   *   <li>When {@code Object}.</li>
   *   <li>Then return {@code NOT_HANDLED}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#overrideMetadataViaAnnotation(OverrideViaAnnotationRequest, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.overrideMetadataViaAnnotation(OverrideViaAnnotationRequest, Map)"})
  public void testOverrideMetadataViaAnnotation_whenJavaLangObject_thenReturnNotHandled() {
    // Arrange
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#overrideMetadataViaXml(OverrideViaXmlRequest, Map)}.
   * <ul>
   *   <li>Given {@link Map} {@link Map#get(Object)} return {@link HashMap#HashMap()}.</li>
   *   <li>Then return {@code HANDLED}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#overrideMetadataViaXml(OverrideViaXmlRequest, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.overrideMetadataViaXml(OverrideViaXmlRequest, Map)"})
  public void testOverrideMetadataViaXml_givenMapGetReturnHashMap_thenReturnHandled() {
    // Arrange
    ...
    // Act
    MetadataProviderResponse actualOverrideMetadataViaXmlResult = basicEntityMetadataProvider
        .overrideMetadataViaXml(overrideViaXmlRequest, new HashMap<>());

    // Assert
    verify(map).containsKey(isA(Object.class));
    verify(map).get(isA(Object.class));
    assertEquals(MetadataProviderResponse.HANDLED, actualOverrideMetadataViaXmlResult);
  }
  ...
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.overrideMetadataViaXml(OverrideViaXmlRequest, Map)"})
  public void testOverrideMetadataViaXml_givenMapGetReturnNull_thenReturnHandled() {
    // Arrange
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#addTabAndGroupMetadataFromCmdProperties(ClassMetadata, Map)}.
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#addTabAndGroupMetadataFromCmdProperties(ClassMetadata, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.addTabAndGroupMetadataFromCmdProperties(ClassMetadata, Map)"})
  ...
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.addTabAndGroupMetadataFromCmdProperties(ClassMetadata, Map)"})
  public void testAddTabAndGroupMetadataFromCmdProperties_givenFoo_thenHashMapSizeIsTwo() {
    // Arrange
    AdornedTargetCollectionMetadata adornedTargetCollectionMetadata = mock(AdornedTargetCollectionMetadata.class);
    when(adornedTargetCollectionMetadata.getGroupOrder()).thenReturn(1);
  ...
  @MethodsUnderTest({
      "MetadataProviderResponse BasicEntityMetadataProvider.addTabAndGroupMetadataFromCmdProperties(ClassMetadata, Map)"})
  public void testAddTabAndGroupMetadataFromCmdProperties_thenHashMapSizeIsOne() {
    // Arrange
    AdornedTargetCollectionMetadata adornedTargetCollectionMetadata = mock(AdornedTargetCollectionMetadata.class);
    when(adornedTargetCollectionMetadata.getGroupOrder()).thenReturn(1);
    when(adornedTargetCollectionMetadata.getTabOrder()).thenReturn(1);
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#buildTabMetadata(AdminTabPresentation, Class, Map)}.
   * <ul>
   *   <li>Given {@link TabMetadata} (default constructor).</li>
   *   <li>When {@link HashMap#HashMap()} {@code foo} is {@link TabMetadata} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#buildTabMetadata(AdminTabPresentation, Class, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"TabMetadata BasicEntityMetadataProvider.buildTabMetadata(AdminTabPresentation, Class, Map)"})
  ...
  /**
   * Test {@link BasicEntityMetadataProvider#buildGroupMetadata(AdminGroupPresentation, Class, Map)}.
   * <ul>
   *   <li>When {@code Object}.</li>
   *   <li>Then return GroupName is {@code Name}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BasicEntityMetadataProvider#buildGroupMetadata(AdminGroupPresentation, Class, Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "GroupMetadata BasicEntityMetadataProvider.buildGroupMetadata(AdminGroupPresentation, Class, Map)"})
