...
public class BroadleafEnumerationUtilityDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link BroadleafEnumerationUtility#getEnumerationValues(String, DynamicEntityDao)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"List BroadleafEnumerationUtility.getEnumerationValues(String, DynamicEntityDao)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BroadleafEnumerationUtility#getSortedEnumValues(Map)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
