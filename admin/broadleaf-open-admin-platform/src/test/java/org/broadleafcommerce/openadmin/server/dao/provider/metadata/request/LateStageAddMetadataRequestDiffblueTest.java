...
public class LateStageAddMetadataRequestDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link LateStageAddMetadataRequest#LateStageAddMetadataRequest(String, Class, Class, DynamicEntityDao, String)}
  ...
  @MethodsUnderTest({"void LateStageAddMetadataRequest.<init>(String, Class, Class, DynamicEntityDao, String)",
      "DynamicEntityDao LateStageAddMetadataRequest.getDynamicEntityDao()",
      "String LateStageAddMetadataRequest.getFieldName()", "Class LateStageAddMetadataRequest.getParentClass()",
      "String LateStageAddMetadataRequest.getPrefix()", "Class LateStageAddMetadataRequest.getTargetClass()"})
