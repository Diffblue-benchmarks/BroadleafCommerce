...
public class OverrideViaAnnotationRequestDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link OverrideViaAnnotationRequest#OverrideViaAnnotationRequest(Class, Boolean, DynamicEntityDao, String)}
  ...
  @MethodsUnderTest({"void OverrideViaAnnotationRequest.<init>(Class, Boolean, DynamicEntityDao, String)",
      "DynamicEntityDao OverrideViaAnnotationRequest.getDynamicEntityDao()",
      "Boolean OverrideViaAnnotationRequest.getParentExcluded()", "String OverrideViaAnnotationRequest.getPrefix()",
