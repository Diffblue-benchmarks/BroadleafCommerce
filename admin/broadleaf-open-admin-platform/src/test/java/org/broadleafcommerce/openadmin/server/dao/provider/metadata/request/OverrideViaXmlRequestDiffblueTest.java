...
public class OverrideViaXmlRequestDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link OverrideViaXmlRequest#OverrideViaXmlRequest(String, String, String, Boolean, DynamicEntityDao)}
  ...
  @MethodsUnderTest({"void OverrideViaXmlRequest.<init>(String, String, String, Boolean, DynamicEntityDao)",
      "DynamicEntityDao OverrideViaXmlRequest.getDynamicEntityDao()",
      "Boolean OverrideViaXmlRequest.getParentExcluded()", "String OverrideViaXmlRequest.getPrefix()",
