...
public class ForgotPasswordSecurityTokenImplDiffblueTest {
  /**
   * Test {@link ForgotPasswordSecurityTokenImpl#equals(Object)}, and {@link ForgotPasswordSecurityTokenImpl#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean ForgotPasswordSecurityTokenImpl.equals(Object)",
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ForgotPasswordSecurityTokenImpl.<init>()",
      "Long ForgotPasswordSecurityTokenImpl.getAdminUserId()", "Date ForgotPasswordSecurityTokenImpl.getCreateDate()",
      "String ForgotPasswordSecurityTokenImpl.getToken()", "Date ForgotPasswordSecurityTokenImpl.getTokenUsedDate()",
