...
public class BroadleafAdminLdapUserDetailsMapperDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SimpleGrantedAuthority#SimpleGrantedAuthority(String)} with role is {@code
   *       mail}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testMapUserFromContext_givenSimpleGrantedAuthorityWithRoleIsMail() {
    // Arrange
    AdminUserDetails adminUserDetails =
        new AdminUserDetails(1L, "janedoe", "iloveyou", new ArrayList<>());
    when(adminUserProvisioningService.provisionAdminUser(
  ...
  public void testDetermineSite_givenSimpleGrantedAuthorityWithRole() {
    // Arrange
    BroadleafAdminLdapUserDetailsMapper broadleafAdminLdapUserDetailsMapper =
