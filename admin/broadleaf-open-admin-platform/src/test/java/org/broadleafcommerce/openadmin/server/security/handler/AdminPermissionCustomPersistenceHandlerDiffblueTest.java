...
public class AdminPermissionCustomPersistenceHandlerDiffblueTest {
  ...
  public void testAdd_givenPropertyWithNameAndValueIsPermission() throws ServiceException {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.findProperty(Mockito.<String>any()))
        .thenReturn(new Property("Name", "PERMISSION_"));
    String[] customCriteria = new String[] {"id"};
   ...
   *
   * <ul>
   *   <li>Given {@link AdminPermissionCustomPersistenceHandler} (default constructor).
  ...
  public void testFetch_givenAdminPermissionCustomPersistenceHandler_thenCallsSetSortAscending()
      throws ServiceException {
    // Arrange
