...
public class AdminSecurityServiceRemoteDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link AdminSecurityServiceRemote} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link AdminSecurityServiceRemote#securityCheck(String[],
   * EntityOperationType)}
  ...
  public void testSecurityCheckWithCeilingNamesOperationType_givenAdminSecurityServiceRemote()
      throws ServiceException {
    // Arrange, Act and Assert
    assertThrows(
        SecurityServiceException.class,
        () ->
            new AdminSecurityServiceRemote()
                .securityCheck((String[]) null, EntityOperationType.FETCH));
  }
  ...
  public void testSecurityCheckWithPersistencePackageOperationType15() throws ServiceException {
    // Arrange
  ...
  public void testSecurityCheckWithPersistencePackageOperationType_givenHashMap()
      throws ServiceException {
    // Arrange
    AdminSecurityCheckExtensionHandler adminSecurityCheckExtensionHandler =
        mock(AdminSecurityCheckExtensionHandler.class);
