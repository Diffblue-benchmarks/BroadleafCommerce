...
public class AdminSecurityServiceImplDiffblueTest {
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword() {
    ...
    GenericResponse actualChangePasswordResult =
        new AdminSecurityServiceImpl().changePassword(null, "iloveyou", " ", " ");
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword2() {
    // Arrange and Act
    GenericResponse actualChangePasswordResult =
        new AdminSecurityServiceImpl().changePassword(null, "iloveyou", "iloveyou", " ");
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword3() {
    // Arrange and Act
    GenericResponse actualChangePasswordResult =
        new AdminSecurityServiceImpl().changePassword(null, "iloveyou", null, " ");
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword4() {
    // Arrange and Act
    GenericResponse actualChangePasswordResult =
        new AdminSecurityServiceImpl().changePassword(null, "iloveyou", "iloveyou", "iloveyou");
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword5() {
    // Arrange and Act
    GenericResponse actualChangePasswordResult =
        new AdminSecurityServiceImpl().changePassword(null, "iloveyou", "iloveyou", "invalidUser");
  ...
  public void testChangePasswordWithUsernameOldPasswordPasswordConfirmPassword8() {
    // Arrange
    AdminUser adminUser = mock(AdminUser.class);
   ...
   *
   * <ul>
   *   <li>Given {@link AdminSecurityServiceImpl} (default constructor).
   *   <li>When {@code null}.
   * </ul>
   *
  ...
  public void testSendForgotUsernameNotification_givenAdminSecurityServiceImpl_whenNull() {
    // Arrange and Act
    GenericResponse actualSendForgotUsernameNotificationResult =
        new AdminSecurityServiceImpl().sendForgotUsernameNotification(null);
  ...
  public void testSendResetPasswordNotification_thenReturnErrorCodesListFirstIsInvalidUser() {
    // Arrange and Act
    GenericResponse actualSendResetPasswordNotificationResult =
        new AdminSecurityServiceImpl().sendResetPasswordNotification(null);
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSecondIsInvalidToken() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl().resetPasswordUsingToken(null, " ", "iloveyou", "iloveyou");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSecondIsPasswordMismatch() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl()
            .resetPasswordUsingToken(null, " ", "iloveyou", "invalidUser");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl().resetPasswordUsingToken(null, " ", " ", " ");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree2() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl().resetPasswordUsingToken(null, null, " ", " ");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree3() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl().resetPasswordUsingToken(null, " ", "iloveyou", " ");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsTwo() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new AdminSecurityServiceImpl().resetPasswordUsingToken(null, "ABC123", " ", " ");
  ...
  public void testCheckPassword_givenAdminSecurityServiceImpl_thenNotGenericResponseHasErrors() {
    // Arrange
    AdminSecurityServiceImpl adminSecurityServiceImpl = new AdminSecurityServiceImpl();
    GenericResponse response = new GenericResponse();
