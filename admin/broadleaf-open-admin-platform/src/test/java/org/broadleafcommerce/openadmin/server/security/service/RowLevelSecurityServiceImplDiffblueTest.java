...
public class RowLevelSecurityServiceImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ArrayList#ArrayList()} add {@link RowLevelSecurityServiceImpl} (default
   *       constructor).
   *   <li>Then return {@code true}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean RowLevelSecurityServiceImpl.canUpdate(AdminUser, Entity)"})
  public void testCanUpdate_givenArrayListAddRowLevelSecurityServiceImpl_thenReturnTrue() {
    // Arrange
    RowLevelSecurityServiceImpl rowLevelSecurityServiceImpl = new RowLevelSecurityServiceImpl();
    rowLevelSecurityServiceImpl.setProviders(new ArrayList<>());

    ArrayList<RowLevelSecurityProvider> providers = new ArrayList<>();
    providers.add(rowLevelSecurityServiceImpl);

    RowLevelSecurityServiceImpl rowLevelSecurityServiceImpl2 = new RowLevelSecurityServiceImpl();
    rowLevelSecurityServiceImpl2.setProviders(providers);
    AdminUserImpl currentUser = new AdminUserImpl();

    // Act and Assert
    assertTrue(rowLevelSecurityServiceImpl2.canUpdate(currentUser, new Entity()));
  }
  ...
  public void testGetUpdateDenialExceptions_thenReturnDataEmpty2() {
    // Arrange
    RowLevelSecurityServiceImpl rowLevelSecurityServiceImpl = new RowLevelSecurityServiceImpl();
    rowLevelSecurityServiceImpl.setProviders(new ArrayList<>());
    ...
    // Act
    EntityFormModifierConfiguration actualUpdateDenialExceptions =
        rowLevelSecurityServiceImpl2.getUpdateDenialExceptions();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean RowLevelSecurityServiceImpl.canRemove(AdminUser, Entity)"})
  public void testCanRemove_givenArrayListAddRowLevelSecurityServiceImpl_thenReturnTrue() {
    // Arrange
    RowLevelSecurityServiceImpl rowLevelSecurityServiceImpl = new RowLevelSecurityServiceImpl();
    rowLevelSecurityServiceImpl.setProviders(new ArrayList<>());
    ...
    // Act and Assert
    assertTrue(rowLevelSecurityServiceImpl2.canRemove(currentUser, new Entity()));
  }
  ...
  public void testValidateUpdateRequest_givenArrayListAddAbstractRowLevelSecurityProvider() {
    // Arrange
    ArrayList<RowLevelSecurityProvider> providers = new ArrayList<>();
    providers.add(new AbstractRowLevelSecurityProvider());
  ...
  public void testValidateUpdateRequest_givenGlobalValidationResultIsNotValidReturnFalse() {
    // Arrange
  ...
  public void testValidateUpdateRequest_thenReturnErrorMessagesFirstIsErrorMessageOrKey() {
    // Arrange
    ...
    assertEquals("Error Message Or Key", actualValidateUpdateRequestResult.getErrorMessage());
    assertFalse(actualValidateUpdateRequestResult.isValid());
    assertTrue(actualValidateUpdateRequestResult.isNotValid());
  }
