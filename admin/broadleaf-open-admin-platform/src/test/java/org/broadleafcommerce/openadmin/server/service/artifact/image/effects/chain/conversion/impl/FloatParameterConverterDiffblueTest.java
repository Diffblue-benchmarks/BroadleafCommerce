...
public class FloatParameterConverterDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FloatParameterConverter#convert(String, Double, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Parameter FloatParameterConverter.convert(String, Double, boolean)"})
  public void testConvert_when42_thenReturnParameterInstanceFloatValueIsFortyTwo() throws ConversionException {
    // Arrange and Act
  ...
  public void testConvert_whenFalse_thenReturnParameterInstanceFloatValueIsFortyTwo() throws ConversionException {
    // Arrange and Act
    Parameter actualConvertResult = floatParameterConverter.convert("42", null, false);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Parameter FloatParameterConverter.convert(String, Double, boolean)"})
  public void testConvert_whenTen_thenReturnParameterInstanceFloatValueIs42() throws ConversionException {
    // Arrange and Act
