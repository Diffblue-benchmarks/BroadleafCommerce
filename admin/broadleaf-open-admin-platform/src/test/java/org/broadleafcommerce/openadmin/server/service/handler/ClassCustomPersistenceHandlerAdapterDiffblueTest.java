...
public class ClassCustomPersistenceHandlerAdapterDiffblueTest {
  /**
   * Test {@link ClassCustomPersistenceHandlerAdapter#ClassCustomPersistenceHandlerAdapter(Class[])}.
   * <p>
   * Method under test: {@link ClassCustomPersistenceHandlerAdapter#ClassCustomPersistenceHandlerAdapter(Class[])}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link ClassCustomPersistenceHandlerAdapter#classMatches(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean ClassCustomPersistenceHandlerAdapter.classMatches(PersistencePackage)"})
   ...
   * <p>
   * Method under test: {@link ClassCustomPersistenceHandlerAdapter#classIsAssignableFrom(PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean ClassCustomPersistenceHandlerAdapter.classIsAssignableFrom(PersistencePackage)"})
