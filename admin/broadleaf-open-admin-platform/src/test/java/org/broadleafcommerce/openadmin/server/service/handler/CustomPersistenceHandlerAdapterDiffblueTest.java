...
public class CustomPersistenceHandlerAdapterDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.broadleafcommerce.openadmin.dto.DynamicResultSet CustomPersistenceHandlerAdapter.inspect(PersistencePackage, DynamicEntityDao, InspectHelper)"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.broadleafcommerce.openadmin.dto.DynamicResultSet CustomPersistenceHandlerAdapter.fetch(PersistencePackage, CriteriaTransferObject, DynamicEntityDao, RecordHelper)"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.broadleafcommerce.openadmin.dto.DynamicResultSet CustomPersistenceHandlerAdapter.getResultSet(PersistencePackage, InspectHelper, Map)"
  })
  ...
  public void testGetPolymorphicClasses_givenJavaLangObject_thenReturnArrayLengthIsZero() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(
        0, classCustomPersistenceHandlerAdapter.getPolymorphicClasses(clazz, null, true).length);
  }
  ...
  public void testGetPolymorphicClasses_givenJavaLangObject_thenReturnArrayLengthIsZero2() {
    // Arrange
    Class<Object> forNameResult = Object.class;
    ClassCustomPersistenceHandlerAdapter classCustomPersistenceHandlerAdapter =
        new ClassCustomPersistenceHandlerAdapter(forNameResult);
