...
public class ParentEntityPersistenceExceptionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ParentEntityPersistenceException#ParentEntityPersistenceException(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ParentEntityPersistenceException.<init>(String)",
  ...
  /**
   * Test {@link ParentEntityPersistenceException#ParentEntityPersistenceException(String, Throwable)}.
   * <ul>
   *   <li>Then return Message is {@code An error occurred}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ParentEntityPersistenceException#ParentEntityPersistenceException(String, Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ParentEntityPersistenceException.<init>(String)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link ParentEntityPersistenceException#ParentEntityPersistenceException(Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ParentEntityPersistenceException.<init>(String)",
