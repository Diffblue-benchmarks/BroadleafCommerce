...
public class PersistenceManagerEventHandlerAdapterDiffblueTest {
  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#postAdd(PersistenceManager, Entity, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#postAdd(PersistenceManager, Entity, PersistencePackage)}
   */
  @Test
  ...
  public void testPostAdd() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPostAddResult.getStatus());
    assertTrue(actualPostAddResult.getAdditionalData().isEmpty());
    assertSame(entity, actualPostAddResult.getEntity());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#preFetch(PersistenceManager, PersistencePackage, CriteriaTransferObject)}.
   * <ul>
   *   <li>Given {@link ArchiveStatusPersistenceEventHandler} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#preFetch(PersistenceManager, PersistencePackage, CriteriaTransferObject)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * Test {@link PersistenceManagerEventHandlerAdapter#preFetch(PersistenceManager, PersistencePackage, CriteriaTransferObject)}.
   * <ul>
   *   <li>Given {@link PersistenceManagerEventHandlerAdapter} (default constructor).</li>
  ...
  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#postFetch(PersistenceManager, DynamicResultSet, PersistencePackage, CriteriaTransferObject)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#postFetch(PersistenceManager, DynamicResultSet, PersistencePackage, CriteriaTransferObject)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPostFetch() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPostFetchResult.getStatus());
    assertTrue(actualPostFetchResult.getAdditionalData().isEmpty());
    assertSame(resultSet, actualPostFetchResult.getDynamicResultSet());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#preAdd(PersistenceManager, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#preAdd(PersistenceManager, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPreAdd() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPreAddResult.getStatus());
    assertTrue(actualPreAddResult.getAdditionalData().isEmpty());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#preUpdate(PersistenceManager, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#preUpdate(PersistenceManager, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPreUpdate() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPreUpdateResult.getStatus());
    assertTrue(actualPreUpdateResult.getAdditionalData().isEmpty());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#postUpdate(PersistenceManager, Entity, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#postUpdate(PersistenceManager, Entity, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPostUpdate() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPostUpdateResult.getStatus());
    assertTrue(actualPostUpdateResult.getAdditionalData().isEmpty());
    assertSame(entity, actualPostUpdateResult.getEntity());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#preRemove(PersistenceManager, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#preRemove(PersistenceManager, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPreRemove() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPreRemoveResult.getStatus());
    assertTrue(actualPreRemoveResult.getAdditionalData().isEmpty());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#postRemove(PersistenceManager, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#postRemove(PersistenceManager, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPostRemove() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPostRemoveResult.getStatus());
    assertTrue(actualPostRemoveResult.getAdditionalData().isEmpty());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#postInspect(PersistenceManager, DynamicResultSet, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#postInspect(PersistenceManager, DynamicResultSet, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPostInspect() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPostInspectResult.getStatus());
  ...
  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#preInspect(PersistenceManager, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#preInspect(PersistenceManager, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testPreInspect() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED, actualPreInspectResult.getStatus());
    assertTrue(actualPreInspectResult.getAdditionalData().isEmpty());
  }

  /**
   * Test {@link PersistenceManagerEventHandlerAdapter#processValidationError(PersistenceManager, Entity, PersistencePackage)}.
   * <p>
   * Method under test: {@link PersistenceManagerEventHandlerAdapter#processValidationError(PersistenceManager, Entity, PersistencePackage)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testProcessValidationError() throws ServiceException {
    ...
    assertEquals(PersistenceManagerEventHandlerResponseStatus.NOT_HANDLED,
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PersistenceManagerEventHandlerAdapter.<init>()",
