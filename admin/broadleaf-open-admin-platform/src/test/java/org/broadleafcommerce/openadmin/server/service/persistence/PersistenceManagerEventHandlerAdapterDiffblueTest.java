...
public class PersistenceManagerEventHandlerAdapterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ArchiveStatusPersistenceEventHandler} (default constructor).
   * </ul>
   *
  ...
  public void testPreFetch_givenArchiveStatusPersistenceEventHandler() throws ServiceException {
    // Arrange
    ArchiveStatusPersistenceEventHandler archiveStatusPersistenceEventHandler =
        new ArchiveStatusPersistenceEventHandler();
    PersistenceManagerImpl persistenceManager = new PersistenceManagerImpl();
    Entity entity = new Entity();
   ...
   *
   * <ul>
   *   <li>Given {@link PersistenceManagerEventHandlerAdapter} (default constructor).
  ...
  public void testPreFetch_givenPersistenceManagerEventHandlerAdapter_whenPersistencePackage()
