...
public class PersistenceManagerFactoryDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link PersistenceManagerFactory#getPersistenceManager(Class)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testGetPersistenceManagerWithEntityClass_thenThrowIllegalStateException() {
    // Arrange
    when(persistenceService.identifyEntityManager(Mockito.<Class<Object>>any(), Mockito.<TargetModeType>any()))
        .thenThrow(new IllegalStateException("foo"));
    Class<Object> entityClass = Object.class;

    // Act and Assert
    assertThrows(IllegalStateException.class, () -> PersistenceManagerFactory.getPersistenceManager(entityClass));
  ...
  /**
   * Test {@link PersistenceManagerFactory#startPersistenceManager(TargetModeType)} with {@code targetModeType}.
   * <ul>
   *   <li>Then throw {@link IllegalStateException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PersistenceManagerFactory#startPersistenceManager(TargetModeType)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * </ul>
   * <p>
   * Method under test: {@link PersistenceManagerFactory#getDefaultPersistenceManager()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testGetDefaultPersistenceManager_thenThrowIllegalStateException() {
    ...
    // Act and Assert
    assertThrows(IllegalStateException.class, () -> PersistenceManagerFactory.getDefaultPersistenceManager());
    verify(persistenceService).identifyDefaultEntityManager(isA(TargetModeType.class));
  }
