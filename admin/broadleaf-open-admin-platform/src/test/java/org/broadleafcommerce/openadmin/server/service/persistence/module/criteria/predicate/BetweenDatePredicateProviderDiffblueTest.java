...
public class BetweenDatePredicateProviderDiffblueTest {
  @Autowired
  private BetweenDatePredicateProvider betweenDatePredicateProvider;

  /**
   * Test
   * {@link BetweenDatePredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link BetweenDatePredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass8594 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.BetweenDatePredicateProvider betweenDatePredicateProvider;
    ...
    // Arrange
    BetweenDatePredicateProvider betweenDatePredicateProvider2 = new BetweenDatePredicateProvider();
    ...
    CriteriaBuilderImpl criteriaBuilder3 = new CriteriaBuilderImpl(new SessionFactoryImpl(metadata2,
        new AbstractDelegatingSessionFactoryOptions(null), mock(QueryPlanCache.QueryPlanCreator.class)));
    Class<Comparable> javaType2 = Comparable.class;
    Class<Object> treatAsType3 = Object.class;
    CollectionAttributeJoin<Object, Comparable> explicitPath = new CollectionAttributeJoin<>(criteriaBuilder3,
        javaType2, new CollectionAttributeJoin.TreatedCollectionAttributeJoin<>(null, treatAsType3), null,
        JoinType.INNER);

    // Act
    betweenDatePredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe",
