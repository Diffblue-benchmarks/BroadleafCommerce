...
public class BetweenPredicateProviderDiffblueTest {
  @Autowired
  private BetweenPredicateProvider betweenPredicateProvider;

  /**
   * Test
   * {@link BetweenPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link BetweenPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass8844 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.BetweenPredicateProvider betweenPredicateProvider;
    ...
    // Arrange
    BetweenPredicateProvider betweenPredicateProvider2 = new BetweenPredicateProvider();
    ...
    // Act
    betweenPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe",
