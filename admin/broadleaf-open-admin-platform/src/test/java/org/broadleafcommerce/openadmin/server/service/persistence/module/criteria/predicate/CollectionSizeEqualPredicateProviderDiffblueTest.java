...
public class CollectionSizeEqualPredicateProviderDiffblueTest {
  @Autowired
  private CollectionSizeEqualPredicateProvider collectionSizeEqualPredicateProvider;

  /**
   * Test
   * {@link CollectionSizeEqualPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link CollectionSizeEqualPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass9094 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.CollectionSizeEqualPredicateProvider collectionSizeEqualPredicateProvider;
    ...
    // Arrange
    CollectionSizeEqualPredicateProvider collectionSizeEqualPredicateProvider2 = new CollectionSizeEqualPredicateProvider();
    ...
    CriteriaBuilderImpl criteriaBuilder3 = new CriteriaBuilderImpl(new SessionFactoryImpl(metadata2,
        new AbstractDelegatingSessionFactoryOptions(null), mock(QueryPlanCache.QueryPlanCreator.class)));
    Class<Collection> javaType2 = Collection.class;
    Class<Object> treatAsType3 = Object.class;
    CollectionAttributeJoin<Object, Collection> explicitPath = new CollectionAttributeJoin<>(criteriaBuilder3,
        javaType2, new CollectionAttributeJoin.TreatedCollectionAttributeJoin<>(null, treatAsType3), null,
        JoinType.INNER);

    // Act
    collectionSizeEqualPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity",
        "Dr Jane Doe", explicitPath, new ArrayList<>());
  }
}
