...
public class EqPredicateProviderDiffblueTest {
  @Autowired
  private EqPredicateProvider eqPredicateProvider;

  /**
   * Test
   * {@link EqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link EqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass9344 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.EqPredicateProvider eqPredicateProvider;
    ...
    // Arrange
    EqPredicateProvider eqPredicateProvider2 = new EqPredicateProvider();
    ...
    // Act
    eqPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe", explicitPath,
        new ArrayList<>());
  }
}
