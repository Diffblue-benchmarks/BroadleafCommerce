...
public class IsNullPredicateProviderDiffblueTest {
  @Autowired
  private IsNullPredicateProvider isNullPredicateProvider;

  /**
   * Test
   * {@link IsNullPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link IsNullPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass9828 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.IsNullPredicateProvider isNullPredicateProvider;
    ...
    // Arrange
    IsNullPredicateProvider isNullPredicateProvider2 = new IsNullPredicateProvider();
    ...
    // Act
    isNullPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe",
