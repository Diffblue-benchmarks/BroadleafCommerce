...
public class NotEqPredicateProviderDiffblueTest {
  @Autowired
  private NotEqPredicateProvider notEqPredicateProvider;

  /**
   * Test
   * {@link NotEqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link NotEqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass10312 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.NotEqPredicateProvider notEqPredicateProvider;
    ...
    // Arrange
    NotEqPredicateProvider notEqPredicateProvider2 = new NotEqPredicateProvider();
    ...
    // Act
    notEqPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe",
