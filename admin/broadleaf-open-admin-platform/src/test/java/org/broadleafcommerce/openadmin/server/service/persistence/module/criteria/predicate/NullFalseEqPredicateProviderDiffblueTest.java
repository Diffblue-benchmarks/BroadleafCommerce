...
public class NullFalseEqPredicateProviderDiffblueTest {
  @Autowired
  private NullFalseEqPredicateProvider nullFalseEqPredicateProvider;

  /**
   * Test
   * {@link NullFalseEqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}.
   * <p>
   * Method under test:
   * {@link NullFalseEqPredicateProvider#buildPredicate(CriteriaBuilder, FieldPathBuilder, From, String, String, Path, List)}
   */
  ...
  public void testBuildPredicate() {
    ...
    //   public class DiffblueFakeClass10546 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.predicate.NullFalseEqPredicateProvider nullFalseEqPredicateProvider;
    ...
    // Arrange
    NullFalseEqPredicateProvider nullFalseEqPredicateProvider2 = new NullFalseEqPredicateProvider();
    ...
    CriteriaBuilderImpl criteriaBuilder3 = new CriteriaBuilderImpl(new SessionFactoryImpl(metadata2,
        new AbstractDelegatingSessionFactoryOptions(null), mock(QueryPlanCache.QueryPlanCreator.class)));
    Class<Serializable> javaType2 = Serializable.class;
    Class<Object> treatAsType3 = Object.class;
    CollectionAttributeJoin<Object, Serializable> explicitPath = new CollectionAttributeJoin<>(criteriaBuilder3,
        javaType2, new CollectionAttributeJoin.TreatedCollectionAttributeJoin<>(null, treatAsType3), null,
        JoinType.INNER);

    // Act
    nullFalseEqPredicateProvider2.buildPredicate(builder, fieldPathBuilder, root, "Ceiling Entity", "Dr Jane Doe",
