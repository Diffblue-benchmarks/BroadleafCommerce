...
public class AdminRegexValidatorDiffblueTest {
  ...
  @MethodsUnderTest({
      "boolean AdminRegexValidator.validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)"})
  public void testValidateInternal_givenAdminRegexValidator_when42_thenReturnFalse() {
    // Arrange
  ...
  @MethodsUnderTest({
      "boolean AdminRegexValidator.validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)"})
  public void testValidateInternal_givenAdminRegexValidator_whenRegex_config_property() {
    // Arrange
    AdminRegexValidator adminRegexValidator = new AdminRegexValidator();
    Entity entity = new Entity();
    SimpleDateFormat instance = new SimpleDateFormat("yyyy/mm/dd");
   ...
   * Test {@link AdminRegexValidator#validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)}.
   * <ul>
   *   <li>Given {@link SystemPropertiesService}.</li>
   *   <li>When {@code 42}.</li>
   *   <li>Then return {@code false}.</li>
   * </ul>
   * <p>
  ...
  @MethodsUnderTest({
      "boolean AdminRegexValidator.validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)"})
  public void testValidateInternal_givenSystemPropertiesService_when42_thenReturnFalse() {
    // Arrange
    Entity entity = new Entity();
    SimpleDateFormat instance = new SimpleDateFormat("yyyy/mm/dd");
    HashMap<String, FieldMetadata> entityFieldMetadata = new HashMap<>();
  ...
  @MethodsUnderTest({
      "boolean AdminRegexValidator.validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)"})
  public void testValidateInternal_givenSystemPropertiesService_when42_thenReturnTrue() {
    // Arrange
    Entity entity = new Entity();
    SimpleDateFormat instance = new SimpleDateFormat("yyyy/mm/dd");
    HashMap<String, FieldMetadata> entityFieldMetadata = new HashMap<>();
  ...
  @MethodsUnderTest({
      "boolean AdminRegexValidator.validateInternal(Entity, Serializable, Map, Map, BasicFieldMetadata, String, String)"})
  public void testValidateInternal_givenSystemPropertiesService_whenNull_thenReturnTrue() {
    // Arrange
    Entity entity = new Entity();
    SimpleDateFormat instance = new SimpleDateFormat("yyyy/mm/dd");
    HashMap<String, FieldMetadata> entityFieldMetadata = new HashMap<>();
