...
public class EntityFormDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code Main Entity Name}.
   * </ul>
   *
   * <p>Method under test: {@link EntityForm#getMainEntityName()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String EntityForm.getMainEntityName()"})
  public void testGetMainEntityName_thenReturnMainEntityName() {
    // Arrange
    EntityForm entityForm = new EntityForm();
    entityForm.setMainEntityName("Main Entity Name");

    // Act and Assert
    assertEquals("Main Entity Name", entityForm.getMainEntityName());
  }
