...
public class TabDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Tab} (default constructor) TabClass is {@code Tab Class}.
   *   <li>Then return {@code Tab Class}.
   * </ul>
   *
   * <p>Method under test: {@link Tab#getTabClass()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Tab.getTabClass()"})
  public void testGetTabClass_givenTabTabClassIsTabClass_thenReturnTabClass() {
    // Arrange
    Tab tab = new Tab();
