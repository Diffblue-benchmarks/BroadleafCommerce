...
public class DataDTOToMVELTranslatorDiffblueTest {
  ...
  public void testFormatValue_whenId_thenThrowMVELTranslationException2()
      throws MVELTranslationException {
    // Arrange, Act and Assert
    assertThrows(
        MVELTranslationException.class,
  ...
  public void testFormatValue_whenUnknown_thenReturnEntityKeyValue()
      throws MVELTranslationException {
    // Arrange, Act and Assert
    assertEquals(
        "Entity Key.Value",
  ...
  public void testFormatValue_whenUnknown_thenReturnMvelHelperToUpperCaseValue()
      throws MVELTranslationException {
    // Arrange, Act and Assert
    assertEquals(
