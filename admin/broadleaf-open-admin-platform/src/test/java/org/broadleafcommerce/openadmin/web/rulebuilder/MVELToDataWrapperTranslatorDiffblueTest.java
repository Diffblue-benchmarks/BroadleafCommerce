...
public class MVELToDataWrapperTranslatorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code Prev}.
   *   <li>When {@link ExpressionDTO} (default constructor) Value is {@code Prev}.
   * </ul>
   *
  ...
  public void testIsBetweenOperator_givenPrev_whenExpressionDTOValueIsPrev() {
    // Arrange
    MVELToDataWrapperTranslator mvelToDataWrapperTranslator = new MVELToDataWrapperTranslator();
  ...
  public void testIsBetweenInclusiveOperator_givenPrev_whenExpressionDTOValueIsPrev() {
    // Arrange
    MVELToDataWrapperTranslator mvelToDataWrapperTranslator = new MVELToDataWrapperTranslator();
