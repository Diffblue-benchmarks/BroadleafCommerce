...
public class MVELToDataWrapperTranslatorDiffblueTest {
   ...
   */
  @Test
  public void testCreateRuleData() {
    // Arrange
   ...
   */
  @Test
  public void testCreateRuleData2() {
   ...
   */
  @Test
  public void testCreateRuleData3() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testCreateRuleData4() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testCreateRuleData5() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleData6() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleData7() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleData8() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleData9() {
    // Arrange, Act and Assert
    assertNull(mVELToDataWrapperTranslator.createRuleData(null, "Mvel Property", "Quantity Property", "Id Property",
   ...
   */
  @Test
  public void testCreateRuleData10() {
    // Arrange, Act and Assert
    assertNull(mVELToDataWrapperTranslator.createRuleData(new Entity[]{}, "Mvel Property", "Quantity Property",
   ...
   */
  @Test
  public void testCreateRuleData11() {
    // Arrange, Act and Assert
    assertNull(mVELToDataWrapperTranslator.createRuleData(new Entity[]{mock(Entity.class)}, null, "Quantity Property",
        "Id Property", mock(RuleBuilderFieldService.class)));
  }
   ...
   */
  @Test
  public void testCreateRuleData12() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleData13() {
    // Arrange
    Entity entity = mock(Entity.class);
    when(entity.getProperties()).thenReturn(new Property[]{new Property()});
   ...
   */
  @Test
  public void testCreateRuleDataDTO() throws MVELTranslationException {
    // Arrange
    MVELToDataWrapperTranslator mvelToDataWrapperTranslator = new MVELToDataWrapperTranslator();
   ...
   */
  @Test
  public void testCreateRuleDataDTO2() throws MVELTranslationException {
    // Arrange
    MVELToDataWrapperTranslator mvelToDataWrapperTranslator = new MVELToDataWrapperTranslator();
   ...
   */
  @Test
  public void testPostProcessCriteria() {
    // Arrange
    DataDTO parentDTO = new DataDTO();
    parentDTO.setCondition("Condition");
    parentDTO.setContainedPk(1L);
    ...
    assertSame(rules, temp.getRules());
   ...
   */
  @Test
  public void testPostProcessCriteria2() {
    // Arrange
   ...
   */
  @Test
  public void testPostProcessCriteria3() {
    // Arrange
    DataDTO parentDTO = mock(DataDTO.class);
    doNothing().when(parentDTO).setCondition(Mockito.<String>any());
    doNothing().when(parentDTO).setContainedPk(Mockito.<Long>any());
   ...
   */
  @Test
  public void testPostProcessCriteria4() {
    // Arrange
    DataDTO parentDTO = mock(DataDTO.class);
    doNothing().when(parentDTO).setCondition(Mockito.<String>any());
    doNothing().when(parentDTO).setContainedPk(Mockito.<Long>any());
