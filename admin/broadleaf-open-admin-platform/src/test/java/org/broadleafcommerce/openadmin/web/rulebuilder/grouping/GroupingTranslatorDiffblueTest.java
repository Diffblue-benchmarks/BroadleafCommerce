...
public class GroupingTranslatorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Group GroupingTranslator.createGroups(String)"})
  public void testCreateGroups_givenGroupingTranslator_whenTNR42_thenReturnPhrasesFirstIsTNR423()
      throws MVELTranslationException {
    // Arrange and Act
    Group actualCreateGroupsResult = new GroupingTranslator().createGroups("[\\t\\n\\r]42\t");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Group GroupingTranslator.createGroups(String)"})
  public void testCreateGroups_givenGroupingTranslator_whenTNR_thenReturnPhrasesFirstIsTNR27()
      throws MVELTranslationException {
    // Arrange and Act
    Group actualCreateGroupsResult = new GroupingTranslator().createGroups("[\\t\\n\\r]\\|\\|\t");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Group GroupingTranslator.createGroups(String)"})
  public void testCreateGroups_givenGroupingTranslator_whenTNR_thenReturnPhrasesFirstIsTNR28()
      throws MVELTranslationException {
    // Arrange and Act
    Group actualCreateGroupsResult = new GroupingTranslator().createGroups("[\\t\\n\\r]||\t");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Group GroupingTranslator.createGroups(String)"})
  public void testCreateGroups_givenGroupingTranslator_whenTNR_thenReturnPhrasesFirstIsTNR29()
      throws MVELTranslationException {
    // Arrange and Act
    Group actualCreateGroupsResult = new GroupingTranslator().createGroups("[\\t\\n\\r])\t");
  ...
  public void testCompilePhrases_givenEquals_whenAmpersandAmpersand_thenGroupPhrasesEmpty()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupingTranslator.compilePhrases(String, Group, boolean)"})
  public void testCompilePhrases_givenEquals_whenAmpersandAmpersand_thenGroupPhrasesEmpty2()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupingTranslator.compilePhrases(String, Group, boolean)"})
  public void testCompilePhrases_givenEquals_whenEmptyString_thenGroupPhrasesEmpty()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupingTranslator.compilePhrases(String, Group, boolean)"})
  public void testCompilePhrases_givenEquals_whenFooBar_thenGroupPhrasesSizeIsTwo()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupingTranslator.compilePhrases(String, Group, boolean)"})
  public void testCompilePhrases_givenNull_thenGroupOperatorTypeIsOr()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void GroupingTranslator.compilePhrases(String, Group, boolean)"})
  public void testCompilePhrases_givenNull_whenFooBar_thenGroupOperatorTypeIsAnd()
      throws MVELTranslationException {
    // Arrange
    Group myGroup = new Group();
    myGroup.setIsTopGroup(true);
