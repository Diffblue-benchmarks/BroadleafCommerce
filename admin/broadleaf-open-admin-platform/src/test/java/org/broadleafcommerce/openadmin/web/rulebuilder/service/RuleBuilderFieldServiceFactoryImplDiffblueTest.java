...
public class RuleBuilderFieldServiceFactoryImplDiffblueTest {
  @Mock
  private List<RuleBuilderFieldService> list;

  @InjectMocks
  private RuleBuilderFieldServiceFactoryImpl ruleBuilderFieldServiceFactoryImpl;

  /**
   * Test {@link RuleBuilderFieldServiceFactoryImpl#createInstance(String)}.
   * <p>
   * Method under test: {@link RuleBuilderFieldServiceFactoryImpl#createInstance(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"RuleBuilderFieldService RuleBuilderFieldServiceFactoryImpl.createInstance(String)"})
   ...
   * Test {@link RuleBuilderFieldServiceFactoryImpl#createInstance(String)}.
   * <ul>
   *   <li>Then calls {@link RuleBuilderFieldService#getName()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RuleBuilderFieldServiceFactoryImpl#createInstance(String)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"RuleBuilderFieldService RuleBuilderFieldServiceFactoryImpl.createInstance(String)"})
  public void testCreateInstance_thenCallsGetName() {
    // Arrange
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"List RuleBuilderFieldServiceFactoryImpl.getFieldServices()",
