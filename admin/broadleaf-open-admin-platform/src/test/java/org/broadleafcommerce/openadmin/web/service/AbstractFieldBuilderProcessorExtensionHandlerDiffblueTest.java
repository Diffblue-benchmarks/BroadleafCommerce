...
public class AbstractFieldBuilderProcessorExtensionHandlerDiffblueTest {
  ...
  /**
   * Test {@link AbstractFieldBuilderProcessorExtensionHandler#modifyRuleBuilderFields(String, String, FieldWrapper)}.
   * <p>
   * Method under test: {@link AbstractFieldBuilderProcessorExtensionHandler#modifyRuleBuilderFields(String, String, FieldWrapper)}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AbstractFieldBuilderProcessorExtensionHandler}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
