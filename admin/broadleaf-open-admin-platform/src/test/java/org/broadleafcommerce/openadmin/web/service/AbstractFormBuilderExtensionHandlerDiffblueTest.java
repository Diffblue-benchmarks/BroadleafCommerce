...
public class AbstractFormBuilderExtensionHandlerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#modifyUnpopulatedEntityForm(EntityForm)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#modifyPopulatedEntityForm(EntityForm, Entity)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#modifyDetailEntityForm(EntityForm)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractFormBuilderExtensionHandler#modifyListGridRecord(String, ListGridRecord, Entity)}.
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#modifyListGridRecord(String, ListGridRecord, Entity)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#addAdditionalFormActions(EntityForm)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#modifyListGrid(String, ListGrid)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ExtensionResultStatusType AbstractFormBuilderExtensionHandler.modifyListGrid(String, ListGrid)"})
   ...
   * <p>
   * Method under test: {@link AbstractFormBuilderExtensionHandler#addAdditionalAdornedFormActions(EntityForm)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
