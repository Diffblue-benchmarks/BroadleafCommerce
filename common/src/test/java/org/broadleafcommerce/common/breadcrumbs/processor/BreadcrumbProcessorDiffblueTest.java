...
public class BreadcrumbProcessorDiffblueTest {
  ...
  public void testGetPrecedence() {
    ...
    // Arrange, Act and Assert
    assertEquals(10000, (new BreadcrumbProcessor()).getPrecedence());
  }
  ...
  public void testGetPrecedence2() {
    ...
    // Arrange and Act
    (new BreadcrumbProcessor()).getPrecedence();
  }

  /**
   * Test
   * {@link BreadcrumbProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}.
   * <p>
   * Method under test:
   * {@link BreadcrumbProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}
   */
  ...
  public void testPopulateModelVariables() {
    ...
    // Arrange
    BreadcrumbProcessor breadcrumbProcessor2 = new BreadcrumbProcessor();

    // Act
    breadcrumbProcessor2.populateModelVariables("Tag Name", new HashMap<>(), mock(BroadleafTemplateContext.class));
  }
}
