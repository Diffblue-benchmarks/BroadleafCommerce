...
public class BreadcrumbServiceImplDiffblueTest {
  ...
  public void testBuildBreadcrumbDTOs() {
    ...
    // Arrange
    BreadcrumbServiceImpl breadcrumbServiceImpl2 = new BreadcrumbServiceImpl();

    // Act
    breadcrumbServiceImpl2.buildBreadcrumbDTOs("https://example.org/example", new HashMap<>());
  }
