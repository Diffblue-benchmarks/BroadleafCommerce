...
public class AbstractHydratedCacheManagerDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractHydratedCacheManager#getHydrationDescriptor(Object)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractHydratedCacheManager#getTopEntityClass(Object)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <ul>
   *   <li>Given {@link BigMemoryHydratedCacheEventListener} (default constructor).</li>
