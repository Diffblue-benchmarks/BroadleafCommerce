...
public class BigMemoryHydratedCacheManagerImplDiffblueTest {
  ...
  @MethodsUnderTest({"String BigMemoryHydratedCacheManagerImpl.getBigMemoryHydratedCacheName()",
   ...
   * <p>
   * Method under test: {@link BigMemoryHydratedCacheManagerImpl#getBigMemoryHydratedCacheConfiguration()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Configuration BigMemoryHydratedCacheManagerImpl.getBigMemoryHydratedCacheConfiguration()"})
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link BigMemoryHydratedCacheManagerImpl}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
