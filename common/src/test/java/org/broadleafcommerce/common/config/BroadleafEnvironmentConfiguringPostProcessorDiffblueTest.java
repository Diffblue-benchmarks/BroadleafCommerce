...
public class BroadleafEnvironmentConfiguringPostProcessorDiffblueTest {
  ...
  public void testNewBroadleafEnvironmentConfiguringPostProcessor() {
    // Arrange and Act
    BroadleafEnvironmentConfiguringPostProcessor
        actualBroadleafEnvironmentConfiguringPostProcessor =
            new BroadleafEnvironmentConfiguringPostProcessor();

    // Assert
    List<FrameworkCommonClasspathPropertySource> frameworkSources =
        actualBroadleafEnvironmentConfiguringPostProcessor.getFrameworkSources();
    ...
    List<BroadleafSharedOverrideProfileAwarePropertySource> profileAwareSources =
        actualBroadleafEnvironmentConfiguringPostProcessor.getProfileAwareSources();
    ...
    assertEquals(
        "development",
        actualBroadleafEnvironmentConfiguringPostProcessor.getDeprecatedDefaultProfileKey());
