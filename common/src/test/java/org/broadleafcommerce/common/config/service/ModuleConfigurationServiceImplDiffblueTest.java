...
public class ModuleConfigurationServiceImplDiffblueTest {
  ...
  public void testFindById() {
    ...
    // Arrange and Act
    (new ModuleConfigurationServiceImpl()).findById(1L);
  }
   ...
   * <p>
   * Method under test:
   * {@link ModuleConfigurationServiceImpl#save(ModuleConfiguration)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSave() {
    ...
    // Arrange
    ModuleConfigurationServiceImpl moduleConfigurationServiceImpl2 = new ModuleConfigurationServiceImpl();

    // Act
    moduleConfigurationServiceImpl2.save(new SiteMapConfigurationImpl());
  }
   ...
   * <p>
   * Method under test:
   * {@link ModuleConfigurationServiceImpl#delete(ModuleConfiguration)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testDelete() {
    ...
    // Act
    moduleConfigurationServiceImpl2.delete(new SiteMapConfigurationImpl());
  }

  /**
   * Test
   * {@link ModuleConfigurationServiceImpl#findActiveConfigurationsByType(ModuleConfigurationType)}.
   * <p>
   * Method under test:
   * {@link ModuleConfigurationServiceImpl#findActiveConfigurationsByType(ModuleConfigurationType)}
   */
  ...
  public void testFindActiveConfigurationsByType() {
    ...
    // Arrange and Act
    (new ModuleConfigurationServiceImpl()).findActiveConfigurationsByType(ModuleConfigurationType.ADDRESS_VERIFICATION);
  }

  /**
   * Test
   * {@link ModuleConfigurationServiceImpl#findAllConfigurationByType(ModuleConfigurationType)}.
   * <p>
   * Method under test:
   * {@link ModuleConfigurationServiceImpl#findAllConfigurationByType(ModuleConfigurationType)}
   */
  ...
  public void testFindAllConfigurationByType() {
    ...
    // Arrange and Act
    (new ModuleConfigurationServiceImpl()).findAllConfigurationByType(ModuleConfigurationType.ADDRESS_VERIFICATION);
  }
  ...
  public void testFindByType() {
    ...
    // Act
    moduleConfigurationServiceImpl2.findByType(type);
  }
}
