...
public class MultiTenantCopierDiffblueTest {
  @Autowired
  private MultiTenantCopier multiTenantCopier;
  ...
  public void testGetOrder2() {
    ...
    // Arrange and Act
    (new EntityDuplicatorImpl()).getOrder();
  }
  ...
  public void testSetOrder2() {
    ...
    // Arrange and Act
    (new EntityDuplicatorImpl()).setOrder(1);
  }

  /**
   * Test
   * {@link MultiTenantCopier#persistCopyObjectTree(CopyOperation, Class, Object, MultiTenantCopyContext)}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#persistCopyObjectTree(CopyOperation, Class, Object, MultiTenantCopyContext)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testPersistCopyObjectTree() throws Exception {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange
    EntityDuplicatorImpl entityDuplicatorImpl = new EntityDuplicatorImpl();
    CopyOperation<Object, Exception> copyOperation = mock(CopyOperation.class);
    ...
    // Act
    entityDuplicatorImpl.persistCopyObjectTree(copyOperation, clazz, BLCFieldUtils.NULL_FIELD,
  ...
  /**
   * Test
   * {@link MultiTenantCopier#persistCopyObjectTreeInternal(Object, Set, MultiTenantCopyContext)}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#persistCopyObjectTreeInternal(Object, Set, MultiTenantCopyContext)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testPersistCopyObjectTreeInternal() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    entityDuplicatorImpl.persistCopyObjectTreeInternal(BLCFieldUtils.NULL_FIELD, library, new MultiTenantCopyContext(
        fromCatalog, toCatalog, fromSite, toSite, genericEntityService, new MultiTenantCopierExtensionManager()));
  }
  ...
  public void testExcludeFromCopyRegexPattern() {
    ...
    // Arrange and Act
    (new EntityDuplicatorImpl()).excludeFromCopyRegexPattern(BLCFieldUtils.NULL_FIELD);
  }
  ...
  /**
   * Test {@link MultiTenantCopier#persistNode(Object, MultiTenantCopyContext)}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#persistNode(Object, MultiTenantCopyContext)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testPersistNode() {
    ...
    // Act
    entityDuplicatorImpl.persistNode(BLCFieldUtils.NULL_FIELD, new MultiTenantCopyContext(fromCatalog, toCatalog,
        fromSite, toSite, genericEntityService, new MultiTenantCopierExtensionManager()));
  }

  /**
   * Test
   * {@link MultiTenantCopier#copyEntitiesOfType(Class, Site, Catalog, MultiTenantCopyContext)}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#copyEntitiesOfType(Class, Site, Catalog, MultiTenantCopyContext)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testCopyEntitiesOfType() throws CloneNotSupportedException, ServiceException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange
    EntityDuplicatorImpl entityDuplicatorImpl = new EntityDuplicatorImpl();
    Class<MultiTenantCloneable> clazz = MultiTenantCloneable.class;
    SiteImpl fromSite = new SiteImpl();
    CatalogImpl fromCatalog = new CatalogImpl();
    ...
    // Act
    entityDuplicatorImpl.copyEntitiesOfType(clazz, fromSite, fromCatalog, new MultiTenantCopyContext(fromCatalog2,
        toCatalog, fromSite2, toSite, genericEntityService, new MultiTenantCopierExtensionManager()));
  }
   ...
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#save(MultiTenantCopyContext, Object)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSave() throws ServiceException {
    ...
    // Act
    entityDuplicatorImpl.save(new MultiTenantCopyContext(fromCatalog, toCatalog, fromSite, toSite, genericEntityService,
        new MultiTenantCopierExtensionManager()), BLCFieldUtils.NULL_FIELD);
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testReadCount() throws ServiceException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    entityDuplicatorImpl.readCount(clazz, site, new CatalogImpl());
  }

  /**
   * Test {@link MultiTenantCopier#readAll(Class, int, int, Site, Catalog)} with
   * {@code clazz}, {@code limit}, {@code offset}, {@code site}, {@code catalog}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopier#readAll(Class, int, int, Site, Catalog)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testReadAllWithClazzLimitOffsetSiteCatalog() throws ServiceException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    entityDuplicatorImpl.readAll(clazz, 1, 2, site, new CatalogImpl());
  }

  /**
   * Test {@link MultiTenantCopier#readAll(Class, Site, Catalog)} with
   * {@code clazz}, {@code site}, {@code catalog}.
   * <p>
   * Method under test: {@link MultiTenantCopier#readAll(Class, Site, Catalog)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testReadAllWithClazzSiteCatalog() throws ServiceException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    entityDuplicatorImpl.readAll(clazz, site, new CatalogImpl());
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testReadAllIds() throws ServiceException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
  ...
  public void testNeedToAdd() {
    ...
    // Act
    entityDuplicatorImpl.needToAdd(Pattern.compile(".*\\.txt"));
  }
