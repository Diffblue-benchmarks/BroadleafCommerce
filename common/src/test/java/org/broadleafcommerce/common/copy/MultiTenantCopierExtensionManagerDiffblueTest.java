...
public class MultiTenantCopierExtensionManagerDiffblueTest {
  @Autowired
  private MultiTenantCopierExtensionManager multiTenantCopierExtensionManager;

  /**
   * Test {@link MultiTenantCopierExtensionManager#continueOnHandled()}.
   * <p>
   * Method under test:
   * {@link MultiTenantCopierExtensionManager#continueOnHandled()}
   */
  @Test
  public void testContinueOnHandled() {
    ...
    // Arrange
    MultiTenantCopierExtensionManager multiTenantCopierExtensionManager = new MultiTenantCopierExtensionManager();
    multiTenantCopierExtensionManager.registerHandler(mock(AbstractMultiTenantCopierExtensionHandler.class));

    // Act and Assert
    assertTrue(multiTenantCopierExtensionManager.continueOnHandled());
  }
  ...
  public void testContinueOnHandled2() {
    ...
    // Arrange and Act
    (new MultiTenantCopierExtensionManager()).continueOnHandled();
  }

  /**
   * Test {@link MultiTenantCopierExtensionManager#continueOnHandled()}.
   * <ul>
   *   <li>Given {@link MultiTenantCopierExtensionManager} (default
   * constructor).</li>
   * </ul>
   * <p>
   * Method under test:
   ...
   */
  @Test
  public void testContinueOnHandled_givenMultiTenantCopierExtensionManager() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.

    // Arrange, Act and Assert
    assertTrue((new MultiTenantCopierExtensionManager()).continueOnHandled());
  }
}
