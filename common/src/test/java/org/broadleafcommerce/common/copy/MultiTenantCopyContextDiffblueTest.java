...
public class MultiTenantCopyContextDiffblueTest {
  ...
  public void testGetAllFields_whenJavaLangBoolean_thenReturnSecondElementNameIsFalse() {
    ...
    assertEquals("boolean", field4.getType().getName());
    Field field5 = actualAllFields[4];
    assertEquals("long", field5.getType().getName());
    ...
    Class<Boolean> expectedDeclaringClass2 = Boolean.class;
    assertEquals(expectedDeclaringClass2, field.getDeclaringClass());
    Class<Boolean> expectedDeclaringClass3 = Boolean.class;
    assertEquals(expectedDeclaringClass3, field3.getDeclaringClass());
    Class<Boolean> expectedDeclaringClass4 = Boolean.class;
    assertEquals(expectedDeclaringClass4, field4.getDeclaringClass());
    Class<Boolean> expectedDeclaringClass5 = Boolean.class;
    assertEquals(expectedDeclaringClass5, field5.getDeclaringClass());
    Class<Boolean> expectedType = Boolean.class;
    assertEquals(expectedType, field2.getType());
    Class<Boolean> expectedType2 = Boolean.class;
    assertEquals(expectedType2, field.getType());
    Class<Class> expectedType3 = Class.class;
    assertEquals(expectedType3, field3.getType());
