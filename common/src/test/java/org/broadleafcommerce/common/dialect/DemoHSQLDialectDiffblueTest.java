...
public class DemoHSQLDialectDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link DemoHSQLDialect}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testNewDemoHSQLDialect() {
    ...
    // Assert
    assertTrue(actualDemoHSQLDialect.getIdentityColumnSupport() instanceof HSQLIdentityColumnSupport);
