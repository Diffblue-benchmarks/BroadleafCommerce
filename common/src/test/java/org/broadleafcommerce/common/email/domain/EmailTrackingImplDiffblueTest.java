...
public class EmailTrackingImplDiffblueTest {
  ...
  @MethodsUnderTest({"boolean EmailTrackingImpl.equals(Object)", "int EmailTrackingImpl.hashCode()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void EmailTrackingImpl.<init>()", "Date EmailTrackingImpl.getDateSent()",
      "String EmailTrackingImpl.getEmailAddress()", "Set EmailTrackingImpl.getEmailTrackingClicks()",
      "Set EmailTrackingImpl.getEmailTrackingOpens()", "Long EmailTrackingImpl.getId()",
      "String EmailTrackingImpl.getType()", "void EmailTrackingImpl.setDateSent(Date)",
      "void EmailTrackingImpl.setEmailAddress(String)", "void EmailTrackingImpl.setEmailTrackingClicks(Set)",
      "void EmailTrackingImpl.setEmailTrackingOpens(Set)", "void EmailTrackingImpl.setId(Long)",
