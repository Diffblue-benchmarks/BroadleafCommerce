...
public class LoggingMailSenderDiffblueTest {
  ...
  /**
   * Test {@link LoggingMailSender#send(MimeMessagePreparator[])} with
   * {@code mimeMessagePreparators}.
   * <p>
   * Method under test: {@link LoggingMailSender#send(MimeMessagePreparator[])}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSendWithMimeMessagePreparators() throws MailException {
    ...
    // Arrange and Act
    loggingMailSender.send(new MimeMessagePreparator[]{mock(MimeMessagePreparator.class)});
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testNewLoggingMailSender2() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
