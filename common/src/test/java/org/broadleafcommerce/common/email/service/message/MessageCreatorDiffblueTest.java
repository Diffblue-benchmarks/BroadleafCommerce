...
public class MessageCreatorDiffblueTest {
  ...
  /**
   * Test {@link MessageCreator#sendMessage(Map)}.
   * <ul>
   *   <li>When {@link HashMap#HashMap()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageCreator#sendMessage(Map)}
   */
  @Test
  public void testSendMessage_whenHashMap() throws MailException {
    ...
    // Act
    nullMessageCreator.sendMessage(new HashMap<>());
  }

  /**
   * Test {@link MessageCreator#buildMimeMessagePreparator(Map)}.
   * <p>
   * Method under test: {@link MessageCreator#buildMimeMessagePreparator(Map)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testBuildMimeMessagePreparator() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    ...
    // Act
    nullMessageCreator.buildMimeMessagePreparator(new HashMap<>());
  }
  ...
  public void testGetMailSender() {
    ...
    // Arrange and Act
    (new NullMessageCreator(new LoggingMailSender())).getMailSender();
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testSetMailSender3() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    nullMessageCreator.setMailSender(new LoggingMailSender());
  }
}
