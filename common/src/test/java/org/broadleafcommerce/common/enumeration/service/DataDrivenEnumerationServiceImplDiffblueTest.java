...
public class DataDrivenEnumerationServiceImplDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link DataDrivenEnumerationServiceImpl#findEnumByKey(String)}
   */
  @Test
  ...
  public void testFindEnumByKey() {
    ...
    // Arrange and Act
    (new DataDrivenEnumerationServiceImpl()).findEnumByKey("Enum Key");
  }

  /**
   * Test
   * {@link DataDrivenEnumerationServiceImpl#findEnumValueByKey(String, String)}.
   * <p>
   * Method under test:
   * {@link DataDrivenEnumerationServiceImpl#findEnumValueByKey(String, String)}
   */
  ...
  public void testFindEnumValueByKey() {
    ...
    // Arrange and Act
    (new DataDrivenEnumerationServiceImpl()).findEnumValueByKey("Enum Key", "42");
  }
}
