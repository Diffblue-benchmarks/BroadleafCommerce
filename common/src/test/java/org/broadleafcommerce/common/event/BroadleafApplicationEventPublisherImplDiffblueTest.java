...
public class BroadleafApplicationEventPublisherImplDiffblueTest {
  ...
  /**
   * Test
   * {@link BroadleafApplicationEventPublisherImpl#publishEvent(ApplicationEvent)}.
   * <p>
   * Method under test:
   * {@link BroadleafApplicationEventPublisherImpl#publishEvent(ApplicationEvent)}
   */
  ...
  public void testPublishEvent() {
    ...
    // Arrange
    BroadleafApplicationEventPublisherImpl broadleafApplicationEventPublisherImpl2 = new BroadleafApplicationEventPublisherImpl();

    // Act
    broadleafApplicationEventPublisherImpl2.publishEvent(new ReindexEvent(BLCFieldUtils.NULL_FIELD));
  }

  /**
   * Test
   * {@link BroadleafApplicationEventPublisherImpl#publishEventUnsynchronized(ApplicationEvent)}.
   * <p>
   * Method under test:
   * {@link BroadleafApplicationEventPublisherImpl#publishEventUnsynchronized(ApplicationEvent)}
   */
  ...
  public void testPublishEventUnsynchronized() {
    ...
    // Act
    broadleafApplicationEventPublisherImpl2.publishEventUnsynchronized(new ReindexEvent(BLCFieldUtils.NULL_FIELD));
  }
}
