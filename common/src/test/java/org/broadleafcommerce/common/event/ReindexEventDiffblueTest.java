...
public class ReindexEventDiffblueTest {
  ...
  public void testNewReindexEvent() {
    ...
    // Assert
    assertNull(actualReindexEvent.getCatalogId());
    assertNull(actualReindexEvent.getProfileId());
    assertNull(actualReindexEvent.getSiteId());
    ...
    assertNull(actualReindexEvent.getCurrencyCode());
    assertNull(actualReindexEvent.getLocaleCode());
    assertNull(actualReindexEvent.getTimeZoneId());
    assertSame(broadleafRequestContext, actualReindexEvent.getSource());
  }
}
