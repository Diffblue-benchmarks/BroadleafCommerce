...
public class BroadleafSimpleMappingExceptionResolverDiffblueTest {
  ...
  public void testDoResolveException() throws IOException {
    ...
    // Arrange
    BroadleafSimpleMappingExceptionResolver broadleafSimpleMappingExceptionResolver2 = new BroadleafSimpleMappingExceptionResolver();
    ...
    // Act
    broadleafSimpleMappingExceptionResolver2.doResolveException(request, response2, BLCFieldUtils.NULL_FIELD,
        new Exception("foo"));
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testResolveException3() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    broadleafSimpleMappingExceptionResolver2.resolveException(request, response2, BLCFieldUtils.NULL_FIELD,
        new Exception("foo"));
  }
