...
public class DefaultEhCacheConfigurationBuilderDiffblueTest {
  @Autowired
  private DefaultEhCacheConfigurationBuilder defaultEhCacheConfigurationBuilder;

  /**
   * Test
   * {@link DefaultEhCacheConfigurationBuilder#buildConfiguration(int, int, Class, Class)}
  ...
  public void testBuildConfigurationWithTtlSecondsMaxElementsInMemoryKeyClassValueClass() {
    ...
    // Arrange
    DefaultEhCacheConfigurationBuilder defaultEhCacheConfigurationBuilder2 = new DefaultEhCacheConfigurationBuilder();
    Class<Object> keyClass = Object.class;
    Class<Object> valueClass = Object.class;

    // Act
    defaultEhCacheConfigurationBuilder2.buildConfiguration(1, 3, keyClass, valueClass);
  }
}
