...
public class DynamicResourceIteratorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link DynamicResourceIterator#addEmbeddedResource(ResourceInputStream)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link DynamicResourceIterator#buildArrayFromStream(InputStream)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
