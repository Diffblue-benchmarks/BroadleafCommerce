...
import org.broadleafcommerce.test.common.test.merge.MergeAnnotationTest;
import org.broadleafcommerce.test.common.test.merge.MergeAnnotationTest.Config1;
...
public class MergeAnnotationAwareBeanDefinitionRegistryPostProcessorDiffblueTest {
  ...
  public void testIsBroadleafBean() {
    // Arrange
    MergeAnnotationAwareBeanDefinitionRegistryPostProcessor mergeProcessorResult =
        Config1.mergeProcessor();
    Class<Object> introspectedClass = Object.class;
    StandardAnnotationMetadata metadata = new StandardAnnotationMetadata(introspectedClass);
    JarClassLoader classLoader = new JarClassLoader();
    MethodMetadataReadingVisitor factoryMethodMetadata =
        new MethodMetadataReadingVisitor(
            "Method Name",
            1,
            "Declaring Class Name",
    ...
    AnnotatedGenericBeanDefinition beanDefinition =
        new AnnotatedGenericBeanDefinition(metadata, factoryMethodMetadata);

    // Act
    boolean actualIsBroadleafBeanResult = mergeProcessorResult.isBroadleafBean(beanDefinition);

    // Assert
    assertFalse(actualIsBroadleafBeanResult);
  }
  ...
  public void testIsBroadleafBean3() {
    // Arrange
    MergeAnnotationAwareBeanDefinitionRegistryPostProcessor mergeProcessorResult =
        Config1.mergeProcessor();
    Class<Object> introspectedClass = Object.class;
   ...
   *   <li>Then calls {@link Resource#getFilename()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * MergeAnnotationAwareBeanDefinitionRegistryPostProcessor#isBroadleafBean(BeanDefinition)}
  ...
  public void testIsBroadleafBean_givenResourceGetFilenameReturnBl_thenCallsGetFilename() {
    // Arrange
  ...
  public void testIsBroadleafBean_thenThrowFactoryBeanNotInitializedException() {
    // Arrange
    Resource resource = mock(Resource.class);
    when(resource.getFilename()).thenThrow(new FactoryBeanNotInitializedException());
