...
@ContextConfiguration(locations = {"/context/merge/bl-framework.xml", "/bl-common-applicationContext-entity.xml",
    ...
    "/context/importer/merge/applicationContext.xml", "/context/merge/bl-module.xml", "/context/merge/local.xml",
...
public class MergeAnnotationAwareBeanDefinitionRegistryPostProcessorDiffblueTest {
  ...
  public void testPostProcessBeanDefinitionRegistry2() throws BeansException {
    ...
    mergeAnnotationAwareBeanDefinitionRegistryPostProcessor
        .postProcessBeanDefinitionRegistry(new DefaultListableBeanFactory());
  }
  ...
  public void testIsBroadleafAnnotationBean2() {
    ...
    // Arrange and Act
    mergeAnnotationAwareBeanDefinitionRegistryPostProcessor.isBroadleafAnnotationBean(new StandardMethodMetadata(null));
  }
  ...
  public void testIsBroadleafBean() {
    ...
    // Arrange and Act
    mergeAnnotationAwareBeanDefinitionRegistryPostProcessor.isBroadleafBean(new GenericBeanDefinition());
  }
   ...
   * <ul>
   *   <li>Then calls
   * {@link ScannedGenericBeanDefinition#getFactoryMethodMetadata()}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link MergeAnnotationAwareBeanDefinitionRegistryPostProcessor#isBroadleafBean(BeanDefinition)}
   */
  @Test
  public void testIsBroadleafBean_thenCallsGetFactoryMethodMetadata() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.

    // Arrange
    MergeAnnotationAwareBeanDefinitionRegistryPostProcessor mergeAnnotationAwareBeanDefinitionRegistryPostProcessor = new MergeAnnotationAwareBeanDefinitionRegistryPostProcessor();
    ScannedGenericBeanDefinition beanDefinition = mock(ScannedGenericBeanDefinition.class);
    when(beanDefinition.getFactoryMethodMetadata()).thenThrow(new FactoryBeanNotInitializedException("Msg"));

    // Act
    mergeAnnotationAwareBeanDefinitionRegistryPostProcessor.isBroadleafBean(beanDefinition);

    // Assert
    verify(beanDefinition).getFactoryMethodMetadata();
  }
  ...
  /**
   * Test
   * {@link MergeAnnotationAwareBeanDefinitionRegistryPostProcessor#postProcessBeanFactory(ConfigurableListableBeanFactory)}.
   * <p>
   * Method under test:
   * {@link MergeAnnotationAwareBeanDefinitionRegistryPostProcessor#postProcessBeanFactory(ConfigurableListableBeanFactory)}
   */
  @Test
  public void testPostProcessBeanFactory() throws BeansException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    ...
    // Act
    mergeAnnotationAwareBeanDefinitionRegistryPostProcessor.postProcessBeanFactory(new DefaultListableBeanFactory());
  }
}
