...
public class MultiTenantMergeBeanStatusProviderDiffblueTest {
  ...
  public void testIsProcessingEnabled() {
    ...
    // Arrange
    MultiTenantMergeBeanStatusProvider multiTenantMergeBeanStatusProvider2 = new MultiTenantMergeBeanStatusProvider();

    // Act
    multiTenantMergeBeanStatusProvider2.isProcessingEnabled(BLCFieldUtils.NULL_FIELD, "Bean Name",
