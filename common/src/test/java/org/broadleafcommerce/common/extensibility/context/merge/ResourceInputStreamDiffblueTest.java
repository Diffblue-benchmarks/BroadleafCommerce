...
public class ResourceInputStreamDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link ResourceInputStream#close()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testClose_givenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8_thenDoesNotThrow()
      throws IOException {
    // Arrange
    try (ResourceInputStream resourceInputStream =
        new ResourceInputStream(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")), "Name")) {}
  }
  ...
  public void testReset_givenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8_thenDoesNotThrow()
      throws IOException {
    // Arrange, Act and Assert
    new ResourceInputStream(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")), "Name").reset();
  }
