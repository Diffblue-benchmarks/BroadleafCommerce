...
public class AutoDDLCreateStatusTestBeanImplDiffblueTest {
  @Autowired
  private AutoDDLCreateStatusTestBeanImpl autoDDLCreateStatusTestBeanImpl;

  /**
   * Test {@link AutoDDLCreateStatusTestBeanImpl#getStartedWithCreate(String)}.
   * <p>
   * Method under test: {@link AutoDDLCreateStatusTestBeanImpl#getStartedWithCreate(String)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link AutoDDLCreateStatusTestBeanImpl#setStartedWithCreate(String, Boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testSetStartedWithCreate() {
    // Arrange
    AutoDDLCreateStatusTestBeanImpl autoDDLCreateStatusTestBeanImpl2 = new AutoDDLCreateStatusTestBeanImpl();

    // Act
    autoDDLCreateStatusTestBeanImpl2.setStartedWithCreate("Pu", true);

    // Assert
    Map<String, Boolean> stringResultBooleanMap = autoDDLCreateStatusTestBeanImpl2.startedWithCreate;
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AutoDDLCreateStatusTestBeanImpl}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
