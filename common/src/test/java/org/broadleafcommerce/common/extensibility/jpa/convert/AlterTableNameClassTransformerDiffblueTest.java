...
public class AlterTableNameClassTransformerDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AlterTableNameClassTransformer#AlterTableNameClassTransformer(String, String)} with {@code Table Name} and {@code Targeted Class}.</li>
   * </ul>
   * <p>
  ...
  public void testTransform_givenAlterTableNameClassTransformerWithTableNameAndTargetedClass()
    ...
    // Arrange
    AlterTableNameClassTransformer alterTableNameClassTransformer = new AlterTableNameClassTransformer("Table Name",
        "Targeted Class");
   ...
   * Test {@link AlterTableNameClassTransformer#transform(ClassLoader, String, Class, ProtectionDomain, byte[])}.
   * <ul>
   *   <li>Given {@link AlterTableNameClassTransformer}.</li>
  ...
  @MethodsUnderTest({
      "byte[] AlterTableNameClassTransformer.transform(ClassLoader, String, Class, ProtectionDomain, byte[])"})
  public void testTransform_givenAlterTableNameClassTransformer_whenClassName_thenReturnNull()
      throws UnsupportedEncodingException, IllegalClassFormatException, MalformedURLException {
    // Arrange
    JarClassLoader loader = new JarClassLoader();
    Class<Object> classBeingRedefined = Object.class;
