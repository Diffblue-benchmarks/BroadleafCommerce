...
public class EntityMarkerClassTransformerDiffblueTest {
  ...
  /**
   * Test
   * {@link EntityMarkerClassTransformer#transform(ClassLoader, String, Class, ProtectionDomain, byte[])}.
   * <p>
   * Method under test:
   * {@link EntityMarkerClassTransformer#transform(ClassLoader, String, Class, ProtectionDomain, byte[])}
   */
  ...
  public void testTransform() throws UnsupportedEncodingException, IllegalClassFormatException, MalformedURLException {
    ...
    // Act
    entityMarkerClassTransformer.transform(loader, "Class Name", classBeingRedefined, protectionDomain,
        "AXAXAXAX".getBytes("UTF-8"));
  }

  /**
   * Test
   * {@link EntityMarkerClassTransformer#containsTypeLevelPersistenceAnnotation(Annotation[])}.
   * <p>
   * Method under test:
   * {@link EntityMarkerClassTransformer#containsTypeLevelPersistenceAnnotation(Annotation[])}
   */
  ...
  public void testIsIgnored() {
    ...
    // Arrange and Act
    entityMarkerClassTransformer.isIgnored("Converted Class Name");
  }
