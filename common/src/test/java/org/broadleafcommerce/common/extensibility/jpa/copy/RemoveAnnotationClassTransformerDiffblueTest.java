...
public class RemoveAnnotationClassTransformerDiffblueTest {
  @Autowired private RemoveAnnotationClassTransformer removeAnnotationClassTransformer;
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void RemoveAnnotationClassTransformer.<init>(String)",
  ...
  public void testGettersAndSetters() throws Exception {
    // Arrange and Act
    RemoveAnnotationClassTransformer actualRemoveAnnotationClassTransformer =
        new RemoveAnnotationClassTransformer("Module Name");
    ...
    actualRemoveAnnotationClassTransformer.compileJPAProperties(
    ...
    assertEquals(
        "Conditional Property Name",
        actualRemoveAnnotationClassTransformer.getConditionalPropertyName());
  ...
  /**
   * Test {@link RemoveAnnotationClassTransformer#transform(ClassLoader, String, Class,
   ...
   * </ul>
   *
   * <p>Method under test: {@link RemoveAnnotationClassTransformer#transform(ClassLoader, String,
  ...
  public void testTransform_givenArrayListAddFoo_whenClassName_thenReturnNull()
      throws UnsupportedEncodingException, IllegalClassFormatException, MalformedURLException {
    // Arrange
    ArrayList<String> classNames = new ArrayList<>();
    classNames.add("foo");

    RemoveAnnotationClassTransformer removeAnnotationClassTransformer =
        new RemoveAnnotationClassTransformer("Module Name");
    removeAnnotationClassTransformer.setClassNames(classNames);
    ...
    // Act and Assert
    assertNull(
        removeAnnotationClassTransformer.transform(
            loader,
            "Class Name",
            classBeingRedefined,
            protectionDomain,
   ...
   *
   * <ul>
   *   <li>Given {@link RemoveAnnotationClassTransformer}.
   *   <li>When {@code Class Name}.
   *   <li>Then return {@code null}.
   * </ul>
   *
  ...
  public void testTransform_givenRemoveAnnotationClassTransformer_whenClassName_thenReturnNull()
      throws UnsupportedEncodingException, IllegalClassFormatException, MalformedURLException {
    // Arrange
    JarClassLoader loader = new JarClassLoader();
    Class<Object> classBeingRedefined = Object.class;
  ...
  public void testTransform_givenRemoveAnnotationClassTransformer_whenNull_thenReturnNull()
      throws UnsupportedEncodingException, IllegalClassFormatException, MalformedURLException {
    // Arrange
    JarClassLoader loader = new JarClassLoader();
    Class<Object> classBeingRedefined = Object.class;
   ...
   *   <li>Then return Name is {@code RuntimeVisibleAnnotations}.
   * </ul>
   *
   * <p>Method under test: {@link RemoveAnnotationClassTransformer#stripAnnotation(ConstPool, List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "AnnotationsAttribute RemoveAnnotationClassTransformer.stripAnnotation(ConstPool, List)"
  })
  public void testStripAnnotation_givenNull_field_thenReturnNameIsRuntimeVisibleAnnotations() {
    // Arrange
    ...
    AnnotationsAttribute actualStripAnnotationResult =
        removeAnnotationClassTransformer.stripAnnotation(constantPool, attributes);
  ...
  public void testStripAnnotation_givenNull_field_thenReturnNameIsRuntimeVisibleAnnotations2() {
    // Arrange
    ConstPool constantPool = new ConstPool("Thisclass");
  ...
  public void testStripAnnotation_whenArrayList_thenArrayListEmpty() {
    // Arrange
    ConstPool constantPool = new ConstPool("Thisclass");
    ArrayList<Object> attributes = new ArrayList<>();
   ...
   * </ul>
   *
   * <p>Method under test: {@link RemoveAnnotationClassTransformer#isPropertyEnabled(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.lang.Boolean RemoveAnnotationClassTransformer.isPropertyEnabled(String)"
  })
   ...
   *
   * <ul>
   *   <li>Given {@link RemoveAnnotationClassTransformer#RemoveAnnotationClassTransformer(String)}
   *       with {@code Module Name}.
   * </ul>
   *
   * <p>Method under test: {@link RemoveAnnotationClassTransformer#isPropertyEnabled(String)}
   */
  ...
  public void testIsPropertyEnabled_givenRemoveAnnotationClassTransformerWithModuleName() {
    // Arrange, Act and Assert
    assertFalse(
        new RemoveAnnotationClassTransformer("Module Name").isPropertyEnabled("Property Name"));
  }
}
