...
public class FileSystemFileServiceProviderDiffblueTest {
  ...
  public void testGetResourceWithUrl2() {
    ...
    // Arrange and Act
    (new FileSystemFileServiceProvider()).getResource("https://example.org/example");
  }
  ...
  public void testGetResourceWithUrlApplicationType() {
    ...
    // Arrange and Act
    (new FileSystemFileServiceProvider()).getResource("https://example.org/example", FileApplicationType.ALL);
  }
  ...
  public void testAddOrUpdateResources() {
    ...
    // Arrange
    FileSystemFileServiceProvider fileSystemFileServiceProvider2 = new FileSystemFileServiceProvider();
    FileWorkArea workArea = new FileWorkArea();

    // Act
    fileSystemFileServiceProvider2.addOrUpdateResources(workArea, new ArrayList<>(), true);
  }
  ...
  public void testAddOrUpdateResourcesForPaths() {
    ...
    // Act
    fileSystemFileServiceProvider2.addOrUpdateResourcesForPaths(workArea, new ArrayList<>(), true);
  }
  ...
  public void testRemoveResource2() {
    ...
    // Arrange and Act
    (new FileSystemFileServiceProvider()).removeResource("Name");
  }
  ...
  public void testGetBaseDirectory2() {
    ...
    // Arrange and Act
    (new FileSystemFileServiceProvider()).getBaseDirectory(true);
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetSiteDirectory3() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new FileSystemFileServiceProvider()).getSiteDirectory("/directory");
  }
}
