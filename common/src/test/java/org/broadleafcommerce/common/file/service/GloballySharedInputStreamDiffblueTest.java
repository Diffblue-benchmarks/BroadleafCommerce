...
public class GloballySharedInputStreamDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link GloballySharedInputStream#close()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testClose_givenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8_thenDoesNotThrow()
      throws IOException {
    // Arrange
    try (GloballySharedInputStream globallySharedInputStream =
        new GloballySharedInputStream(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")))) {}
  }
  ...
  public void testReset_givenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8_thenDoesNotThrow()
      throws IOException {
    // Arrange, Act and Assert
    new GloballySharedInputStream(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8"))).reset();
  }
