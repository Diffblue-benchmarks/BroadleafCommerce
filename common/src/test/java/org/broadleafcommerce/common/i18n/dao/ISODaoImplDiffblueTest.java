...
@Transactional
public class ISODaoImplDiffblueTest {
  @Autowired
  private ISODaoImpl iSODaoImpl;

  /**
   * Test {@link ISODaoImpl#findISOCountryByAlpha2Code(String)}.
   * <p>
   * Method under test: {@link ISODaoImpl#findISOCountryByAlpha2Code(String)}
   */
  @Test
  ...
  public void testFindISOCountryByAlpha2Code() {
    ...
    // Arrange and Act
    (new ISODaoImpl()).findISOCountryByAlpha2Code("Alpha2");
  }

  /**
   * Test {@link ISODaoImpl#findISOCountries()}.
   * <p>
   * Method under test: {@link ISODaoImpl#findISOCountries()}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testFindISOCountries() {
    ...
    // Arrange and Act
    (new ISODaoImpl()).findISOCountries();
  }

  /**
   * Test {@link ISODaoImpl#save(ISOCountry)}.
   * <p>
   * Method under test: {@link ISODaoImpl#save(ISOCountry)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSave() {
    ...
    // Arrange
    ISODaoImpl isoDaoImpl = new ISODaoImpl();

    // Act
    isoDaoImpl.save(new ISOCountryImpl());
  }
}
