...
public class TranslationDaoImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TranslationDaoImpl} (default constructor).
  ...
  public void testFindBestTranslation_givenTranslationDaoImpl_thenCallsGetLocaleCode() {
    // Arrange
  ...
  public void testFindSpecificTranslation_givenTranslationDaoImpl_whenArrayList_thenReturnNull() {
    // Arrange
    TranslationDaoImpl translationDaoImpl = new TranslationDaoImpl();
