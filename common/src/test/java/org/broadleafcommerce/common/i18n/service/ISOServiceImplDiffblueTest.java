...
public class ISOServiceImplDiffblueTest {
  ...
  public void testFindISOCountries() {
    ...
    // Arrange and Act
    (new ISOServiceImpl()).findISOCountries();
  }
  ...
  public void testFindISOCountryByAlpha2Code() {
    ...
    // Arrange and Act
    (new ISOServiceImpl()).findISOCountryByAlpha2Code("Alpha2");
  }
  ...
  public void testSave() {
    ...
    // Arrange
    ISOServiceImpl isoServiceImpl = new ISOServiceImpl();

    // Act
    isoServiceImpl.save(new ISOCountryImpl());
  }
}
