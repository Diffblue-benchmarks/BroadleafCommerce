...
public class IdGenerationDaoImplDiffblueTest {
  ...
  @MethodsUnderTest({"Long IdGenerationDaoImpl.getDefaultBatchSize()",
      "Long IdGenerationDaoImpl.getDefaultBatchStart()", "void IdGenerationDaoImpl.setDefaultBatchSize(Long)",
