...
public class IdGenerationDaoImplDiffblueTest {
  @Autowired
  private IdGenerationDaoImpl idGenerationDaoImpl;

  /**
   * Test {@link IdGenerationDaoImpl#findNextId(String)} with {@code idType}.
   * <p>
   * Method under test: {@link IdGenerationDaoImpl#findNextId(String)}
   */
  @Test
  ...
  public void testFindNextIdWithIdType() throws Exception {
    ...
    // Arrange and Act
    (new IdGenerationDaoImpl()).findNextId("Id Type");
  }

  /**
   * Test {@link IdGenerationDaoImpl#findNextId(String, Long)} with
   * {@code idType}, {@code batchSize}.
   * <p>
   * Method under test: {@link IdGenerationDaoImpl#findNextId(String, Long)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testFindNextIdWithIdTypeBatchSize() throws Exception {
    ...
    // Arrange and Act
    (new IdGenerationDaoImpl()).findNextId("Id Type", 3L);
  }
