...
public class IdGenerationServiceImplDiffblueTest {
  ...
  public void testFindNextIdWithIdType() {
    ...
    // Arrange and Act
    (new IdGenerationServiceImpl()).findNextId("Id Type");
  }

  /**
   * Test {@link IdGenerationServiceImpl#findNextId(String, Long)} with
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testFindNextIdWithIdTypeBatchSize() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new IdGenerationServiceImpl()).findNextId("Id Type", 3L);
  }
}
