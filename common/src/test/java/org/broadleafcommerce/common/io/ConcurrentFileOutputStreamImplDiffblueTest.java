...
public class ConcurrentFileOutputStreamImplDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link ConcurrentFileOutputStreamImpl#write(InputStream, File)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testWriteWithSrcDest() throws IOException {
    ...
    // Arrange
    ConcurrentFileOutputStreamImpl concurrentFileOutputStreamImpl2 = new ConcurrentFileOutputStreamImpl();
    ByteArrayInputStream src = new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8"));

    // Act
    concurrentFileOutputStreamImpl2.write(src, Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile());
  }

  /**
   * Test {@link ConcurrentFileOutputStreamImpl#write(InputStream, File, int)}
   * with {@code src}, {@code dest}, {@code bufferSize}.
   * <p>
   * Method under test:
   * {@link ConcurrentFileOutputStreamImpl#write(InputStream, File, int)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testWriteWithSrcDestBufferSize() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    concurrentFileOutputStreamImpl2.write(src, Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile(), 3);
  }

  /**
   * Test {@link ConcurrentFileOutputStreamImpl#createTempFile(File)}.
   * <p>
   * Method under test:
   * {@link ConcurrentFileOutputStreamImpl#createTempFile(File)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testCreateTempFile() throws IOException {
    ...
    concurrentFileOutputStreamImpl2
        .createTempFile(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile());
  }

  /**
   * Test {@link ConcurrentFileOutputStreamImpl#getTempFileSuffix()}.
   * <p>
   * Method under test: {@link ConcurrentFileOutputStreamImpl#getTempFileSuffix()}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetTempFileSuffix() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new ConcurrentFileOutputStreamImpl()).getTempFileSuffix();
  }

  /**
   * Test
   * {@link ConcurrentFileOutputStreamImpl#writeToTempFile(InputStream, File, int)}.
   * <p>
   * Method under test:
   * {@link ConcurrentFileOutputStreamImpl#writeToTempFile(InputStream, File, int)}
   */
  ...
  public void testWriteToTempFile() throws IOException {
    ...
    // Act
    concurrentFileOutputStreamImpl2.writeToTempFile(src,
        Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile(), 3);
  }
  ...
  public void testReplaceExisting() throws IOException {
    ...
    // Act
    concurrentFileOutputStreamImpl2.replaceExisting(src,
