...
@ContextConfiguration(locations = {"/bl-common-applicationContext-mbeans.xml",
    "/bl-common-applicationContext-entity.xml", "/bl-common-applicationContext-persistence.xml",
...
public class AnnotationJmxAttributeSourceDiffblueTest {
  ...
  /**
   * Test
   * {@link AnnotationJmxAttributeSource#AnnotationJmxAttributeSource(String)}.
   * <p>
   * Method under test:
   * {@link AnnotationJmxAttributeSource#AnnotationJmxAttributeSource(String)}
   */
  @Test
  public void testNewAnnotationJmxAttributeSource() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing observers.
    //   Diffblue Cover was unable to create an assertion.
    //   Add getters for the following fields or make them package-private:
    //     AnnotationJmxAttributeSource.appName
    //     AnnotationJmxAttributeSource.embeddedValueResolver

    // Arrange and Act
    new AnnotationJmxAttributeSource("App Name");
  }
  ...
  public void testGetManagedResource2() throws InvalidMetadataException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
