...
public class MetadataNamingStrategyDiffblueTest {
  ...
  public void testGetObjectName() throws MalformedObjectNameException {
    ...
    // Arrange and Act
    metadataNamingStrategy.getObjectName(BLCFieldUtils.NULL_FIELD, "Bean Key");
  }
  ...
  /**
   * Test new {@link MetadataNamingStrategy} (default constructor).
   * <p>
   * Method under test: default or parameterless constructor of
   * {@link MetadataNamingStrategy}
   */
  @Test
  public void testNewMetadataNamingStrategy() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing observers.
    //   Diffblue Cover was unable to create an assertion.
    //   Add getters for the following fields or make them package-private:
    //     MetadataNamingStrategy.attributeSource
    //     MetadataNamingStrategy.defaultDomain

    // Arrange and Act
    new MetadataNamingStrategy();
  }
}
