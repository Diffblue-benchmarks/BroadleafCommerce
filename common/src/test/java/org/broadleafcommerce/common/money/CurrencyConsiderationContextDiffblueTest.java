...
public class CurrencyConsiderationContextDiffblueTest {
   ...
   * <p>
   * Method under test: {@link CurrencyConsiderationContext#getCurrencyConsiderationContext()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.util.HashMap CurrencyConsiderationContext.getCurrencyConsiderationContext()"})
