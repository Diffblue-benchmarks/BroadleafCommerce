...
public class PaymentAdditionalFieldTypeDiffblueTest {
  @Autowired private PaymentAdditionalFieldType paymentAdditionalFieldType;
   ...
   *
   * <p>Method under test: {@link PaymentAdditionalFieldType#PaymentAdditionalFieldType(String,
   * String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
