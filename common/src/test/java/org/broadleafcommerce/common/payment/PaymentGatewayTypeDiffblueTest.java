...
public class PaymentGatewayTypeDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PaymentGatewayType.<init>()", "String PaymentGatewayType.getFriendlyType()",
   ...
   * <p>
   * Method under test: {@link PaymentGatewayType#PaymentGatewayType(String, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PaymentGatewayType.equals(Object)", "int PaymentGatewayType.hashCode()"})
