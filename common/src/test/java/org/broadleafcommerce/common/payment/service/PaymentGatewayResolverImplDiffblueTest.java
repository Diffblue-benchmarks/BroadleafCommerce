...
public class PaymentGatewayResolverImplDiffblueTest {
  ...
  public void testIsHandlerCompatible() {
    ...
    // Arrange and Act
    (new PaymentGatewayResolverImpl()).isHandlerCompatible(PaymentGatewayType.PASSTHROUGH);
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testResolvePaymentGateway3() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange
    PaymentGatewayResolverImpl paymentGatewayResolverImpl2 = new PaymentGatewayResolverImpl();

    // Act
    paymentGatewayResolverImpl2.resolvePaymentGateway(
        new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }
}
