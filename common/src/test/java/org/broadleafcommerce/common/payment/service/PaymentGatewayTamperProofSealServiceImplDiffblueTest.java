...
public class PaymentGatewayTamperProofSealServiceImplDiffblueTest {
  ...
  public void testCreateTamperProofSeal() throws InvalidKeyException, NoSuchAlgorithmException {
    ...
    // Arrange and Act
    (new PaymentGatewayTamperProofSealServiceImpl()).createTamperProofSeal("EXAMPLEKEYwjalrXUtnFEMI/K7MDENG/bPxRfiCY",
        "42", "42");
  }
  ...
  public void testVerifySeal() throws InvalidKeyException, NoSuchAlgorithmException {
    ...
    // Arrange and Act
    (new PaymentGatewayTamperProofSealServiceImpl()).verifySeal("Seal", "EXAMPLEKEYwjalrXUtnFEMI/K7MDENG/bPxRfiCY",
        "42", "42");
  }
