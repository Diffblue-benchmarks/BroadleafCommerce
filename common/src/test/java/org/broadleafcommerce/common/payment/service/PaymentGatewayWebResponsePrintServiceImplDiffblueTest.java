...
public class PaymentGatewayWebResponsePrintServiceImplDiffblueTest {
  @Autowired
  private PaymentGatewayWebResponsePrintServiceImpl paymentGatewayWebResponsePrintServiceImpl;

  /**
   * Test
   * {@link PaymentGatewayWebResponsePrintServiceImpl#printRequest(HttpServletRequest)}.
   * <p>
   * Method under test:
   * {@link PaymentGatewayWebResponsePrintServiceImpl#printRequest(HttpServletRequest)}
   */
  ...
  public void testPrintRequest() {
    ...
    // Arrange
    PaymentGatewayWebResponsePrintServiceImpl paymentGatewayWebResponsePrintServiceImpl2 = new PaymentGatewayWebResponsePrintServiceImpl();

    // Act
    paymentGatewayWebResponsePrintServiceImpl2
        .printRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest()));
  }
}
