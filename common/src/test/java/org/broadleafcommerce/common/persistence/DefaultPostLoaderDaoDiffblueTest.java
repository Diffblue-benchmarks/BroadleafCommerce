...
public class DefaultPostLoaderDaoDiffblueTest {
   ...
   * <p>
   * Method under test: {@link DefaultPostLoaderDao#getPostLoaderDao()}
   */
  @Test
  ...
  public void testGetPostLoaderDao() {
    ...
    //   test threw
    //   java.lang.IllegalStateException: org.springframework.boot.web.reactive.context.AnnotationConfigReactiveWebApplicationContext@2f248498 has not been refreshed yet
    //       at org.broadleafcommerce.common.persistence.DefaultPostLoaderDao.getPostLoaderDao(DefaultPostLoaderDao.java:49)
    //   See https://diff.blue/R013 to resolve this issue.

    // Arrange and Act
    DefaultPostLoaderDao.getPostLoaderDao();
  }

  /**
   * Test {@link DefaultPostLoaderDao#setApplicationContext(ApplicationContext)}.
   * <p>
   * Method under test:
   * {@link DefaultPostLoaderDao#setApplicationContext(ApplicationContext)}
   */
  @Test
  public void testSetApplicationContext() throws BeansException {
    ...
    //     DefaultPostLoaderDao.applicationContext
    //     DefaultPostLoaderDao.persistenceService
    //     DefaultPostLoaderDao.postLoaderDao

    // Arrange
    DefaultPostLoaderDao defaultPostLoaderDao = new DefaultPostLoaderDao();

    // Act
    defaultPostLoaderDao.setApplicationContext(new AnnotationConfigReactiveWebApplicationContext());
  }
  ...
  public void testFind() {
    ...
    // Arrange
    DefaultPostLoaderDao defaultPostLoaderDao2 = new DefaultPostLoaderDao();
    Class<Object> clazz = Object.class;

    // Act
    defaultPostLoaderDao2.find(clazz, BLCFieldUtils.NULL_FIELD);
  }
   ...
   * <p>
   * Method under test:
   * {@link DefaultPostLoaderDao#findSandboxEntity(Class, Object)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testFindSandboxEntity() {
    ...
    // Act
    defaultPostLoaderDao2.findSandboxEntity(clazz, BLCFieldUtils.NULL_FIELD);
  }
  ...
  public void testGetEntityManager() {
    ...
    // Act
    defaultPostLoaderDao2.getEntityManager(clazz);
  }
}
