...
public class EntityDuplicatorImplDiffblueTest {
  ...
  /**
   * Test {@link EntityDuplicatorImpl#copy(Class, Long)} with {@code entityClass},
   * {@code id}.
   * <p>
  ...
  public void testCopyWithEntityClassId() {
    ...
    // Arrange
    EntityDuplicatorImpl entityDuplicatorImpl2 = new EntityDuplicatorImpl();
    Class<Object> entityClass = Object.class;

    // Act
    entityDuplicatorImpl2.copy(entityClass, 1L);
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testCopyWithEntityClassId2() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
