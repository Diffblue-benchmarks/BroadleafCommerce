...
public class QueryHelperImplDiffblueTest {
  ...
  public void testGetSingleton() {
    ...
    //   test threw
    //   java.lang.IllegalStateException: org.springframework.boot.web.reactive.context.AnnotationConfigReactiveWebApplicationContext@2e5eb21f has not been refreshed yet
    //       at org.broadleafcommerce.common.persistence.QueryHelperImpl.getSingleton(QueryHelperImpl.java:48)
    //   See https://diff.blue/R013 to resolve this issue.

    // Arrange and Act
    QueryHelperImpl.getSingleton();
  }

  /**
   * Test {@link QueryHelperImpl#setApplicationContext(ApplicationContext)}.
   * <p>
   * Method under test:
   * {@link QueryHelperImpl#setApplicationContext(ApplicationContext)}
   */
  @Test
  public void testSetApplicationContext() throws BeansException {
    ...
    //     QueryHelperImpl.applicationContext
    //     QueryHelperImpl.queryHelper

    // Arrange
    QueryHelperImpl queryHelperImpl = new QueryHelperImpl();

    // Act
    queryHelperImpl.setApplicationContext(new AnnotationConfigReactiveWebApplicationContext());
  }

  /**
   * Test {@link QueryHelperImpl#getResultListWithHint(Query, String, Object)}
   * with {@code Query}, {@code String}, {@code Object}.
   * <p>
   * Method under test:
   * {@link QueryHelperImpl#getResultListWithHint(Query, String, Object)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetResultListWithHintWithQueryStringObject() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    ...
    // Arrange
    QueryHelperImpl queryHelperImpl2 = new QueryHelperImpl();
    SessionDelegatorBaseImpl delegate = new SessionDelegatorBaseImpl(null);

    // Act
    queryHelperImpl2.getResultListWithHint(
        new ProcedureCallImpl<>(new SessionDelegatorBaseImpl(delegate, new SessionDelegatorBaseImpl(null)),
            "Procedure Name"),
        "Hint Key", BLCFieldUtils.NULL_FIELD);
  }

  /**
   * Test
   * {@link QueryHelperImpl#getResultListWithHint(TypedQuery, String, Object)}
   * with {@code TypedQuery}, {@code String}, {@code Object}.
   * <p>
   * Method under test:
   * {@link QueryHelperImpl#getResultListWithHint(TypedQuery, String, Object)}
   */
  ...
  /**
   * Test {@link QueryHelperImpl#getSingleResultWithHint(Query, String, Object)}
   * with {@code Query}, {@code String}, {@code Object}.
   * <p>
   * Method under test:
   * {@link QueryHelperImpl#getSingleResultWithHint(Query, String, Object)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetSingleResultWithHintWithQueryStringObject() {
    ...
    // Act
    queryHelperImpl2.getSingleResultWithHint(
        new ProcedureCallImpl<>(new SessionDelegatorBaseImpl(delegate, new SessionDelegatorBaseImpl(null)),
            "Procedure Name"),
        "Hint Key", BLCFieldUtils.NULL_FIELD);
  }
  ...
  /**
   * Test
   * {@link QueryHelperImpl#getSingleResultWithHint(TypedQuery, String, Object)}
   * with {@code TypedQuery}, {@code String}, {@code Object}.
   * <p>
   * Method under test:
   * {@link QueryHelperImpl#getSingleResultWithHint(TypedQuery, String, Object)}
  ...
  public void testGetQueryHint() {
    ...
    // Arrange and Act
    (new QueryHelperImpl()).getQueryHint("Hint Key");
  }
