...
public class SequenceGeneratorCorruptionDetectionDiffblueTest {
  ...
  /**
   * Test
   * {@link SequenceGeneratorCorruptionDetection#onApplicationEvent(ContextRefreshedEvent)}
  ...
  public void testOnApplicationEventWithContextRefreshedEvent() {
    ...
    // Arrange
    SequenceGeneratorCorruptionDetection sequenceGeneratorCorruptionDetection2 = new SequenceGeneratorCorruptionDetection();

    // Act
    sequenceGeneratorCorruptionDetection2
        .onApplicationEvent(new ContextRefreshedEvent(new AnnotationConfigReactiveWebApplicationContext()));
  }

  /**
   * Test
   * {@link SequenceGeneratorCorruptionDetection#patchSequenceGeneratorInconsistencies(EntityManager, Session)}.
   * <p>
   * Method under test:
   * {@link SequenceGeneratorCorruptionDetection#patchSequenceGeneratorInconsistencies(EntityManager, Session)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testPatchSequenceGeneratorInconsistencies() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    SessionDelegatorBaseImpl delegate2 = new SessionDelegatorBaseImpl(null);

    // Act
    sequenceGeneratorCorruptionDetection2.patchSequenceGeneratorInconsistencies(em,
        new SessionDelegatorBaseImpl(delegate2, new SessionDelegatorBaseImpl(null)));
  }
}
