...
public class CompressedItemDiffblueTest {
  ...
  public void testCompress_thenReturnArrayOfByteWithThirtyOneAndMinusOneHundredSeventeen()
    ...
    assertArrayEquals(
        new byte[] {
          31, -117, '\b', 0, 0, 0, 0, 0, 0, -1, 11, '.', ')', 2, 0, 25, -27, -29, 'd', 3, 0, 0, 0
        },
   ...
   *
   * <ul>
   *   <li>Then return {@code H4sIAAAAAAAA/wsuSSwqAQCLerheBQAAAA==}.
   * </ul>
   *
   * <p>Method under test: {@link CompressedItem#toString()}
   */
  ...
  public void testToString_thenReturnH4sIAAAAAAAAWsuSSwqAQCLerheBQAAAA() throws IOException {
    // Arrange, Act and Assert
    assertEquals(
        "H4sIAAAAAAAA/wsuSSwqAQCLerheBQAAAA==", new CompressedItem("Start", false).toString());
  }
  ...
  public void testNewCompressedItem_whenStart_thenReturnDecompressIsStart() throws IOException {
    ...
    assertArrayEquals(
        new byte[] {
          31, -117, '\b', 0, 0, 0, 0, 0, 0, -1, 11, '.', 'I', ',', '*', 1, 0, -117, 'z', -72, '^',
          5, 0, 0, 0
        },
