...
public class ResourceMinificationExceptionDiffblueTest {
   ...
   */
  @Test
  public void testNewResourceMinificationException() {
    // Arrange and Act
   ...
   */
  @Test
  public void testNewResourceMinificationException2() {
    // Arrange and Act
    ResourceMinificationException actualResourceMinificationException = new ResourceMinificationException(
        "An error occurred");
   ...
   */
  @Test
  public void testNewResourceMinificationException3() {
    // Arrange
   ...
   */
  @Test
  public void testNewResourceMinificationException4() {
    // Arrange
    Throwable cause = new Throwable();
