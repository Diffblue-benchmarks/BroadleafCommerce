...
public class SandBoxServiceImplDiffblueTest {
  @Mock private Map<String, Long> map;
  ...
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_givenMapContainsKeyReturnTrue() {
    // Arrange
    when(map.get(Mockito.<Object>any())).thenReturn(5L);
    ...
    assertEquals(5L, actualCreateUserSandBoxResult.longValue());
  }
  ...
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_thenCallsCreateUserSandBox() {
    ...
    when(map.put(Mockito.<String>any(), Mockito.<Long>any())).thenReturn(5L);
    when(map.get(Mockito.<Object>any())).thenReturn(5L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Long SandBoxServiceImpl.createUserSandBox(Long, Long)"})
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_thenCallsPut() {
    // Arrange
    when(sandBoxDao.retrieveNamedSandBox(
            Mockito.<SandBoxType>any(), Mockito.<String>any(), Mockito.<Long>any()))
        .thenReturn(new SandBoxImpl());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Long SandBoxServiceImpl.createUserSandBox(Long, Long)"})
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_whenFour_thenCallsPut() {
    // Arrange
    when(sandBoxDao.retrieveNamedSandBox(
            Mockito.<SandBoxType>any(), Mockito.<String>any(), Mockito.<Long>any()))
        .thenReturn(new SandBoxImpl());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Long SandBoxServiceImpl.createUserSandBox(Long, Long)"})
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_whenThree_thenCallsPut() {
    // Arrange
    when(sandBoxDao.retrieveNamedSandBox(
            Mockito.<SandBoxType>any(), Mockito.<String>any(), Mockito.<Long>any()))
        .thenReturn(new SandBoxImpl());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Long SandBoxServiceImpl.createUserSandBox(Long, Long)"})
  public void testCreateUserSandBoxWithAuthorIdApprovalSandbox_whenTwo_thenCallsPut() {
    // Arrange
    when(sandBoxDao.retrieveNamedSandBox(
            Mockito.<SandBoxType>any(), Mockito.<String>any(), Mockito.<Long>any()))
        .thenReturn(new SandBoxImpl());
