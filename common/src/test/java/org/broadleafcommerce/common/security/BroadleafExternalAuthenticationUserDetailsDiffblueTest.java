...
public class BroadleafExternalAuthenticationUserDetailsDiffblueTest {
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails() {
    // Arrange and Act
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails2() {
    // Arrange
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails3() {
    // Arrange
    ArrayList<GrantedAuthority> authorities = new ArrayList<>();
    authorities.add(new SimpleGrantedAuthority("Role"));
    authorities.add(new SimpleGrantedAuthority("Role"));
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails4() {
    // Arrange and Act
    BroadleafExternalAuthenticationUserDetails actualBroadleafExternalAuthenticationUserDetails = new BroadleafExternalAuthenticationUserDetails(
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails5() {
    // Arrange
    ArrayList<GrantedAuthority> authorities = new ArrayList<>();
    authorities.add(new SimpleGrantedAuthority("Role"));
   ...
   */
  @Test
  public void testNewBroadleafExternalAuthenticationUserDetails6() {
    // Arrange
    ArrayList<GrantedAuthority> authorities = new ArrayList<>();
    authorities.add(new SimpleGrantedAuthority("Role"));
    authorities.add(new SimpleGrantedAuthority("Role"));
