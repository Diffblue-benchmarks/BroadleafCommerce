...
public class SecurityFilterDiffblueTest {
  ...
  /**
   * Test {@link SecurityFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}.
   * <p>
   * Method under test: {@link SecurityFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void SecurityFilter.doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"List SecurityFilter.getExcludedRequestPatterns()",
