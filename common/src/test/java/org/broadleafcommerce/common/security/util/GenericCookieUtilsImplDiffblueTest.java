...
public class GenericCookieUtilsImplDiffblueTest {
  ...
  /**
   * Test {@link GenericCookieUtilsImpl#shouldUseSecureCookieIfApplicable()}.
   * <p>
   * Method under test:
   * {@link GenericCookieUtilsImpl#shouldUseSecureCookieIfApplicable()}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testShouldUseSecureCookieIfApplicable() {
    ...
    // Arrange and Act
    (new GenericCookieUtilsImpl()).shouldUseSecureCookieIfApplicable();
  }
  ...
  public void testGetCookieValue3() {
    ...
    // Arrange
    GenericCookieUtilsImpl genericCookieUtilsImpl2 = new GenericCookieUtilsImpl();

    // Act
    genericCookieUtilsImpl2.getCookieValue(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest()),
        "Cookie Name");
  }
  ...
  /**
   * Test
   * {@link GenericCookieUtilsImpl#setCookieValue(HttpServletResponse, String, String)}
   * with {@code response}, {@code cookieName}, {@code cookieValue}.
   * <p>
   * Method under test:
   * {@link GenericCookieUtilsImpl#setCookieValue(HttpServletResponse, String, String)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSetCookieValueWithResponseCookieNameCookieValue() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    genericCookieUtilsImpl2.setCookieValue(new StatusExposingServletResponse(
  ...
  /**
   * Test
   * {@link GenericCookieUtilsImpl#setCookieValue(HttpServletResponse, String, String, String, Integer, Boolean)}
   * with {@code response}, {@code cookieName}, {@code cookieValue}, {@code path},
   * {@code maxAge}, {@code isSecure}.
   * <p>
   * Method under test:
   * {@link GenericCookieUtilsImpl#setCookieValue(HttpServletResponse, String, String, String, Integer, Boolean)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testSetCookieValueWithResponseCookieNameCookieValuePathMaxAgeIsSecure() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    genericCookieUtilsImpl2.setCookieValue(
        new StatusExposingServletResponse(new FileSystemResponseWrapper(response,
            Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile())),
        "Cookie Name", "42", "Path", 3, true);
  }

  /**
   * Test
   * {@link GenericCookieUtilsImpl#invalidateCookie(HttpServletResponse, String)}.
   * <p>
   * Method under test:
   * {@link GenericCookieUtilsImpl#invalidateCookie(HttpServletResponse, String)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testInvalidateCookie() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    genericCookieUtilsImpl2.invalidateCookie(new StatusExposingServletResponse(
        new FileSystemResponseWrapper(response, Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile())),
        "Cookie Name");
  }
}
