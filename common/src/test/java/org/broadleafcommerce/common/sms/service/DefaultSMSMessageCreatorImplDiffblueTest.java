...
public class DefaultSMSMessageCreatorImplDiffblueTest {
  @Autowired
  private DefaultSMSMessageCreatorImpl defaultSMSMessageCreatorImpl;

  /**
   * Test {@link DefaultSMSMessageCreatorImpl#sendMessage(SMSMessage, Map)}.
   * <p>
   * Method under test:
   * {@link DefaultSMSMessageCreatorImpl#sendMessage(SMSMessage, Map)}
   */
  @Test
  ...
  public void testSendMessage() {
    ...
    // Arrange
    DefaultSMSMessageCreatorImpl defaultSMSMessageCreatorImpl2 = new DefaultSMSMessageCreatorImpl();
    SMSMessage message = new SMSMessage("alice.liddell@example.org", "jane.doe@example.org",
        "Not all who wander are lost");

    // Act
    defaultSMSMessageCreatorImpl2.sendMessage(message, new HashMap<>());
  }
}
