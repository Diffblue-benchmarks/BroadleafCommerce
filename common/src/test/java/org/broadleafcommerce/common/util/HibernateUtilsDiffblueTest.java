...
public class HibernateUtilsDiffblueTest {
  /**
   * Test {@link HibernateUtils#executeWithCache(GenericOperation, EntityManager)} with {@code operation}, {@code em}.
   * <ul>
   *   <li>Given {@link Exception#Exception(String)} with {@code foo}.</li>
   *   <li>Then throw {@link Exception}.</li>
   * </ul>
   * <p>
   * Method under test: {@link HibernateUtils#executeWithCache(GenericOperation, EntityManager)}
   */
  @Test
  ...
  /**
   * Test {@link HibernateUtils#executeWithoutCache(GenericOperation, EntityManager)} with {@code operation}, {@code em}.
   * <ul>
   *   <li>Given {@link Exception#Exception(String)} with {@code foo}.</li>
   *   <li>Then throw {@link Exception}.</li>
   * </ul>
   * <p>
   * Method under test: {@link HibernateUtils#executeWithoutCache(GenericOperation, EntityManager)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
