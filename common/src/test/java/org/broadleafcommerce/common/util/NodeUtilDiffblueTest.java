...
public class NodeUtilDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void NodeUtil.mergeNodeLists(Node, NodeList, NodeList, String)"})
  public void testMergeNodeLists_givenDefaultElementWithTextAndTextAndTextAndTextAndThree2() {
    // Arrange
    IIOMetadataNode targetNode = new IIOMetadataNode();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void NodeUtil.mergeNodeLists(Node, NodeList, NodeList, String)"})
  public void testMergeNodeLists_whenNull_thenIIOMetadataNodeLengthIsThree() {
    // Arrange
    IIOMetadataNode targetNode = new IIOMetadataNode();
  ...
  public void testMergeNodeLists_whenNull_thenIIOMetadataNodeLengthIsZero() {
    ...
    // Act
    NodeUtil.mergeNodeLists(targetNode, null, new IIOMetadataNode(), "Attribute Name");
  ...
  public void testNodeComparatorBySingleAttributeCompareWithNodeNode() {
    ...
    assertEquals(
        -1,
        nodeComparatorBySingleAttribute.compare(
            o1,
            new org.htmlunit.cyberneko.html.dom.HTMLAnchorElementImpl(
                new HTMLDocumentImpl(), "Name")));
  }
  ...
  public void testNodeComparatorBySingleAttributeCompareWithNodeNode_thenReturnOne() {
    ...
    NodeComparatorBySingleAttribute nodeComparatorBySingleAttribute =
        new NodeComparatorBySingleAttribute("Attribute Name");
    org.htmlunit.cyberneko.html.dom.HTMLAnchorElementImpl o1 =
        new org.htmlunit.cyberneko.html.dom.HTMLAnchorElementImpl(new HTMLDocumentImpl(), "Name");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int NodeComparatorBySingleAttribute.compare(Node, Node)"})
  public void testNodeComparatorBySingleAttributeCompareWithNodeNode_whenIIOMetadataNode() {
    // Arrange
    NodeComparatorBySingleAttribute nodeComparatorBySingleAttribute =
        new NodeComparatorBySingleAttribute("Attribute Name");
    IIOMetadataNode o1 = new IIOMetadataNode();
