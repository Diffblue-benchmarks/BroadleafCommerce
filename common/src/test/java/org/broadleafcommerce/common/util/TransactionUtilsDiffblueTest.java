...
public class TransactionUtilsDiffblueTest {
   ...
   */
  @Test
  public void testFinalizeTransaction2() throws TransactionException {
    // Arrange
    DefaultTransactionStatus status = mock(DefaultTransactionStatus.class);
    when(status.isRollbackOnly()).thenReturn(true);
   ...
   */
  @Test
  public void testFinalizeTransaction3() throws TransactionException {
    // Arrange
    DefaultTransactionStatus status = mock(DefaultTransactionStatus.class);
    when(status.isRollbackOnly()).thenReturn(true);
    PlatformTransactionManager transactionManager = mock(PlatformTransactionManager.class);
   ...
   */
  @Test
  public void testFinalizeTransaction4() throws TransactionException {
    // Arrange
    DefaultTransactionStatus status = mock(DefaultTransactionStatus.class);
