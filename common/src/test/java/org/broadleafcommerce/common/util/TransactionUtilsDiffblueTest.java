...
public class TransactionUtilsDiffblueTest {
  /**
   * Test {@link TransactionUtils#createTransaction(int, int, PlatformTransactionManager, boolean)} with {@code propagationBehavior}, {@code isolationLevel}, {@code transactionManager}, {@code isReadOnly}.
   * <p>
   * Method under test: {@link TransactionUtils#createTransaction(int, int, PlatformTransactionManager, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
      "TransactionStatus TransactionUtils.createTransaction(int, int, PlatformTransactionManager, boolean)"})
  ...
  /**
   * Test {@link TransactionUtils#finalizeTransaction(TransactionStatus, PlatformTransactionManager, boolean)} with {@code status}, {@code transactionManager}, {@code isError}.
   * <ul>
   *   <li>Then calls {@link PlatformTransactionManager#commit(TransactionStatus)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TransactionUtils#finalizeTransaction(TransactionStatus, PlatformTransactionManager, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
