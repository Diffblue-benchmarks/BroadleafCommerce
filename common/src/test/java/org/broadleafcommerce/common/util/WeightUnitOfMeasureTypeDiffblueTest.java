...
public class WeightUnitOfMeasureTypeDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void WeightUnitOfMeasureType.<init>()", "String WeightUnitOfMeasureType.getFriendlyType()",
   ...
   * <p>
   * Method under test: {@link WeightUnitOfMeasureType#WeightUnitOfMeasureType(String, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  /**
   * Test {@link WeightUnitOfMeasureType#equals(Object)}, and {@link WeightUnitOfMeasureType#hashCode()}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean WeightUnitOfMeasureType.equals(Object)", "int WeightUnitOfMeasureType.hashCode()"})
