...
public class DynamicDaoHelperImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return array of {@link Class} with.
   * </ul>
   *
  ...
  public void testGetCachedPolymorphicEntityList_thenReturnArrayOfClassWith() {
    // Arrange
    DynamicDaoHelperImpl dynamicDaoHelperImpl = new DynamicDaoHelperImpl();
  ...
  public void testSortEntities_givenJavaLangClass_thenReturnArrayLengthIsFour() {
    ...
    assertEquals(expectedResultClass2, actualSortEntitiesResult[2]);
    Class<Object> expectedResultClass3 = Object.class;
    assertEquals(expectedResultClass3, actualSortEntitiesResult[3]);
  }
   ...
   * <ul>
   *   <li>Given {@code Class}.
   *   <li>Then return array of {@link Class} with and.
   * </ul>
   *
   * <p>Method under test: {@link DynamicDaoHelperImpl#sortEntities(Class, List)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Class[] DynamicDaoHelperImpl.sortEntities(Class, List)"})
  public void testSortEntities_givenJavaLangClass_thenReturnArrayOfClassWithAnd() {
    // Arrange
    Class<Object> ceilingClass = Object.class;
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Class[] DynamicDaoHelperImpl.sortEntities(Class, List)"})
  public void testSortEntities_whenJavaLangObject_thenReturnArrayOfClassWith() {
    // Arrange
    Class<Object> ceilingClass = Object.class;
    ...
    // Assert
    assertTrue(entities.isEmpty());
    assertArrayEquals(new Class[] {Object.class}, actualSortEntitiesResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Class[] DynamicDaoHelperImpl.sortEntities(Class, List)"})
  public void testSortEntities_whenJavaLangObject_thenReturnArrayOfClassWithAnd() {
    // Arrange
    Class<Object> ceilingClass = Object.class;
    ...
    // Assert
    assertTrue(entities.isEmpty());
    assertArrayEquals(new Class[] {Object.class, Object.class}, actualSortEntitiesResult);
  }
  ...
  public void testGetIdMetadata_thenReturnNull() {
    ...
    when(entityManager.unwrap(Session.class)).thenReturn(sessionDelegatorBaseImpl);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Map DynamicDaoHelperImpl.getIdMetadata(Class, EntityManager)"})
  public void testGetIdMetadata_thenThrowProxyDetectionException() {
    // Arrange
    DynamicDaoHelperImpl dynamicDaoHelperImpl = new DynamicDaoHelperImpl();
    ...
    assertThrows(
        ProxyDetectionException.class,
        () ->
            dynamicDaoHelperImpl.getIdMetadata(entityClass, mock(SessionDelegatorBaseImpl.class)));
  }
