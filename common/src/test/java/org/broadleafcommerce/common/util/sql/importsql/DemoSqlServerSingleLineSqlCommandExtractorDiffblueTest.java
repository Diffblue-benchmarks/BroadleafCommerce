...
public class DemoSqlServerSingleLineSqlCommandExtractorDiffblueTest {
  ...
  public void testReplaceBoolean4() {
    // Arrange, Act and Assert
    assertEquals(
        ",  'FALSE',org.broadleafcommerce.common.util.sql.importsql.DemoSqlServerSingleLineSqlComman"
            + "dExtractor",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(
            ",  false  ,org.broadleafcommerce.common.util.sql.importsql.DemoSqlServerSingleLineSqlComman"
                + "dExtractor"));
  ...
  public void testReplaceBoolean_whenAString_thenReturnAString2() {
    // Arrange, Act and Assert
    assertEquals(
        ",  CURRENT_TIMESTAMP,org.broadleafcommerce.common.util.sql.importsql.DemoSqlServerSingleLineSqlComma"
            + "ndExtractor",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(
            ",  current_date  ,org.broadleafcommerce.common.util.sql.importsql.DemoSqlServerSingleLineSqlComman"
                + "dExtractor"));
  ...
  public void testReplaceBoolean_whenFalse42_thenReturnFalse422() {
    ...
    assertEquals(
        ",  'FALSE',42",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(",  false  ,42"));
  }
  ...
  public void testReplaceBoolean_whenFalseMd_thenReturnFalseMd2() {
    ...
    assertEquals(
        ",  'FALSE',MD",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(",  false  ,MD"));
  }
  ...
  public void testReplaceBoolean_whenFalse_thenReturnFalse6() {
    ...
    assertEquals(
        ",  'FALSE',\\",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(",  false  ,\\\\"));
  }
  ...
  public void testReplaceBoolean_whenMdFalse_thenReturnMdFalse() {
    ...
    assertEquals(
        "MD,  'FALSE',",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean("MD,  false  ,"));
  }
  ...
  public void testReplaceBoolean_whenTrue_thenReturnTrue6() {
    ...
    assertEquals(
        ",  'TRUE',\\",
        demoSqlServerSingleLineSqlCommandExtractor.replaceBoolean(",  true  ,\\\\"));
  }
