...
public class ConditionalFieldAnnotationCopyTransformersManagerImplDiffblueTest {
  ...
  /**
   * Test {@link ConditionalFieldAnnotationCopyTransformersManagerImpl#init()}.
   * <p>
   * Method under test:
   * {@link ConditionalFieldAnnotationCopyTransformersManagerImpl#init()}
   */
  @Test
  ...
  public void testInit() {
    ...
    // Arrange and Act
    (new ConditionalFieldAnnotationCopyTransformersManagerImpl()).init();
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testIsEntityEnabled2() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testGetTransformMember3() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new ConditionalFieldAnnotationCopyTransformersManagerImpl()).getTransformMember("Entity Name");
  }

  /**
   * Test
   * {@link ConditionalFieldAnnotationCopyTransformersManagerImpl#setBeanFactory(BeanFactory)}.
   * <p>
   * Method under test:
   * {@link ConditionalFieldAnnotationCopyTransformersManagerImpl#setBeanFactory(BeanFactory)}
   */
  ...
  public void testSetBeanFactory() throws BeansException {
    ...
    //     ConditionalFieldAnnotationCopyTransformersManagerImpl.beanFactory
    //     ConditionalFieldAnnotationCopyTransformersManagerImpl.enabledEntities
    //     ConditionalFieldAnnotationCopyTransformersManagerImpl.entityToPropertyMap
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testIsPropertyEnabled2() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new ConditionalFieldAnnotationCopyTransformersManagerImpl()).isPropertyEnabled("Property Name");
  }
