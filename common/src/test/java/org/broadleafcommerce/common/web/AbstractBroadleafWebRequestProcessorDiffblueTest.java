...
public class AbstractBroadleafWebRequestProcessorDiffblueTest {
  @Autowired
  private AbstractBroadleafWebRequestProcessor abstractBroadleafWebRequestProcessor;

  /**
   * Test {@link AbstractBroadleafWebRequestProcessor#postProcess(WebRequest)}.
   * <p>
   * Method under test:
   * {@link AbstractBroadleafWebRequestProcessor#postProcess(WebRequest)}
   */
  @Test
