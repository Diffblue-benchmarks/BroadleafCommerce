...
public class BroadleafCurrencyResolverImplDiffblueTest {
  ...
  /**
   * Test
   * {@link BroadleafCurrencyResolverImpl#resolveCurrency(HttpServletRequest)}
  ...
  public void testResolveCurrencyWithHttpServletRequest() {
    ...
    // Arrange
    BroadleafCurrencyResolverImpl broadleafCurrencyResolverImpl2 = new BroadleafCurrencyResolverImpl();

    // Act
    broadleafCurrencyResolverImpl2
        .resolveCurrency(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest()));
  }

  /**
   * Test {@link BroadleafCurrencyResolverImpl#resolveCurrency(WebRequest)} with
   * {@code WebRequest}.
   * <p>
   * Method under test:
   * {@link BroadleafCurrencyResolverImpl#resolveCurrency(WebRequest)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testResolveCurrencyWithWebRequest() {
    ...
    // Act
    broadleafCurrencyResolverImpl2
        .resolveCurrency(new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }
}
