...
public class BroadleafLocaleResolverImplDiffblueTest {
  ...
  /**
   * Test {@link BroadleafLocaleResolverImpl#resolveLocale(HttpServletRequest)}
   * with {@code HttpServletRequest}.
   * <p>
   * Method under test:
   * {@link BroadleafLocaleResolverImpl#resolveLocale(HttpServletRequest)}
   */
  @Test
  ...
  public void testResolveLocaleWithHttpServletRequest() {
    ...
    // Arrange
    BroadleafLocaleResolverImpl broadleafLocaleResolverImpl2 = new BroadleafLocaleResolverImpl();

    // Act
    broadleafLocaleResolverImpl2.resolveLocale(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest()));
  }

  /**
   * Test {@link BroadleafLocaleResolverImpl#resolveLocale(WebRequest)} with
   * {@code WebRequest}.
   * <p>
   * Method under test:
   * {@link BroadleafLocaleResolverImpl#resolveLocale(WebRequest)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testResolveLocaleWithWebRequest() {
    ...
    // Act
    broadleafLocaleResolverImpl2
        .resolveLocale(new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }
}
