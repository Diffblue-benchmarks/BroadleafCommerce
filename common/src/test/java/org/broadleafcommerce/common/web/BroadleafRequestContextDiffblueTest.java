...
public class BroadleafRequestContextDiffblueTest {
   ...
   */
  @Test
  public void testIsProductionSandBox() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testIsProductionSandBox2() {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();
    broadleafRequestContext.setSandBox(new SandBoxImpl());
  ...
  public void testGetJavaLocale() {
    ...
    // Assert
    assertSame(actualJavaLocale.ENGLISH, actualJavaLocale);
  }
  ...
  public void testGetJavaCurrency() {
    // Arrange
    BroadleafCurrencyImpl broadleafCurrency = mock(BroadleafCurrencyImpl.class);
  ...
  public void testConvertLocaleToJavaLocale() {
    ...
    // Assert
    Locale locale = actualConvertLocaleToJavaLocaleResult.ENGLISH;
   ...
   */
  @Test
  public void testConvertLocaleToJavaLocale2() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testConvertLocaleToJavaLocale3() {
    // Arrange, Act and Assert
   ...
   */
  @Test
  public void testConvertLocaleToJavaLocale4() throws MissingResourceException {
    // Arrange
    ...
    assertEquals("", actualConvertLocaleToJavaLocaleResult.getCountry());
    assertEquals("", actualConvertLocaleToJavaLocaleResult.getDisplayCountry());
    ...
    assertEquals("", actualConvertLocaleToJavaLocaleResult.getISO3Country());
    ...
    assertEquals("English", actualConvertLocaleToJavaLocaleResult.getDisplayName());
   ...
   */
  @Test
  public void testConvertLocaleToJavaLocale5() {
    // Arrange
    org.broadleafcommerce.common.locale.domain.Locale broadleafLocale = mock(
        org.broadleafcommerce.common.locale.domain.Locale.class);
   ...
   */
  @Test
  public void testGetExplicitCatalogs() {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();

    // Act
    List<Long> actualExplicitCatalogs = broadleafRequestContext.getExplicitCatalogs();

    // Assert
    assertTrue(actualExplicitCatalogs.isEmpty());
    assertSame(broadleafRequestContext.explicitCatalogs, actualExplicitCatalogs);
  }
   ...
   */
  @Test
  public void testGetExplicitCatalogs2() {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();
   ...
   */
  @Test
  public void testGetIgnoreSite2() {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();
   ...
   */
  @Test
  public void testGetIgnoreSite3() {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();
  ...
  public void testCreateLightWeightClone() throws MissingResourceException {
    ...
    List<Long> explicitCatalogs = actualCreateLightWeightCloneResult.getExplicitCatalogs();
    assertTrue(explicitCatalogs.isEmpty());
    ...
    assertSame(actualCreateLightWeightCloneResult.explicitCatalogs, explicitCatalogs);
  ...
  public void testNewBroadleafRequestContext() throws MissingResourceException {
    ...
    List<Long> explicitCatalogs = actualBroadleafRequestContext.getExplicitCatalogs();
    assertTrue(explicitCatalogs.isEmpty());
    ...
    assertSame(actualBroadleafRequestContext.explicitCatalogs, explicitCatalogs);
  }
}
