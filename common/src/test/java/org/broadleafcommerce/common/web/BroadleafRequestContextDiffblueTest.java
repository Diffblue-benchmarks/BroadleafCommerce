...
public class BroadleafRequestContextDiffblueTest {
  ...
  public void testGetJavaLocale() {
    // Arrange and Act
    java.util.Locale actualJavaLocale = (new BroadleafRequestContext()).getJavaLocale();
   ...
   * <ul>
   *   <li>Given Default.</li>
   *   <li>Then {@link BroadleafRequestContext} (default constructor) JavaLocale is Default {@link java.util.Locale#ENGLISH}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BroadleafRequestContext#setLocale(Locale)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void BroadleafRequestContext.setLocale(Locale)"})
  public void testSetLocale_givenDefault_thenBroadleafRequestContextJavaLocaleIsDefaultEnglish()
      throws MissingResourceException {
    // Arrange
    BroadleafRequestContext broadleafRequestContext = new BroadleafRequestContext();
    Locale locale = mock(Locale.class);
    java.util.Locale resultDefault = java.util.Locale.getDefault();
    ...
    java.util.Locale expectedJavaLocale = resultDefault.ENGLISH;
  ...
  public void testConvertLocaleToJavaLocale() {
    ...
    // Act
    java.util.Locale actualConvertLocaleToJavaLocaleResult = broadleafRequestContext.convertLocaleToJavaLocale();

    // Assert
    java.util.Locale locale = actualConvertLocaleToJavaLocaleResult.ENGLISH;
   ...
   * </ul>
   * <p>
   * Method under test: {@link BroadleafRequestContext#convertLocaleToJavaLocale(Locale)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @MethodsUnderTest({"Map BroadleafRequestContext.getAdditionalProperties()",
      ...
      "Boolean BroadleafRequestContext.getInternalValidateFind()", "Locale BroadleafRequestContext.getLocale()",
