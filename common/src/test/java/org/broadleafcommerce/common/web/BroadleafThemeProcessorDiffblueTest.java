...
public class BroadleafThemeProcessorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BroadleafThemeProcessor#process(WebRequest)}
   */
  @Test
  ...
  public void testProcess() {
    ...
    // Arrange
    BroadleafThemeProcessor broadleafThemeProcessor2 = new BroadleafThemeProcessor();

    // Act
    broadleafThemeProcessor2
        .process(new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }

  /**
   * Test {@link BroadleafThemeProcessor#postProcess(WebRequest)}.
   * <p>
   * Method under test: {@link BroadleafThemeProcessor#postProcess(WebRequest)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testPostProcess() {
    ...
    // Act
    broadleafThemeProcessor2
        .postProcess(new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }
}
