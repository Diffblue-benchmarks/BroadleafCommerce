...
public class BroadleafTimeZoneResolverImplDiffblueTest {
  @Autowired
  private BroadleafTimeZoneResolverImpl broadleafTimeZoneResolverImpl;
  ...
  public void testResolveTimeZone2() {
    ...
    // Arrange
    BroadleafTimeZoneResolverImpl broadleafTimeZoneResolverImpl2 = new BroadleafTimeZoneResolverImpl();

    // Act
    broadleafTimeZoneResolverImpl2
        .resolveTimeZone(new ServletWebRequest(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
  }
