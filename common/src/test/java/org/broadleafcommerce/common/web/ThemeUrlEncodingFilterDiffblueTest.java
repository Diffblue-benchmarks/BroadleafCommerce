...
public class ThemeUrlEncodingFilterDiffblueTest {
  ...
  @Autowired
  private ThemeUrlEncodingFilter themeUrlEncodingFilter;

  /**
   * Test {@link ThemeUrlEncodingFilter#doFilter(ServletRequest, ServletResponse, FilterChain)}.
   * <p>
   * Method under test: {@link ThemeUrlEncodingFilter#doFilter(ServletRequest, ServletResponse, FilterChain)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void ThemeUrlEncodingFilter.doFilter(ServletRequest, ServletResponse, FilterChain)"})
