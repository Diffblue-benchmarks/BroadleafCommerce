...
public class DataDrivenEnumVariableExpressionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link DataDrivenEnumVariableExpression} (default constructor).
   *   <li>When {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link DataDrivenEnumVariableExpression#getEnumValues(String, String)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataDrivenEnumVariableExpression.getEnumValues(String, String)"})
  public void testGetEnumValuesWithKeySort_givenDataDrivenEnumVariableExpression_whenNull() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class,
        () -> new DataDrivenEnumVariableExpression().getEnumValues(null, "not empty"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataDrivenEnumVariableExpression.getEnumValues(String, String)"})
  public void testGetEnumValuesWithKeySort_whenEmptyString() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class,
        () -> new DataDrivenEnumVariableExpression().getEnumValues("", "not empty"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataDrivenEnumVariableExpression.getEnumValues(String)"})
  public void testGetEnumValuesWithKey_givenDataDrivenEnumVariableExpression_whenEmptyString() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class,
        () -> new DataDrivenEnumVariableExpression().getEnumValues(""));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataDrivenEnumVariableExpression.getEnumValues(String)"})
  public void testGetEnumValuesWithKey_givenDataDrivenEnumVariableExpression_whenNull() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class,
