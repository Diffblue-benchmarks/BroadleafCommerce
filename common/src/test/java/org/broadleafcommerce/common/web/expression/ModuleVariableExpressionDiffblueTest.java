...
public class ModuleVariableExpressionDiffblueTest {
  @InjectMocks
  private ModuleVariableExpression moduleVariableExpression;
  ...
  public void testIsPresent_whenCommonTest_thenReturnTrue() {
    // Arrange, Act and Assert
    assertTrue(moduleVariableExpression.isPresent("CommonTest"));
  }
  ...
  public void testIsPresent_whenModuleInQuestion_thenReturnFalse() {
    // Arrange, Act and Assert
    assertFalse(moduleVariableExpression.isPresent("Module In Question"));
  }
}
