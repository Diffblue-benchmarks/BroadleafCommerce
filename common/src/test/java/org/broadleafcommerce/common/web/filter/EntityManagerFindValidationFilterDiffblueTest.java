...
public class EntityManagerFindValidationFilterDiffblueTest {
  /**
   * Test {@link EntityManagerFindValidationFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}.
   * <ul>
   *   <li>Then throw {@link ServletException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EntityManagerFindValidationFilter#doFilterInternal(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  @Test
