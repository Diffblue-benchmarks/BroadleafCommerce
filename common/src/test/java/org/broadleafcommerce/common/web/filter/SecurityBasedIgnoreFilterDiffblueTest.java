...
public class SecurityBasedIgnoreFilterDiffblueTest {
  ...
  public void testInitWithEvent() throws BeansException {
    ...
    when(source.getBean(Mockito.<String>any())).thenReturn(new FilterChainProxy());

    // Act
    securityBasedIgnoreFilter.init(new ContextRefreshedEvent(source));

    // Assert
    verify(source).getBean(eq("springSecurityFilterChain"));
    FilterChainProxy filterChainProxy = securityBasedIgnoreFilter.springSecurity;
    Environment environment = filterChainProxy.getEnvironment();
    ...
    assertTrue(collectResult.get(2) instanceof PropertiesPropertySource);
    ...
    assertTrue(collectResult.get(3) instanceof SystemEnvironmentPropertySource);
    assertTrue(environment instanceof StandardServletEnvironment);
    assertNull(filterChainProxy.getFilterConfig());
    ...
    String expectedString3 = System.getProperty("awt.toolkit");
    assertEquals(expectedString3, systemProperties.get("awt.toolkit"));
  ...
  public void testInitWithEvent2() {
    ...
    // Arrange
    SecurityBasedIgnoreFilter securityBasedIgnoreFilter2 = new SecurityBasedIgnoreFilter();

    // Act
    securityBasedIgnoreFilter2.init(new ContextRefreshedEvent(new AnnotationConfigReactiveWebApplicationContext()));
  }
  ...
  public void testDoFilter() throws IOException, ServletException {
    ...
    // Act
    securityBasedIgnoreFilter2.doFilter(request, new StatusExposingServletResponse(
