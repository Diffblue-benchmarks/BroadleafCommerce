...
public class TranslationFilterDiffblueTest {
  ...
  /**
   * Test
   * {@link TranslationFilter#doFilterUnlessIgnored(ServletRequest, ServletResponse, FilterChain)}.
   * <p>
   * Method under test:
   * {@link TranslationFilter#doFilterUnlessIgnored(ServletRequest, ServletResponse, FilterChain)}
   */
  ...
  public void testDoFilterUnlessIgnored() throws IOException, ServletException {
    ...
    // Arrange
    TranslationFilter translationFilter2 = new TranslationFilter();
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    MockHttpServletResponse response = new MockHttpServletResponse();

    // Act
    translationFilter2.doFilterUnlessIgnored(request, new StatusExposingServletResponse(
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testAreTranslationsEnabled() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Arrange and Act
    (new TranslationFilter()).areTranslationsEnabled();
  }
