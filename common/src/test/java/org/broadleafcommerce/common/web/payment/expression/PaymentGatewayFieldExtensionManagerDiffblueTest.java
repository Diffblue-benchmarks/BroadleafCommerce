...
public class PaymentGatewayFieldExtensionManagerDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link PaymentGatewayFieldExtensionManager#continueOnHandled()}
   */
  @Test
  public void testContinueOnHandled() {
    ...
    // Arrange
    PaymentGatewayFieldExtensionManager paymentGatewayFieldExtensionManager = new PaymentGatewayFieldExtensionManager();
    paymentGatewayFieldExtensionManager.registerHandler(mock(PaymentGatewayFieldExtensionHandler.class));
  ...
  public void testContinueOnHandled2() {
    ...
    // Arrange and Act
    (new PaymentGatewayFieldExtensionManager()).continueOnHandled();
  }

  /**
   * Test {@link PaymentGatewayFieldExtensionManager#continueOnHandled()}.
   * <ul>
   *   <li>Given {@link PaymentGatewayFieldExtensionManager} (default
   * constructor).</li>
   * </ul>
   * <p>
   * Method under test:
   ...
   */
  @Test
  public void testContinueOnHandled_givenPaymentGatewayFieldExtensionManager() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.

    // Arrange, Act and Assert
    assertTrue((new PaymentGatewayFieldExtensionManager()).continueOnHandled());
  }
}
