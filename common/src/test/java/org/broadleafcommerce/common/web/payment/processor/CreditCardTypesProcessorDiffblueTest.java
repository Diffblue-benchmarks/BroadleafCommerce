...
public class CreditCardTypesProcessorDiffblueTest {
  ...
  public void testGetPrecedence2() {
    ...
    // Arrange and Act
    (new CreditCardTypesProcessor()).getPrecedence();
  }
  ...
  public void testUseGlobalScope2() {
    ...
    // Arrange and Act
    (new CreditCardTypesProcessor()).useGlobalScope();
  }
  ...
  public void testPopulateModelVariables2() {
    ...
    // Arrange
    CreditCardTypesProcessor creditCardTypesProcessor2 = new CreditCardTypesProcessor();

    // Act
    creditCardTypesProcessor2.populateModelVariables("Tag Name", new HashMap<>(), mock(BroadleafTemplateContext.class));
  }
}
