...
public class TransparentRedirectCreditCardFormProcessorDiffblueTest {
  ...
  /**
   * Test
   * {@link TransparentRedirectCreditCardFormProcessor#getInjectedModelAndTagAttributes(String, Map, BroadleafTemplateContext)}.
   * <p>
   * Method under test:
   * {@link TransparentRedirectCreditCardFormProcessor#getInjectedModelAndTagAttributes(String, Map, BroadleafTemplateContext)}
   */
  ...
  public void testGetInjectedModelAndTagAttributes() {
    ...
    // Arrange
    TransparentRedirectCreditCardFormProcessor transparentRedirectCreditCardFormProcessor2 = new TransparentRedirectCreditCardFormProcessor();

    // Act
    transparentRedirectCreditCardFormProcessor2.getInjectedModelAndTagAttributes("Root Tag Name", new HashMap<>(),
  ...
  public void testReprocessModel2() {
    ...
    // Arrange and Act
    (new TransparentRedirectCreditCardFormProcessor()).reprocessModel();
  }
