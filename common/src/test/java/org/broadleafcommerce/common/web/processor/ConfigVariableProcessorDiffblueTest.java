...
public class ConfigVariableProcessorDiffblueTest {
  @Autowired
  private ConfigVariableProcessor configVariableProcessor;
  ...
  public void testGetPrecedence2() {
    ...
    // Arrange and Act
    (new ConfigVariableProcessor()).getPrecedence();
  }

  /**
   * Test
   * {@link ConfigVariableProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}.
   * <p>
   * Method under test:
   * {@link ConfigVariableProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}
   */
  ...
  public void testPopulateModelVariables() {
    ...
    // Arrange
    ConfigVariableProcessor configVariableProcessor2 = new ConfigVariableProcessor();

    // Act
    configVariableProcessor2.populateModelVariables("Tag Name", new HashMap<>(), mock(BroadleafTemplateContext.class));
  }
}
