...
public class DataDrivenEnumerationProcessorDiffblueTest {
  ...
  public void testGetPrecedence2() {
    ...
    // Arrange and Act
    (new DataDrivenEnumerationProcessor()).getPrecedence();
  }

  /**
   * Test
   * {@link DataDrivenEnumerationProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}.
   * <p>
   * Method under test:
   * {@link DataDrivenEnumerationProcessor#populateModelVariables(String, Map, BroadleafTemplateContext)}
   */
  ...
  public void testPopulateModelVariables() {
    ...
    // Arrange
    DataDrivenEnumerationProcessor dataDrivenEnumerationProcessor2 = new DataDrivenEnumerationProcessor();

    // Act
    dataDrivenEnumerationProcessor2.populateModelVariables("Tag Name", new HashMap<>(),
