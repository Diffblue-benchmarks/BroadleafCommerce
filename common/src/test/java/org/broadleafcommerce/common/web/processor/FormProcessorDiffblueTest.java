...
public class FormProcessorDiffblueTest {
  ...
  public void testGetPrecedence2() {
    ...
    // Arrange and Act
    (new FormProcessor()).getPrecedence();
  }
  ...
  public void testGetInjectedModelAndTagAttributes() {
    ...
    // Arrange
    FormProcessor formProcessor2 = new FormProcessor();

    // Act
    formProcessor2.getInjectedModelAndTagAttributes("Root Tag Name", new HashMap<>(),
  ...
  public void testReprocessModel2() {
    ...
    // Arrange and Act
    (new FormProcessor()).reprocessModel();
  }
}
