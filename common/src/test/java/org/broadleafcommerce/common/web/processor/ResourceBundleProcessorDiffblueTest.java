...
public class ResourceBundleProcessorDiffblueTest {
  ...
  public void testBuildModelUnbundled3() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
  ...
  public void testBuildModelUnbundled_givenResourceBundleProcessor() {
    // Arrange
  ...
  public void testBuildModelBundled9() {
    ...
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
    ResourcesRequestBundle resourcesRequestBundle =
        new ResourcesRequestBundle("/", "/", new ArrayList<>(), "/");
    when(resourcesRequest.getBundle(
            Mockito.<String>any(), Mockito.<String>any(), Mockito.<List<String>>any()))
        .thenReturn(resourcesRequestBundle);
    ArrayList<String> attributeFiles = new ArrayList<>();
  ...
  public void testBuildModelBundled_givenResourceBundleProcessor() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
    ArrayList<String> attributeFiles = new ArrayList<>();
    ResourceTagAttributes attributes = new ResourceTagAttributes();
   ...
   *
   * <ul>
   *   <li>Then calls {@link ResourcesRequest#saveBundle(String, String, List, String)}.
   * </ul>
   *
   * <p>Method under test: {@link ResourceBundleProcessor#buildModelBundled(List,
   * ResourceTagAttributes, BroadleafTemplateContext)}
  ...
  public void testBuildModelBundled_thenCallsSaveBundle() {
    // Arrange
    when(resourceBundlingService.resolveBundleResourceName(
            Mockito.<String>any(),
            Mockito.<String>any(),
   ...
   *
   * <ul>
   *   <li>When {@link ResourceTagAttributes} {@link ResourceTagAttributes#src(String)} throw {@link
   *       IllegalArgumentException#IllegalArgumentException()}.
   * </ul>
   *
   * <p>Method under test: {@link ResourceBundleProcessor#buildModelBundled(List,
  ...
  public void testBuildModelBundled_whenResourceTagAttributesSrcThrowIllegalArgumentException() {
    // Arrange
    ResourcesRequestBundle resourcesRequestBundle =
        new ResourcesRequestBundle("/", "/", new ArrayList<>(), "/");
    when(resourcesRequest.getBundle(
    ...
    ResourceTagAttributes attributes = mock(ResourceTagAttributes.class);
    when(attributes.src(Mockito.<String>any())).thenThrow(new IllegalArgumentException());
    when(attributes.mappingPrefix()).thenReturn("Mapping Prefix");
    when(attributes.name()).thenReturn("Name");
  ...
  public void testAddElementToModelWithSrcAsyncDeferContextModel5() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenThrow(new IllegalArgumentException());
  ...
  public void testAddElementToModelWithSrcAsyncDeferContextModel6() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
    ...
    assertThrows(
        ...
        () ->
            resourceBundleProcessor.addElementToModel(
                ".js", true, true, context, mock(BroadleafTemplateModel.class)));
    verify(context).createNonVoidElement(eq("script"), isA(Map.class), eq(true));
    verify(environment).getProperty("bundle.enabled");
  }
  ...
  public void testAddElementToModelWithSrcAsyncDeferContextModel7() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
  ...
  public void testAddElementToModelWithSrcAsyncDeferContextModel8() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
  ...
  public void testAddElementToModelWithSrcAsyncDeferContextModel_whenFalse2() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
  ...
  public void testAddElementToModelWithSrcAsyncDeferDependencyEventContextModel_whenFalse2() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
  ...
  public void testAddJavaScriptToModel5() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
   ...
   *
   * <ul>
   *   <li>When {@link BroadleafTemplateModel} {@link
   *       BroadleafTemplateModel#addElement(BroadleafTemplateElement)} does nothing.
   * </ul>
   *
   * <p>Method under test: {@link
   * ResourceBundleProcessor#addJavaScriptToModel(ResourceTagAttributes, BroadleafTemplateContext,
  ...
  public void testAddJavaScriptToModel_whenBroadleafTemplateModelAddElementDoesNothing() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
    ResourceTagAttributes attributes = new ResourceTagAttributes();
  ...
  public void testAddCssToModel5() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
    ...
    assertThrows(
        ...
        () ->
            resourceBundleProcessor.addDependencyRestrictionToModel(
                files, attributes, context, mock(BroadleafTemplateModel.class)));
    verify(attributes, atLeast(1)).async();
  ...
  public void testAddDependencyRestrictionToModel4() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
    ArrayList<String> files = new ArrayList<>();
  ...
  public void testAddDependencyRestrictionToModel_givenJs() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
    ArrayList<String> files = new ArrayList<>();
    ...
    verify(context)
        .createTextElement(
            "<script>function runOnReady(callback, event) {    var watchEvent = typeof(event) == 'undefined' ? 'DOMContentLoaded' : event;    if (document.readyState != 'loading' && !event) {        callback();    } else {        document.addEventListener(watchEvent, callback);    }}; if (typeof(Bundle Dependency EventEvent) !== 'undefined') {    runOnReady(handle_js);} else {    runOnReady(function() {            runOnReady(handle_js);        },        'Bundle Dependency Event');} function handle_js() {    var lastScript = null;    [].forEach(function (elem, idx, arr) {        var script = document.createElement('script');        script.type = 'text/javascript';        script.src = elem;        script.async = false;        document.body.appendChild(script);if (idx === arr.length - 1) {    script.addEventListener('load', function () {        var Bundle Completed EventEvent = new CustomEvent('Bundle Completed Event');document.dispatchEvent(Bundle Completed EventEvent);;    });}    });};</script>");
    verify(model).addElement(isA(BroadleafTemplateElement.class));
    verify(environment, atLeast(1)).getProperty("bundle.enabled");
  }
   ...
   *
   * <ul>
   *   <li>Given {@link ResourceBundleProcessor}.
   *   <li>When {@code 42.css}.
  ...
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42Css_thenReturn42Css() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42Js_thenReturn42Js() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn42() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn422() {
    // Arrange, Act and Assert
    assertEquals("_42", resourceBundleProcessor.cleanUpJavaScriptName(".42"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn423() {
    // Arrange, Act and Assert
    assertEquals("\\_42", resourceBundleProcessor.cleanUpJavaScriptName("\\.42"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn424() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn425() {
    // Arrange, Act and Assert
    assertEquals("42_", resourceBundleProcessor.cleanUpJavaScriptName("42."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_when42_thenReturn426() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync2() {
    // Arrange, Act and Assert
    assertEquals("_async", resourceBundleProcessor.cleanUpJavaScriptName(".async"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync3() {
    // Arrange, Act and Assert
    assertEquals("\\_async", resourceBundleProcessor.cleanUpJavaScriptName("\\.async"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync4() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync5() {
    // Arrange, Act and Assert
    assertEquals("async_", resourceBundleProcessor.cleanUpJavaScriptName("async."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenAsync_thenReturnAsync6() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss42_thenReturnCss42() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCssJs_thenReturnCssJs() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss() {
    // Arrange, Act and Assert
    assertEquals("_css", new ResourceBundleProcessor().cleanUpJavaScriptName(".css"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss2() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss3() {
    // Arrange, Act and Assert
    assertEquals("__css", resourceBundleProcessor.cleanUpJavaScriptName("..css"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss4() {
    // Arrange, Act and Assert
    assertEquals("\\__css", resourceBundleProcessor.cleanUpJavaScriptName("\\..css"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss5() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss6() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss7() {
    // Arrange, Act and Assert
    assertEquals("_css_", resourceBundleProcessor.cleanUpJavaScriptName(".css."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss8() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss9() {
    // Arrange, Act and Assert
    assertEquals("_css'", resourceBundleProcessor.cleanUpJavaScriptName(".css'"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss10() {
    // Arrange, Act and Assert
    assertEquals("_css;", resourceBundleProcessor.cleanUpJavaScriptName(".css;"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenCss_thenReturnCss11() {
    // Arrange, Act and Assert
    assertEquals(";_css", resourceBundleProcessor.cleanUpJavaScriptName(";.css"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs42_thenReturnJs42() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJsCss_thenReturnJsCss() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJsJs_thenReturnJsJs() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs() {
    // Arrange, Act and Assert
    assertEquals("_js", new ResourceBundleProcessor().cleanUpJavaScriptName(".js"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs2() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs3() {
    // Arrange, Act and Assert
    assertEquals("__js", resourceBundleProcessor.cleanUpJavaScriptName("..js"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs4() {
    // Arrange, Act and Assert
    assertEquals("\\__js", resourceBundleProcessor.cleanUpJavaScriptName("\\..js"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs5() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs6() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs7() {
    // Arrange, Act and Assert
    assertEquals("_js_", resourceBundleProcessor.cleanUpJavaScriptName(".js."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs8() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs9() {
    // Arrange, Act and Assert
    assertEquals("_js'", resourceBundleProcessor.cleanUpJavaScriptName(".js'"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs10() {
    // Arrange, Act and Assert
    assertEquals("_js;", resourceBundleProcessor.cleanUpJavaScriptName(".js;"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJs_thenReturnJs11() {
    // Arrange, Act and Assert
    assertEquals(";_js", resourceBundleProcessor.cleanUpJavaScriptName(";.js"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJsrel_thenReturnJsrel() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenJssrc_thenReturnJssrc() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink2() {
    // Arrange, Act and Assert
    assertEquals("_link", resourceBundleProcessor.cleanUpJavaScriptName(".link"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink3() {
    // Arrange, Act and Assert
    assertEquals("\\_link", resourceBundleProcessor.cleanUpJavaScriptName("\\.link"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink4() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink5() {
    // Arrange, Act and Assert
    assertEquals("link_", resourceBundleProcessor.cleanUpJavaScriptName("link."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenLink_thenReturnLink6() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRelJs_thenReturnRelJs() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel2() {
    // Arrange, Act and Assert
    assertEquals("_rel", resourceBundleProcessor.cleanUpJavaScriptName(".rel"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel3() {
    // Arrange, Act and Assert
    assertEquals("\\_rel", resourceBundleProcessor.cleanUpJavaScriptName("\\.rel"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel4() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel5() {
    // Arrange, Act and Assert
    assertEquals("rel_", resourceBundleProcessor.cleanUpJavaScriptName("rel."));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenRel_thenReturnRel6() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenSrc_thenReturnSrc() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenSrc_thenReturnSrc2() {
    // Arrange, Act and Assert
    assertEquals("_src", resourceBundleProcessor.cleanUpJavaScriptName(".src"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourceBundleProcessor.cleanUpJavaScriptName(String)"})
  public void testCleanUpJavaScriptName_givenResourceBundleProcessor_whenSrc_thenReturnSrc3() {
    // Arrange, Act and Assert
    assertEquals("\\_src", resourceBundleProcessor.cleanUpJavaScriptName("\\.src"));
  }
  ...
  public void testCleanUpJavaScriptName_whenBackslashDot_thenReturnBackslashUnderscore() {
    // Arrange, Act and Assert
    assertEquals("\\_", new ResourceBundleProcessor().cleanUpJavaScriptName("\\."));
  }
  ...
  public void testCleanUpJavaScriptName_whenJavaLangString_thenReturnJavaLangString() {
    ...
    assertEquals(
        "java_lang_String",
        new ResourceBundleProcessor().cleanUpJavaScriptName("java.lang.String"));
  }
  ...
  public void testGetLinkAttributes() {
    // Arrange and Act
    Map<String, String> actualLinkAttributes =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ResourceBundleProcessor.useAsyncJavaScript(ResourceTagAttributes)"})
  public void testUseAsyncJavaScript_givenResourceBundleProcessor_whenResourceTagAttributes() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ResourceBundleProcessor.useAsyncJavaScript(ResourceTagAttributes)"})
  public void testUseAsyncJavaScript_whenResourceTagAttributesAsyncReturnFalse() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
  ...
  public void testValidateTagAttributes() {
    ...
    ResourceTagAttributes attributes = new ResourceTagAttributes(new ResourceTagAttributes());
    attributes.name("");
    attributes.bundleDependencyEvent("Attributes");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceBundleProcessor.validateTagAttributes(ResourceTagAttributes)"})
  public void testValidateTagAttributes9() {
    // Arrange
    when(resourceBundlingService.getAdditionalBundleFiles(Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceBundleProcessor.validateTagAttributes(ResourceTagAttributes)"})
  public void testValidateTagAttributes10() {
    // Arrange
    when(resourceBundlingService.getAdditionalBundleFiles(Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
    when(resourcesRequest.getBundle(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceBundleProcessor.validateTagAttributes(ResourceTagAttributes)"})
  public void testValidateTagAttributes11() {
    // Arrange
    when(resourcesRequest.getBundle(
            Mockito.<String>any(), Mockito.<String>any(), Mockito.<List<String>>any()))
        .thenReturn(null);
  ...
  public void testValidateTagAttributes_givenBundleEnabled() {
    ...
    assertThrows(
        InvalidParameterException.class,
        () -> resourceBundleProcessor.validateTagAttributes(attributes));
    verify(resourcesRequest).getBundle(eq("bundle.enabled"), eq("Attributes"), isA(List.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourceBundleProcessor.validateTagAttributes(ResourceTagAttributes)"})
  public void testValidateTagAttributes_givenResourceBundleProcessor_whenResourceTagAttributes() {
    // Arrange
    ResourceBundleProcessor resourceBundleProcessor = new ResourceBundleProcessor();
    ...
    assertThrows(
        ...
        () ->
            resourceBundleProcessor.buildUnbundledSyncCompletedEventElement(
                new ResourceTagAttributes(), mock(BroadleafTemplateContext.class)));
    verify(environment).getProperty("bundle.enabled");
  }
  ...
  public void testBuildUnbundledSyncCompletedEventElement2() {
    ...
    ResourceTagAttributes attributes = new ResourceTagAttributes(new ResourceTagAttributes());
    attributes.bundleCompletedEvent("bundle.enabled");
    attributes.async(false);
    attributes.includeAsyncDeferUnbundled(false);
  ...
  public void testBuildUnbundledSyncCompletedEventElement3() {
    ...
    verify(context)
        .createTextElement(
            "var bundle.enabledEvent = new CustomEvent('bundle.enabled');document.dispatchEvent(bundle.enabledEvent);");
    verify(broadleafTemplateNonVoidElement).addChild(isA(BroadleafTemplateElement.class));
    verify(environment).getProperty("bundle.enabled");
  }
  ...
  public void testBuildUnbundledSyncCompletedEventElement6() {
    ...
    when(attributes.async()).thenReturn(false);
    when(attributes.bundleCompletedEvent()).thenReturn("Bundle Completed Event");
    when(attributes.async(anyBoolean())).thenReturn(new ResourceTagAttributes());
    when(attributes.bundleCompletedEvent(Mockito.<String>any()))
        .thenReturn(new ResourceTagAttributes());
    when(attributes.includeAsyncDeferUnbundled(anyBoolean()))
        .thenReturn(new ResourceTagAttributes());
    attributes.bundleCompletedEvent("bundle.enabled");
    attributes.async(false);
    attributes.includeAsyncDeferUnbundled(false);
    ...
    assertThrows(
        ...
        () -> resourceBundleProcessor.buildUnbundledSyncCompletedEventElement(attributes, context));
    verify(attributes).async();
    verify(attributes).async(false);
    verify(attributes, atLeast(1)).bundleCompletedEvent();
    verify(attributes).bundleCompletedEvent("bundle.enabled");
    verify(attributes).includeAsyncDeferUnbundled(false);
    verify(context).createNonVoidElement("script");
    verify(context)
        .createTextElement(
  ...
  public void testBuildUnbundledSyncCompletedEventElement_thenReturnNull() {
    // Arrange
    when(environment.getProperty(Mockito.<String>any())).thenReturn("Property");
