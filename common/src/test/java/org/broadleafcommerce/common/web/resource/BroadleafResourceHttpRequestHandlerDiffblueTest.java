...
@ContextConfiguration(locations = {"/blc-config/site/framework/bl-common-applicationContext.xml",
    "/bl-common-applicationContext-entity.xml", "/bl-common-applicationContext-mbeans.xml",
    "/bl-common-applicationContext-persistence.xml", "/bl-common-applicationContext-servlet.xml",
    "/bl-common-applicationContext-wrapper.xml", "/bl-common-applicationContext.xml",
    ...
    "/context/reader/merge/testbeans2.xml",
    "/context/reader/merge/testbeans3.xml"}, classes = {BroadleafResourceHttpRequestHandler.OrderedComparator.class})
@WebAppConfiguration
...
public class BroadleafResourceHttpRequestHandlerDiffblueTest {
  ...
  /**
   * Test OrderedComparator
   * {@link OrderedComparator#OrderedComparator(BroadleafResourceHttpRequestHandler)}.
   * <p>
   * Method under test:
   * {@link BroadleafResourceHttpRequestHandler.OrderedComparator#OrderedComparator(BroadleafResourceHttpRequestHandler)}
   */
  @Test
  public void testOrderedComparatorNewOrderedComparator() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Missing observers.
    //   Diffblue Cover was unable to create an assertion.
    //   Add getters for the following fields or make them package-private:
    //     OrderedComparator.this$0
  ...
  /**
   * Test {@link BroadleafResourceHttpRequestHandler#sortCollections()}.
   * <p>
   * Method under test:
   * {@link BroadleafResourceHttpRequestHandler#sortCollections()}
   */
  @Test
  ...
  public void testSortCollections() {
    ...
    // Arrange and Act
    broadleafResourceHttpRequestHandler.sortCollections();
  }

  /**
   * Test
   * {@link BroadleafResourceHttpRequestHandler#handleRequest(HttpServletRequest, HttpServletResponse)}.
   * <p>
   * Method under test:
   * {@link BroadleafResourceHttpRequestHandler#handleRequest(HttpServletRequest, HttpServletResponse)}
   */
  ...
  public void testHandleRequest() throws IOException, ServletException {
    ...
    // Act
    broadleafResourceHttpRequestHandler.handleRequest(request, new StatusExposingServletResponse(
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testSetHeaders3() throws IOException {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    broadleafResourceHttpRequestHandler.setHeaders(response2, resource,
        MediaType.parseMediaType("https://example.org/example"));
  }
  ...
  @Test
  @Ignore("TODO: Complete this test")
  public void testNewBroadleafResourceHttpRequestHandler2() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
