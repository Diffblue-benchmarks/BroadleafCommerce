...
public class BLCJSResourceResolverDiffblueTest {
  ...
  public void testResolveUrlPathInternal() {
    ...
    // Act
    blcjsResourceResolver.resolveUrlPathInternal("https://example.org/example", locations,
  ...
  public void testResolveResourceInternal2() {
    ...
    // Act
    blcjsResourceResolver.resolveResourceInternal(request, "Request Path", locations,
        new BroadleafDefaultResourceResolverChain(new ArrayList<>()));
  }
  ...
  public void testConvertResource() throws IOException {
    ...
    // Act
    blcjsResourceResolver.convertResource(new GeneratedResource(), "foo.txt");
  }
  ...
  public void testAddVersion() {
    ...
    // Arrange and Act
    (new BLCJSResourceResolver()).addVersion("Request Path", "1.0.2");
  }
