...
public class BroadleafCachingResourceResolverDiffblueTest {
  ...
  @MethodsUnderTest({"Cache BroadleafCachingResourceResolver.getCache()",
      "int BroadleafCachingResourceResolver.getOrder()", "void BroadleafCachingResourceResolver.setOrder(int)"})
   ...
   * <p>
   * Method under test: {@link BroadleafCachingResourceResolver#computeKey(HttpServletRequest, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String BroadleafCachingResourceResolver.computeKey(HttpServletRequest, String)"})
  ...
  /**
   * Test {@link BroadleafCachingResourceResolver#resolveUrlPathInternal(String, List, ResourceResolverChain)}.
   * <ul>
   *   <li>Given {@link ConcurrentMapCache#ConcurrentMapCache(String)} with {@code Name}.</li>
   *   <li>Then return {@code null}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BroadleafCachingResourceResolver#resolveUrlPathInternal(String, List, ResourceResolverChain)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
