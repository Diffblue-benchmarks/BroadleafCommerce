...
public class BroadleafCachingResourceResolverDiffblueTest {
  @Autowired
  private BroadleafCachingResourceResolver broadleafCachingResourceResolver;
  ...
  /**
   * Test
   * {@link BroadleafCachingResourceResolver#resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)}.
   * <p>
   * Method under test:
   * {@link BroadleafCachingResourceResolver#resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)}
   */
  ...
  public void testResolveResourceInternal() {
    ...
    // Arrange
    BroadleafCachingResourceResolver broadleafCachingResourceResolver2 = new BroadleafCachingResourceResolver(
    ...
    // Act
    broadleafCachingResourceResolver2.resolveResourceInternal(request, "Request Path", locations,
  ...
  public void testComputeKey3() {
    ...
    // Act
    broadleafCachingResourceResolver2.computeKey(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest()),
        "Request Path");
  }
  ...
  public void testResolveUrlPathInternal2() {
    ...
    // Act
    broadleafCachingResourceResolver2.resolveUrlPathInternal("https://example.org/example", locations,
        new BroadleafDefaultResourceResolverChain(new ArrayList<>()));
  }
