...
public class BroadleafVersionResourceResolverDiffblueTest {
  ...
  public void testResolveResourceInternal2() {
    ...
    // Arrange
    BroadleafVersionResourceResolver broadleafVersionResourceResolver2 = new BroadleafVersionResourceResolver();
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    ArrayList<Resource> locations = new ArrayList<>();

    // Act
    broadleafVersionResourceResolver2.resolveResourceInternal(request, "Request Path", locations,
        new BroadleafDefaultResourceResolverChain(new ArrayList<>()));
  }
  ...
  public void testResolveUrlPathInternal() {
    ...
    // Act
    broadleafVersionResourceResolver2.resolveUrlPathInternal("https://example.org/example", locations,
        new BroadleafDefaultResourceResolverChain(new ArrayList<>()));
  }
  ...
  public void testInitIt() throws Exception {
    ...
    // Arrange and Act
    (new BroadleafVersionResourceResolver()).initIt();
  }
}
