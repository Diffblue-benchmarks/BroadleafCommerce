...
public class BundleResourceResolverDiffblueTest {
  @InjectMocks
  private BundleResourceResolver bundleResourceResolver;

  @Mock
  private ResourceBundlingService resourceBundlingService;

  /**
   * Test {@link BundleResourceResolver#resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)}.
   * <p>
   * Method under test: {@link BundleResourceResolver#resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)}
   */
  @Test
  ...
  public void testResolveResourceInternal() {
    ...
    when(resourceBundlingService.resolveBundleResource(Mockito.<String>any())).thenReturn(generatedResource);
    when(resourceBundlingService.checkForRegisteredBundleFile(Mockito.<String>any())).thenReturn(true);
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    ArrayList<Resource> locations = new ArrayList<>();

    // Act
    Resource actualResolveResourceInternalResult = bundleResourceResolver.resolveResourceInternal(request,
        "Request Path", locations, new BroadleafDefaultResourceResolverChain(new ArrayList<>()));

    // Assert
    verify(resourceBundlingService).checkForRegisteredBundleFile(eq("Request Path"));
    verify(resourceBundlingService).resolveBundleResource(eq("Request Path"));
  ...
  public void testResolveResourceInternal3() {
    ...
    // Assert
    verify(resourceBundlingService).checkForRegisteredBundleFile(eq("Request Path"));
    verify(resourceBundlingService).rebuildBundledResource(eq("Request Path"));
    verify(resourceBundlingService).resolveBundleResource(eq("Request Path"));
    assertNull(actualResolveResourceInternalResult);
  }
  ...
  public void testResolveResourceInternal4() {
    // Arrange
    when(resourceBundlingService.checkForRegisteredBundleFile(Mockito.<String>any())).thenReturn(false);
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    ArrayList<Resource> locations = new ArrayList<>();
  ...
  public void testResolveResourceInternal_givenGeneratedResource() {
    // Arrange
    GeneratedResource generatedResource = new GeneratedResource();
    when(resourceBundlingService.rebuildBundledResource(Mockito.<String>any())).thenReturn(generatedResource);
    when(resourceBundlingService.resolveBundleResource(Mockito.<String>any()))
        .thenReturn(new ClassPathResource("Path"));
    when(resourceBundlingService.checkForRegisteredBundleFile(Mockito.<String>any())).thenReturn(true);
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
   ...
   * Test {@link BundleResourceResolver#resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)}.
   * <ul>
   *   <li>Given {@link ResourceBundlingService}.</li>
  ...
  @MethodsUnderTest({
      "Resource BundleResourceResolver.resolveResourceInternal(HttpServletRequest, String, List, ResourceResolverChain)"})
  public void testResolveResourceInternal_givenResourceBundlingService_whenNull_thenReturnNull() {
    // Arrange
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    ArrayList<Resource> locations = new ArrayList<>();
  ...
  /**
   * Test {@link BundleResourceResolver#resolveUrlPathInternal(String, List, ResourceResolverChain)}.
   * <ul>
   *   <li>Given {@link GeneratedResource#GeneratedResource()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BundleResourceResolver#resolveUrlPathInternal(String, List, ResourceResolverChain)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String BundleResourceResolver.resolveUrlPathInternal(String, List, ResourceResolverChain)"})
  public void testResolveUrlPathInternal_givenGeneratedResource() {
    ...
    // Act
    String actualResolveUrlPathInternalResult = bundleResourceResolver.resolveUrlPathInternal(
        "https://example.org/example", locations, new BroadleafDefaultResourceResolverChain(new ArrayList<>()));

    // Assert
    verify(resourceBundlingService).checkForRegisteredBundleFile(eq("https://example.org/example"));
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String BundleResourceResolver.resolveUrlPathInternal(String, List, ResourceResolverChain)"})
  public void testResolveUrlPathInternal_givenResourceBundlingService_whenNull_thenReturnNull() {
    // Arrange
    ArrayList<Resource> locations = new ArrayList<>();
   ...
   * </ul>
   * <p>
   * Method under test: {@link BundleResourceResolver#isBundleFile(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"int BundleResourceResolver.getOrder()", "void BundleResourceResolver.setOrder(int)"})
