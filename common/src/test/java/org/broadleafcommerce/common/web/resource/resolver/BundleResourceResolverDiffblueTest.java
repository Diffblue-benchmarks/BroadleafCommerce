...
public class BundleResourceResolverDiffblueTest {
  ...
  public void testResolveResourceInternal() {
    ...
    // Arrange
    BundleResourceResolver bundleResourceResolver2 = new BundleResourceResolver();
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    ArrayList<Resource> locations = new ArrayList<>();

    // Act
    bundleResourceResolver2.resolveResourceInternal(request, "Request Path", locations,
  ...
  /**
   * Test {@link BundleResourceResolver#logTraceInformation(Resource)}.
   * <p>
   * Method under test:
   * {@link BundleResourceResolver#logTraceInformation(Resource)}
   */
  @Test
  @Ignore("TODO: Complete this test")
  public void testLogTraceInformation() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Reason: Failed to create Spring context.
    //   Attempt to initialize test context failed with
    //   com.diffblue.fuzztest.shared.proxy.BeanInstantiationException: Could not instantiate bean: messageSource defined in bl-common-applicationContext.xml
    ...
    // Act
    bundleResourceResolver2.logTraceInformation(new GeneratedResource());
  }
  ...
  public void testResolveUrlPathInternal() {
    ...
    // Act
    bundleResourceResolver2.resolveUrlPathInternal("https://example.org/example", locations,
        new BroadleafDefaultResourceResolverChain(new ArrayList<>()));
  }
  ...
  public void testIsBundleFile() {
    ...
    // Arrange and Act
    (new BundleResourceResolver()).isBundleFile("Request Path");
  }
