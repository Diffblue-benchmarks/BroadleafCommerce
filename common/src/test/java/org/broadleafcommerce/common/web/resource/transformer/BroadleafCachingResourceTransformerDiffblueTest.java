...
public class BroadleafCachingResourceTransformerDiffblueTest {
  @Autowired
  private BroadleafCachingResourceTransformer broadleafCachingResourceTransformer;
  ...
  public void testTransform() throws IOException {
    ...
    // Arrange
    BroadleafCachingResourceTransformer broadleafCachingResourceTransformer2 = new BroadleafCachingResourceTransformer(
        new ConcurrentMapCache("Name"));
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());

    // Act
    broadleafCachingResourceTransformer2.transform(request, new GeneratedResource(),
        mock(ResourceTransformerChain.class));
  }
