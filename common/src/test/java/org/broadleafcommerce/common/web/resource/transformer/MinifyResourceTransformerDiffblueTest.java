...
public class MinifyResourceTransformerDiffblueTest {
  ...
  public void testTransform() throws IOException {
    ...
    // Arrange
    MinifyResourceTransformer minifyResourceTransformer2 = new MinifyResourceTransformer();
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());

    // Act
    minifyResourceTransformer2.transform(request, new GeneratedResource(), mock(ResourceTransformerChain.class));
  }
