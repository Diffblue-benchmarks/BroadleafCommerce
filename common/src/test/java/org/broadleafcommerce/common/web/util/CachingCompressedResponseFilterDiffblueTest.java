...
public class CachingCompressedResponseFilterDiffblueTest {
  @Mock
  private CacheAwareResponseHandler cacheAwareResponseHandler;

  @InjectMocks
  private CachingCompressedResponseFilter cachingCompressedResponseFilter;
  ...
  public void testBroadleafSpringResourceConfigBlCacheAwareReponseHandler() {
    // Arrange and Act
    CacheAwareResponseHandler actualBlCacheAwareReponseHandlerResult = (new BroadleafSpringResourceConfig())
  ...
  @MethodsUnderTest({
      "void CachingCompressedResponseFilter.doFilterInternalUnlessIgnored(HttpServletRequest, HttpServletResponse, FilterChain)"})
  public void testDoFilterInternalUnlessIgnored_givenFalseToString() throws IOException, ServletException {
    // Arrange
   ...
   * Test {@link CachingCompressedResponseFilter#doFilterInternalUnlessIgnored(HttpServletRequest, HttpServletResponse, FilterChain)}.
   * <ul>
   *   <li>Then calls {@link HttpServletRequestWrapper#getHeaders(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CachingCompressedResponseFilter#doFilterInternalUnlessIgnored(HttpServletRequest, HttpServletResponse, FilterChain)}
   */
  ...
  @MethodsUnderTest({
      "void CachingCompressedResponseFilter.doFilterInternalUnlessIgnored(HttpServletRequest, HttpServletResponse, FilterChain)"})
  public void testDoFilterInternalUnlessIgnored_thenCallsGetHeaders() throws IOException, ServletException {
    // Arrange
    ...
    SessionlessHttpServletRequestWrapper request2 = new SessionlessHttpServletRequestWrapper(
   ...
   * <ul>
   *   <li>Given {@link CacheAwareResponseHandler}.</li>
  ...
  public void testProcessStatic_givenCacheAwareResponseHandler_thenReturnFalse() throws IOException, ServletException {
    // Arrange
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new MockHttpServletRequest());
    MockHttpServletResponse response = new MockHttpServletResponse();
   ...
   * Test {@link CachingCompressedResponseFilter#processStatic(HttpServletRequest, HttpServletResponse, FilterChain, String)}.
   * <ul>
   *   <li>Given {@link CachingCompressedResponseFilter} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link CachingCompressedResponseFilter#processStatic(HttpServletRequest, HttpServletResponse, FilterChain, String)}
   */
  ...
  @MethodsUnderTest({
      "boolean CachingCompressedResponseFilter.processStatic(HttpServletRequest, HttpServletResponse, FilterChain, String)"})
  public void testProcessStatic_givenCachingCompressedResponseFilter() throws IOException, ServletException {
    // Arrange
    CachingCompressedResponseFilter cachingCompressedResponseFilter = new CachingCompressedResponseFilter();
    SessionlessHttpServletRequestWrapper request = new SessionlessHttpServletRequestWrapper(
        new HttpServletRequestWrapper(new SessionlessHttpServletRequestWrapper(new MockHttpServletRequest())));
