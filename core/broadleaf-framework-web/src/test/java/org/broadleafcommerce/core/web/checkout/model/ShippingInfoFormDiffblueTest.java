...
public class ShippingInfoFormDiffblueTest {
  /**
  ...
  public void testNewShippingInfoForm() {
    // Arrange and Act
  ...
  public void testShouldUseBillingAddress_givenShippingInfoForm_thenReturnFalse() {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ShippingInfoForm.shouldUseBillingAddress()"})
  public void testShouldUseBillingAddress_thenReturnTrue() {
    // Arrange
    ShippingInfoForm shippingInfoForm = new ShippingInfoForm();
    shippingInfoForm.setUseBillingAddress(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ShippingInfoForm.hasValidAddress()"})
  public void testHasValidAddress_givenShippingInfoFormAddressIsNull_thenReturnFalse() {
    // Arrange
    ShippingInfoForm shippingInfoForm = new ShippingInfoForm();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean ShippingInfoForm.hasValidAddress()"})
  public void testHasValidAddress_givenShippingInfoForm_thenReturnFalse() {
    // Arrange, Act and Assert
