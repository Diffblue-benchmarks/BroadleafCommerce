...
@ContextConfiguration(classes = {BroadleafSocialRegisterController.class})
...
class BroadleafSocialRegisterControllerDiffblueTest {
  ...
  /**
   * Test
   * {@link BroadleafSocialRegisterController#register(RegisterCustomerForm, HttpServletRequest, HttpServletResponse, Model)}.
   * <p>
   * Method under test:
   * {@link BroadleafSocialRegisterController#register(RegisterCustomerForm, HttpServletRequest, HttpServletResponse, Model)}
   */
  ...
  void testRegister() {
    ...
    //   when running class:
    //   package org.broadleafcommerce.core.web.controller.account;
    //   @org.springframework.test.context.ContextConfiguration(classes = {org.broadleafcommerce.core.web.controller.account.BroadleafSocialRegisterController.class})
    //   @org.junit.runner.RunWith(value = org.springframework.test.context.junit4.SpringRunner.class) // if JUnit 4
    //   @org.junit.jupiter.api.extension.ExtendWith(value = org.springframework.test.context.junit.jupiter.SpringExtension.class) // if JUnit 5
    //   public class DiffblueFakeClass7 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.core.web.controller.account.BroadleafSocialRegisterController broadleafSocialRegisterController;
    ...
    //     @org.springframework.boot.test.mock.mockito.MockBean org.springframework.social.connect.web.ProviderSignInUtils providerSignInUtils;
  ...
  /**
   * Test
   * {@link BroadleafSocialRegisterController#processRegister(RegisterCustomerForm, BindingResult, HttpServletRequest, HttpServletResponse, Model)}.
   * <p>
   * Method under test:
   * {@link BroadleafSocialRegisterController#processRegister(RegisterCustomerForm, BindingResult, HttpServletRequest, HttpServletResponse, Model)}
   */
  ...
  void testProcessRegister() throws ServiceException, PricingException {
    ...
    // Act
    broadleafSocialRegisterController.processRegister(registerCustomerForm, errors, request, response,
        new ConcurrentModel());
  }
