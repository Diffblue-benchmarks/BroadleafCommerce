...
public class BroadleafPaymentInfoControllerDiffblueTest {
  ...
  public void testSavePaymentInfo() throws ServiceException, PricingException {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerPaymentImpl} (default constructor) AdditionalFields is {@link
   *       HashMap#HashMap()}.
   * </ul>
   *
   * <p>Method under test: {@link BroadleafPaymentInfoController#savePaymentInfo(HttpServletRequest,
  ...
  public void testSavePaymentInfo_givenCustomerPaymentImplAdditionalFieldsIsHashMap()
   ...
   * <ul>
   *   <li>Given {@code false}.
   *   <li>Then calls {@link PaymentInfoForm#getShouldSaveNewPayment()}.
   * </ul>
   *
   * <p>Method under test: {@link BroadleafPaymentInfoController#savePaymentInfo(HttpServletRequest,
   * HttpServletResponse, Model, PaymentInfoForm, BindingResult)}
  ...
  public void testSavePaymentInfo_givenFalse_thenCallsGetShouldSaveNewPayment()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    doNothing()
  ...
  public void testSavePaymentInfo_thenCallsGetCustomerPaymentId()
      throws ServiceException, PricingException {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testSavePaymentInfo_thenCallsUpdateSavedPayment()
      throws ServiceException, PricingException {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then not {@link PaymentInfoForm} (default constructor) ShouldUseCustomerPayment.
   * </ul>
   *
   * <p>Method under test: {@link BroadleafPaymentInfoController#savePaymentInfo(HttpServletRequest,
   * HttpServletResponse, Model, PaymentInfoForm, BindingResult)}
  ...
  public void testSavePaymentInfo_thenNotPaymentInfoFormShouldUseCustomerPayment()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    doNothing()
  ...
  public void testSavePaymentInfo_thenPaymentInfoFormAddressIsAddressImpl()
      throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(addressImpl);
   ...
   *
   * <ul>
   *   <li>Then {@link PaymentInfoForm} (default constructor) CustomerPaymentId longValue is one.
   * </ul>
   *
   * <p>Method under test: {@link BroadleafPaymentInfoController#savePaymentInfo(HttpServletRequest,
   * HttpServletResponse, Model, PaymentInfoForm, BindingResult)}
  ...
  public void testSavePaymentInfo_thenPaymentInfoFormCustomerPaymentIdLongValueIsOne()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    when(cartStateService.cartHasCreditCardPaymentWithSameToken(Mockito.<String>any()))
  ...
  public void testSavePaymentInfo_thenPaymentInfoFormCustomerPaymentIdLongValueIsOne2()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    when(cartStateService.cartHasCreditCardPaymentWithSameToken(Mockito.<String>any()))
  ...
  public void testSavePaymentInfo_whenPaymentInfoFormShouldUseCustomerPaymentIsTrue()
      throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(addressImpl);
  ...
  public void testSaveBillingAddress() throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
  ...
  public void testSaveBillingAddress_givenCustomerPaymentImplBillingAddressIsAddressImpl()
      throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    addressImpl.setPrimaryPhone("");
  ...
  public void testSaveBillingAddress_thenPaymentInfoFormAddressAddressImpl()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    when(fulfillmentGroupService.getFirstShippableFulfillmentGroup(Mockito.<Order>any()))
  ...
  public void testSaveBillingAddress_thenPaymentInfoFormAddressIsAddressImpl()
      throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    addressImpl.setPrimaryPhone("");
  ...
  public void testSaveBillingAddress_thenReturnRedirectCheckout()
      throws ServiceException, PricingException {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    addressImpl.setPrimaryPhone("");
  ...
  public void testSaveBillingAddress_whenPaymentInfoForm_thenPaymentInfoFormAddressAddressImpl()
      throws ServiceException, PricingException {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    doNothing()
  ...
  public void testPreProcessBillingAddress() {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    when(customerPaymentService.readCustomerPaymentById(Mockito.<Long>any())).thenReturn(null);
  ...
  public void testPreProcessBillingAddress2() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testPreProcessBillingAddress3() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testPreProcessBillingAddress_givenFalse() {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    when(customerPaymentService.readCustomerPaymentById(Mockito.<Long>any()))
        .thenReturn(new CustomerPaymentImpl());
  ...
  public void testPreProcessBillingAddress_givenFulfillmentGroupImplAddressIsAddressImpl() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testPreProcessBillingAddress_givenNull() {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testPreProcessBillingAddress_thenCallsSetAddress() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
  ...
  public void testPreProcessBillingAddress_whenPaymentInfoForm() {
    // Arrange
    doNothing().when(addressService).populateAddressISOCountrySub(Mockito.<Address>any());
    PaymentInfoForm paymentForm = new PaymentInfoForm();
  ...
  public void testCopyShippingAddressToBillingAddress() {
    // Arrange
    when(fulfillmentGroupService.getFirstShippableFulfillmentGroup(Mockito.<Order>any()))
        .thenReturn(new FulfillmentGroupImpl());
  ...
  public void testCopyShippingAddressToBillingAddress2() {
    // Arrange
    when(fulfillmentGroupService.getFirstShippableFulfillmentGroup(Mockito.<Order>any()))
        .thenReturn(null);
    NullOrderImpl order = new NullOrderImpl();
  ...
  public void testCopyShippingAddressToBillingAddress_thenCallsGetAddress() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
  ...
  public void testCopyCustomerPaymentAddressToBillingAddress() {
    // Arrange
    when(customerPaymentService.readCustomerPaymentById(Mockito.<Long>any()))
        .thenReturn(new CustomerPaymentImpl());
    PaymentInfoForm paymentForm = new PaymentInfoForm();
  ...
  public void testCopyCustomerPaymentAddressToBillingAddress2() {
    // Arrange
    when(customerPaymentService.readCustomerPaymentById(Mockito.<Long>any())).thenReturn(null);
    PaymentInfoForm paymentForm = new PaymentInfoForm();
  ...
  public void testCopyCustomerPaymentAddressToBillingAddress3() {
    // Arrange
    AddressImpl addressImpl = new AddressImpl();
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(addressImpl);
  ...
  public void testAddTemporaryOrderPayment_thenOrderImplPaymentsIsArrayList() {
    // Arrange
  ...
  public void testNewBroadleafPaymentInfoController() {
    // Arrange and Act
