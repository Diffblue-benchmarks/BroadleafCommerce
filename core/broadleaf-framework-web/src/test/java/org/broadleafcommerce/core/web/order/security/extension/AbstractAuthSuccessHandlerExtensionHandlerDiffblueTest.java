...
class AbstractAuthSuccessHandlerExtensionHandlerDiffblueTest {
  /**
   * Test {@link AbstractAuthSuccessHandlerExtensionHandler#preMergeCartExecution(HttpServletRequest, HttpServletResponse, Authentication)}.
   * <p>
   * Method under test: {@link AbstractAuthSuccessHandlerExtensionHandler#preMergeCartExecution(HttpServletRequest, HttpServletResponse, Authentication)}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AbstractAuthSuccessHandlerExtensionHandler}
   */
  @Test
