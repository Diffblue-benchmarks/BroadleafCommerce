...
public class GoogleUniversalAnalyticsProcessorDiffblueTest {
  /**
  ...
  public void testShouldShowMasterTracker() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean GoogleUniversalAnalyticsProcessor.shouldShowMasterTracker()"})
  public void testShouldShowMasterTracker2() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
   ...
   *
   * <ul>
   *   <li>Given {@link GoogleUniversalAnalyticsProcessor} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link GoogleUniversalAnalyticsProcessor#shouldShowMasterTracker()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean GoogleUniversalAnalyticsProcessor.shouldShowMasterTracker()"})
  public void testShouldShowMasterTracker_givenGoogleUniversalAnalyticsProcessor() {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean GoogleUniversalAnalyticsProcessor.shouldShowMasterTracker()"})
  public void testShouldShowMasterTracker_thenReturnTrue() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
  ...
  public void testGetLinkAttributionJs() {
    // Arrange, Act and Assert
    assertEquals(
  ...
  public void testGetDisplayAdvertisingJs() {
    // Arrange, Act and Assert
    assertEquals(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GoogleUniversalAnalyticsProcessor.getItemJs(Order, String)"})
  public void testGetItemJs_givenGoogleUniversalAnalyticsProcessor_thenReturnEmptyString() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GoogleUniversalAnalyticsProcessor.getItemJs(Order, String)"})
  public void testGetItemJs_givenGoogleUniversalAnalyticsProcessor_thenReturnEmptyString2() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
  ...
  public void testGetVariation_givenCategoryImpl() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String GoogleUniversalAnalyticsProcessor.getVariation(OrderItem)"})
  public void testGetVariation_givenCategoryImplGetNameReturnName_thenReturnName() {
    // Arrange
    GoogleUniversalAnalyticsProcessor googleUniversalAnalyticsProcessor =
        new GoogleUniversalAnalyticsProcessor();
