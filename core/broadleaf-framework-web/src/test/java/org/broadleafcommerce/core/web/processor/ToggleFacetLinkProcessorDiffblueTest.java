...
class ToggleFacetLinkProcessorDiffblueTest {
  ...
  void testGetPrecedence2() {
    ...
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.core.web.processor.ToggleFacetLinkProcessor toggleFacetLinkProcessor;
    ...
    // Arrange and Act
    (new ToggleFacetLinkProcessor()).getPrecedence();
  }

  /**
   * Test
   * {@link ToggleFacetLinkProcessor#getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)}.
   * <p>
   * Method under test:
   * {@link ToggleFacetLinkProcessor#getModifiedAttributes(String, Map, String, String, BroadleafTemplateContext)}
   */
  ...
  void testGetModifiedAttributes() {
    ...
    // Arrange
    ToggleFacetLinkProcessor toggleFacetLinkProcessor2 = new ToggleFacetLinkProcessor();

    // Act
    toggleFacetLinkProcessor2.getModifiedAttributes("Tag Name", new HashMap<>(), "Attribute Name", "42",
