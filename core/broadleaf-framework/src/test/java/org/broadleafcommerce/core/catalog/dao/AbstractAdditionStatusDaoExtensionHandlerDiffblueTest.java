...
public class AbstractAdditionStatusDaoExtensionHandlerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AbstractAdditionStatusDaoExtensionHandler#cleanUpEntity(Object)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ExtensionResultStatusType AbstractAdditionStatusDaoExtensionHandler.cleanUpEntity(Object)"})
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AbstractAdditionStatusDaoExtensionHandler}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
