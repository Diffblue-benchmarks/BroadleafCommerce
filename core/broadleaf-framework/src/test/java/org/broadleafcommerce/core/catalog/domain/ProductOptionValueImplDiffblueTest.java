...
public class ProductOptionValueImplDiffblueTest {
  ...
  public void testGetAttributeValue() {
    ...
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.core.catalog.domain.ProductOptionValueImpl productOptionValueImpl;
    ...
    // Arrange and Act
    (new ProductOptionValueImpl()).getAttributeValue();
  }
  ...
  public void testGetPriceAdjustment2() {
    ...
    // Arrange and Act
    (new ProductOptionValueImpl()).getPriceAdjustment();
  }
  ...
  public void testGetPriceAdjustmentSkipDynamicPricing3() {
    ...
    // Arrange and Act
    (new ProductOptionValueImpl()).getPriceAdjustmentSkipDynamicPricing();
  }
  ...
  public void testCreateOrRetrieveCopyInstance2() throws CloneNotSupportedException {
    ...
    // Act
    productOptionValueImpl2.createOrRetrieveCopyInstance(new MultiTenantCopyContext(fromCatalog, toCatalog, fromSite,
   ...
   * {@link ProductOptionValueImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.
   * <ul>
   *   <li>Then return Clone AttributeValue is {@code 42}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link ProductOptionValueImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  public void testCreateOrRetrieveCopyInstance_thenReturnCloneAttributeValueIs42() throws CloneNotSupportedException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    productOptionValueImpl.setDisplayOrder(1L);
    productOptionValueImpl.setId(1L);
    productOptionValueImpl.setProductOption(null);
    Money priceAdjustment = new Money();
    productOptionValueImpl.setPriceAdjustment(priceAdjustment);
    ...
    copyHints.put("MANUAL_DUPLICATION", "Context");
    CatalogImpl fromCatalog = new CatalogImpl();
    CatalogImpl toCatalog = new CatalogImpl();
    SiteImpl fromSite = new SiteImpl();
    SiteImpl toSite = new SiteImpl();
    ...
    context.setCopyHints(copyHints);
    ...
    assertEquals("42", clone.getAttributeValue());
    assertEquals("42", clone.getRawAttributeValue());
    assertNull(clone.getId());
    assertNull(clone.getProductOption());
    assertEquals(1L, clone.getDisplayOrder().longValue());
