...
public class SkuMediaXrefImplDiffblueTest {
  ...
  /**
   * Test {@link SkuMediaXrefImpl#createEntityInstance()}.
   * <ul>
   *   <li>Given {@link SkuMediaXrefImpl#SkuMediaXrefImpl()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SkuMediaXrefImpl#createEntityInstance()}
   */
  @Test
  public void testCreateEntityInstance_givenSkuMediaXrefImpl() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Diffblue AI was unable to find a test

    // Arrange and Act
    (new SkuMediaXrefImpl()).createEntityInstance();
  }
