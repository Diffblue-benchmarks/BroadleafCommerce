...
public class AbstractPreviewProductUrlModifierExtensionHandlerDiffblueTest {
  /**
   * Test {@link AbstractPreviewProductUrlModifierExtensionHandler#modifyUrl(Product, ExtensionResultHolder)}.
   * <p>
   * Method under test: {@link AbstractPreviewProductUrlModifierExtensionHandler#modifyUrl(Product, ExtensionResultHolder)}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AbstractPreviewProductUrlModifierExtensionHandler}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
