...
public class ConfirmPaymentsRollbackHandlerDiffblueTest {
  @Autowired
  private ConfirmPaymentsRollbackHandler confirmPaymentsRollbackHandler;
  ...
  public void testRollbackState() throws RollbackFailureException {
    ...
    //   public class DiffblueFakeClass1346 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.core.checkout.service.workflow.ConfirmPaymentsRollbackHandler confirmPaymentsRollbackHandler;
    ...
    // Arrange
    ConfirmPaymentsRollbackHandler confirmPaymentsRollbackHandler2 = new ConfirmPaymentsRollbackHandler();
    ...
    // Act
    confirmPaymentsRollbackHandler2.rollbackState(activity, processContext, new HashMap<>());
  }
