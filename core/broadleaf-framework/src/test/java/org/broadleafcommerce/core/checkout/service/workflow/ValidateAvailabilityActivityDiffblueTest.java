...
public class ValidateAvailabilityActivityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ValidateAvailabilityActivity} (default constructor).
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext ValidateAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenValidateAvailabilityActivity_thenSeedDataOrderReturnOrderImpl()
      throws Exception {
    // Arrange
    ValidateAvailabilityActivity validateAvailabilityActivity = new ValidateAvailabilityActivity();
