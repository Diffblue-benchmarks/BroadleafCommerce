...
public class ValidateProductOptionsActivityDiffblueTest {
  ...
  public void testExecute() throws Exception {
    ...
    ValidateProductOptionsActivity validateProductOptionsActivity =
        new ValidateProductOptionsActivity();
  ...
  public void testShouldValidateWithException_whenFalse_thenReturnFalse() {
    ...
    assertFalse(
        new ValidateProductOptionsActivity()
            .shouldValidateWithException(false, false, false, false));
  }
  ...
  public void testShouldValidateWithException_whenTrue_thenReturnFalse() {
    // Arrange, Act and Assert
    assertFalse(
        new ValidateProductOptionsActivity().shouldValidateWithException(true, true, false, false));
  }
  ...
  public void testShouldValidateWithException_whenTrue_thenReturnTrue2() {
    // Arrange, Act and Assert
    assertTrue(
        new ValidateProductOptionsActivity().shouldValidateWithException(true, true, false, true));
  }
  ...
  public void testIsMissingRequiredAttribute_when42_thenReturnFalse() {
    ...
    assertFalse(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(true, true, true, true, "42"));
  }
  ...
  public void testIsMissingRequiredAttribute_when42_thenReturnFalse2() {
    ...
    assertFalse(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(true, true, false, true, "42"));
  }
  ...
  public void testIsMissingRequiredAttribute_when42_thenReturnFalse3() {
    ...
    assertFalse(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(true, true, false, false, "42"));
  }
  ...
  public void testIsMissingRequiredAttribute_whenEmptyString_thenReturnFalse() {
    ...
    assertFalse(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(false, false, false, false, ""));
  }
  ...
  public void testIsMissingRequiredAttribute_whenEmptyString_thenReturnTrue() {
    ...
    assertTrue(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(true, true, true, true, ""));
  }
  ...
  public void testIsMissingRequiredAttribute_whenNull_thenReturnTrue() {
    ...
    assertTrue(
        new ValidateProductOptionsActivity()
            .isMissingRequiredAttribute(true, false, false, false, null));
  }
