...
public class OfferOfferRuleXrefImplDiffblueTest {
  ...
  /**
   * Test {@link OfferOfferRuleXrefImpl#createEntityInstance()}.
   * <ul>
   *   <li>Given {@link OfferOfferRuleXrefImpl#OfferOfferRuleXrefImpl()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link OfferOfferRuleXrefImpl#createEntityInstance()}
   */
  @Test
  public void testCreateEntityInstance_givenOfferOfferRuleXrefImpl() {
    // TODO: Diffblue Cover was only able to create a partial test for this method:
    //   Diffblue AI was unable to find a test

    // Arrange and Act
    (new OfferOfferRuleXrefImpl()).createEntityInstance();
  }
