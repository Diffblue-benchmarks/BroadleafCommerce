...
public class OfferOfferRuleXrefImplDiffblueTest {
  ...
  @MethodsUnderTest({"void OfferOfferRuleXrefImpl.<init>()",
      "void OfferOfferRuleXrefImpl.<init>(Offer, OfferRule, String)", "Long OfferOfferRuleXrefImpl.getId()",
      "String OfferOfferRuleXrefImpl.getKey()", "Offer OfferOfferRuleXrefImpl.getOffer()",
      "OfferRule OfferOfferRuleXrefImpl.getOfferRule()", "void OfferOfferRuleXrefImpl.setId(Long)",
      "void OfferOfferRuleXrefImpl.setKey(String)", "void OfferOfferRuleXrefImpl.setOffer(Offer)",
   ...
   * Test {@link OfferOfferRuleXrefImpl#getMatchRule()}.
   * <ul>
   *   <li>Given {@link OfferOfferRuleXrefImpl#OfferOfferRuleXrefImpl()} Id is {@link CandidateFulfillmentGroupOfferImpl#serialVersionUID}.</li>
   * </ul>
   * <p>
   * Method under test: {@link OfferOfferRuleXrefImpl#getMatchRule()}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void OfferOfferRuleXrefImpl.setMatchRule(String)"})
  public void testSetMatchRule_givenOfferOfferRuleXrefImplIdIsSerialVersionUID() {
    // Arrange
    OfferOfferRuleXrefImpl offerOfferRuleXrefImpl2 = new OfferOfferRuleXrefImpl();
   ...
   * <p>
   * Method under test: {@link OfferOfferRuleXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"CreateResponse OfferOfferRuleXrefImpl.createOrRetrieveCopyInstance(MultiTenantCopyContext)"})
   ...
   * Test {@link OfferOfferRuleXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.
   * <ul>
   *   <li>Then calls {@link OfferImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link OfferOfferRuleXrefImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
