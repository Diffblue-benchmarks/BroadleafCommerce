...
public class PromotionQualifierWrapperDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link PromotionQualifierWrapper#PromotionQualifierWrapper(PromotionQualifier)} with pq is {@link PromotionQualifierWrapper#PromotionQualifierWrapper(PromotionQualifier)}.</li>
   * </ul>
   * <p>
   ...
   * <p>
   * Method under test: {@link PromotionQualifierWrapper#setItemCriteria(OfferItemCriteria)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link PromotionQualifierWrapper#setFinalizedQuantity(int)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PromotionQualifierWrapper.equals(Object)", "int PromotionQualifierWrapper.hashCode()"})
