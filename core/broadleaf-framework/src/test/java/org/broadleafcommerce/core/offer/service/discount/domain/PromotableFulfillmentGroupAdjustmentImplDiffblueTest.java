...
public class PromotableFulfillmentGroupAdjustmentImplDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link PromotableFulfillmentGroupAdjustmentImpl#PromotableFulfillmentGroupAdjustmentImpl(PromotableCandidateFulfillmentGroupOffer, PromotableFulfillmentGroup, Money, Money)}
   *   <li>{@link PromotableFulfillmentGroupAdjustmentImpl#getAdjustmentValue()}
   *   <li>{@link PromotableFulfillmentGroupAdjustmentImpl#getPromotableCandidateFulfillmentGroupOffer()}
