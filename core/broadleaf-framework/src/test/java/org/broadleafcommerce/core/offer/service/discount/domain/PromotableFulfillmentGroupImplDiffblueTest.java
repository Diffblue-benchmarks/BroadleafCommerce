...
public class PromotableFulfillmentGroupImplDiffblueTest {
  ...
  public void testGetDiscountableOrderItems() {
    ...
    // Act
    List<PromotableOrderItem> actualDiscountableOrderItems = promotableFulfillmentGroupImpl.getDiscountableOrderItems();
    ...
    List<PromotableOrderItem> allOrderItems = promotableOrder2.getAllOrderItems();
    assertTrue(allOrderItems.isEmpty());
    assertSame(promotableFulfillmentGroupImpl.discountableOrderItems, actualDiscountableOrderItems);
    List<PromotableOrderItem> promotableOrderItemList = promotableOrder.allOrderItems;
    assertSame(promotableOrderItemList, allOrderItems);
    assertSame(promotableOrderItemList, ((PromotableOrderImpl) promotableOrder2).allOrderItems);
  }
}
