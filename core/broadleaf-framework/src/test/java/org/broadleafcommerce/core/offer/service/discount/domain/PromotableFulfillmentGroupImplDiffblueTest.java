...
public class PromotableFulfillmentGroupImplDiffblueTest {
   ...
   * <p>
   * Method under test: {@link PromotableFulfillmentGroupImpl#getDiscountableOrderItems()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.util.List PromotableFulfillmentGroupImpl.getDiscountableOrderItems()"})
