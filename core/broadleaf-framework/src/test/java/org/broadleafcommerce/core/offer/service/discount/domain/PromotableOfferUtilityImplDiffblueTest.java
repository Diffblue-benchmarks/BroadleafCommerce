...
public class PromotableOfferUtilityImplDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link PromotableOfferUtilityImpl#determineOfferUnitValue(Offer, Integer)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.math.BigDecimal PromotableOfferUtilityImpl.determineOfferUnitValue(Offer, Integer)"})
