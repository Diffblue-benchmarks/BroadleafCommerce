...
public class FulfillmentGroupOfferProcessorImplDiffblueTest {
  ...
  public void testCalculateFulfillmentGroupTotal() {
    ...
    // Assert
    assertSame(order, order2.getOrder());
  }
   ...
   */
  @Test
  public void testCalculateFulfillmentGroupTotal3() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testCompareAndAdjustFulfillmentGroupOffers4() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testCompareAndAdjustFulfillmentGroupOffers5() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testCompareAndAdjustFulfillmentGroupOffers6() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    when(broadleafCurrencyImpl.getCurrencyCode()).thenReturn("GBP");
    PromotableOrder order = mock(PromotableOrder.class);
    when(order.getOrderCurrency()).thenReturn(broadleafCurrencyImpl);
    when(order.calculateSubtotalWithoutAdjustments()).thenReturn(new Money());
   ...
   */
  @Test
  public void testRemoveTrailingNotCombinableFulfillmentGroupOffers5() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testRemoveTrailingNotCombinableFulfillmentGroupOffers6() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    assertSame(fulfillmentGroupOfferPotential2, actualRemoveTrailingNotCombinableFulfillmentGroupOffersResult.get(0));
  }
   ...
   */
  @Test
  public void testRemoveTrailingNotCombinableFulfillmentGroupOffers7() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
