...
public class OfferDiscountTypeDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@code 42FIX_PRICE}.
   *   <li>Then {@link OfferDiscountType} Type is {@code 42FIX_PRICE}.
   * </ul>
   *
  ...
  public void testSetType_when42fixPrice_thenOfferDiscountTypeTypeIs42fixPrice() {
    // Arrange and Act
    offerDiscountType.setType("42FIX_PRICE");

    // Assert
    assertEquals("42FIX_PRICE", offerDiscountType.getType());
  }
