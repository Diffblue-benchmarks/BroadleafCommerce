...
public class AbstractOrderDaoExtensionHandlerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AbstractOrderDaoExtensionHandler#attachAdditionalDataToNewCart(Customer, Order)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link AbstractOrderDaoExtensionHandler#processPostSaveNewCart(Customer, Order)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractOrderDaoExtensionHandler#applyAdditionalOrderLookupFilter(Customer, String, List)}.
   * <ul>
   *   <li>Given {@link NullOrderImpl} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AbstractOrderDaoExtensionHandler#applyAdditionalOrderLookupFilter(Customer, String, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link AbstractOrderDaoExtensionHandler}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
