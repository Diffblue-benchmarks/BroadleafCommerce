...
public class NullOrderImplDiffblueTest {
  @Autowired private NullOrderImpl nullOrderImpl;

  /**
   * Test {@link NullOrderImpl#setId(Long)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setId(Long)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setName(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setAuditable(Auditable)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#getSubTotal()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testGetSubTotal() {
    // Arrange, Act and Assert
    assertEquals(Money.ZERO, new NullOrderImpl().getSubTotal());
  }

  /**
   * Test {@link NullOrderImpl#setSubTotal(Money)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setSubTotal(Money)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#assignOrderItemsFinalPrice()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAssignOrderItemsFinalPrice() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> new NullOrderImpl().assignOrderItemsFinalPrice());
  }

  /**
   * Test {@link NullOrderImpl#setTotal(Money)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setTotal(Money)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setCustomer(Customer)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetCustomer() {
    ...
    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setCustomer(new CustomerImpl()));
  }

  /**
   * Test {@link NullOrderImpl#setStatus(OrderStatus)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setStatus(OrderStatus)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetStatus() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> new NullOrderImpl().setStatus(OrderStatus.ARCHIVED));
  }
   ...
   *   <li>When {@link ArrayList#ArrayList()} add {@link BundleOrderItemImpl} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link NullOrderImpl#setOrderItems(List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetOrderItems_givenBundleOrderItemImpl_whenArrayListAddBundleOrderItemImpl() {
    ...
    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setOrderItems(orderItems));
  }
  ...
  public void testSetOrderItems_whenArrayList() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setOrderItems(new ArrayList<>()));
  }

  /**
   * Test {@link NullOrderImpl#addOrderItem(OrderItem)}.
   *
   * <p>Method under test: {@link NullOrderImpl#addOrderItem(OrderItem)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link NullOrderImpl#setFulfillmentGroups(List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetFulfillmentGroups_givenFulfillmentGroupImpl() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setFulfillmentGroups(fulfillmentGroups));
  }
  ...
  public void testSetFulfillmentGroups_whenArrayList() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setFulfillmentGroups(new ArrayList<>()));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link CandidateOrderOfferImpl} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link NullOrderImpl#setCandidateOrderOffers(List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetCandidateOrderOffers_whenArrayList() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setCandidateOrderOffers(new ArrayList<>()));
  }

  /**
   * Test {@link NullOrderImpl#setSubmitDate(Date)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setSubmitDate(Date)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setTotalTax(Money)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setTotalShipping(Money)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetTotalShipping() {
    ...
    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setTotalShipping(new Money()));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link OrderPaymentImpl} (default constructor).
   *   <li>When {@link ArrayList#ArrayList()} add {@link OrderPaymentImpl} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link NullOrderImpl#setPayments(List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetPayments_givenOrderPaymentImpl_whenArrayListAddOrderPaymentImpl() {
    ...
    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setPayments(paymentInfos));
  }
  ...
  public void testSetPayments_whenArrayList() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setPayments(new ArrayList<>()));
  }

  /**
   * Test {@link NullOrderImpl#hasCategoryItem(String)}.
   *
   * <p>Method under test: {@link NullOrderImpl#hasCategoryItem(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#containsSku(Sku)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setOrderNumber(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setEmailAddress(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetEmailAddress() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setEmailAddress("42 Main St"));
  }

  /**
   * Test {@link NullOrderImpl#setAdditionalOfferInformation(Map)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setAdditionalOfferInformation(Map)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#updatePrices()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#addOfferCode(OfferCode)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAddOfferCode() {
    ...
    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.addOfferCode(new OfferCodeImpl()));
  }

  /**
   * Test {@link NullOrderImpl#addAddedOfferCode(OfferCode)}.
   *
   * <p>Method under test: {@link NullOrderImpl#addAddedOfferCode(OfferCode)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAddAddedOfferCode() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.addAddedOfferCode(new OfferCodeImpl()));
  }

  /**
   * Test {@link NullOrderImpl#setOrderAttributes(Map)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setOrderAttributes(Map)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetOrderAttributes() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setOrderAttributes(new HashMap<>()));
  }

  /**
   * Test {@link NullOrderImpl#setCurrency(BroadleafCurrency)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setCurrency(BroadleafCurrency)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetCurrency() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setCurrency(new BroadleafCurrencyImpl()));
  }

  /**
   * Test {@link NullOrderImpl#calculateSubTotal()}.
   *
   * <p>Method under test: {@link NullOrderImpl#calculateSubTotal()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCalculateSubTotal() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> new NullOrderImpl().calculateSubTotal());
  }

  /**
   * Test {@link NullOrderImpl#setTotalFulfillmentCharges(Money)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setTotalFulfillmentCharges(Money)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetTotalFulfillmentCharges() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setTotalFulfillmentCharges(new Money()));
  }

  /**
   * Test {@link NullOrderImpl#finalizeItemPrices()}.
   *
   * <p>Method under test: {@link NullOrderImpl#finalizeItemPrices()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testFinalizeItemPrices() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> new NullOrderImpl().finalizeItemPrices());
  }

  /**
   * Test {@link NullOrderImpl#setOrderMessages(List)}.
   *
   * <p>Method under test: {@link NullOrderImpl#setOrderMessages(List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetOrderMessages() {
    ...
    orderMessages.add(
        new ActivityMessageDTO(
            "NullOrder does not support any modification operations.",
            1,
            "Not all who wander are lost"));

    // Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> nullOrderImpl.setOrderMessages(orderMessages));
  }
  ...
  public void testSetOrderMessages_whenArrayList() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> nullOrderImpl.setOrderMessages(new ArrayList<>()));
  }

  /**
   * Test {@link NullOrderImpl#getTaxOverride()}.
   *
   * <p>Method under test: {@link NullOrderImpl#getTaxOverride()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#setTaxOverride(Boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testSetTaxOverride() {
    // Arrange, Act and Assert
    assertThrows(
        UnsupportedOperationException.class, () -> new NullOrderImpl().setTaxOverride(true));
  }
   ...
   * NullOrderImpl#createOrRetrieveCopyInstance(MultiTenantCopyContext)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CreateResponse NullOrderImpl.createOrRetrieveCopyInstance(MultiTenantCopyContext)"
  })
  public void testCreateOrRetrieveCopyInstance() throws CloneNotSupportedException {
    ...
    CreateResponse<Order> actualCreateOrRetrieveCopyInstanceResult =
        nullOrderImpl.createOrRetrieveCopyInstance(context);
   ...
   *
   * <p>Method under test: {@link NullOrderImpl#hasValidationErrors()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void NullOrderImpl.<init>()",
    "List NullOrderImpl.getAddedOfferCodes()",
    "Map NullOrderImpl.getAdditionalOfferInformation()",
    "List NullOrderImpl.getAllFutureCreditAdjustments()",
    "Auditable NullOrderImpl.getAuditable()",
    "Long NullOrderImpl.getBroadleafAccountId()",
    "List NullOrderImpl.getCandidateOrderOffers()",
    "BroadleafCurrency NullOrderImpl.getCurrency()",
    "Customer NullOrderImpl.getCustomer()",
    "List NullOrderImpl.getDiscreteOrderItems()",
    "String NullOrderImpl.getEmailAddress()",
    "Money NullOrderImpl.getFulfillmentGroupAdjustmentsValue()",
    "List NullOrderImpl.getFulfillmentGroups()",
    "String NullOrderImpl.getFulfillmentStatus()",
    ...
    "Money NullOrderImpl.getFutureCreditOrderAdjustmentsValue()",
    "boolean NullOrderImpl.getHasOrderAdjustments()",
    "Long NullOrderImpl.getId()",
    "Money NullOrderImpl.getItemAdjustmentsValue()",
    "int NullOrderImpl.getItemCount()",
    "Locale NullOrderImpl.getLocale()",
    "String NullOrderImpl.getName()",
    "List NullOrderImpl.getNonDiscreteOrderItems()",
    "List NullOrderImpl.getOrderAdjustments()",
    "Money NullOrderImpl.getOrderAdjustmentsValue()",
    "Map NullOrderImpl.getOrderAttributes()",
    "List NullOrderImpl.getOrderItems()",
    "List NullOrderImpl.getOrderMessages()",
    "String NullOrderImpl.getOrderNumber()",
    "List NullOrderImpl.getPayments()",
    "OrderStatus NullOrderImpl.getStatus()",
    "Date NullOrderImpl.getSubmitDate()",
    "Money NullOrderImpl.getTotal()",
    "Money NullOrderImpl.getTotalAdjustmentsValue()",
    "Money NullOrderImpl.getTotalAfterAppliedPayments()",
    "Money NullOrderImpl.getTotalFulfillmentCharges()",
    "Money NullOrderImpl.getTotalFutureCreditAdjustmentsValue()",
    "Money NullOrderImpl.getTotalShipping()",
    "Money NullOrderImpl.getTotalTax()",
  ...
  public void testGettersAndSetters() {
    ...
    List<Adjustment> actualAllFutureCreditAdjustments =
    ...
    List<CandidateOrderOffer> actualCandidateOrderOffers =
    ...
    Money actualFutureCreditItemAdjustmentsValue =
    ...
    assertSame(Money.ZERO, actualOrderAdjustmentsValue);
  }
}
