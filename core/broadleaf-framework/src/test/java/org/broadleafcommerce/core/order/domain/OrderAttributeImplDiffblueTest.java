...
public class OrderAttributeImplDiffblueTest {
  ...
  @MethodsUnderTest({"boolean OrderAttributeImpl.equals(Object)", "int OrderAttributeImpl.hashCode()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void OrderAttributeImpl.<init>()", "Long OrderAttributeImpl.getId()",
      "String OrderAttributeImpl.getName()", "Order OrderAttributeImpl.getOrder()",
      "String OrderAttributeImpl.getValue()", "void OrderAttributeImpl.setId(Long)",
      "void OrderAttributeImpl.setName(String)", "void OrderAttributeImpl.setOrder(Order)",
      "void OrderAttributeImpl.setValue(String)", "String OrderAttributeImpl.toString()"})
