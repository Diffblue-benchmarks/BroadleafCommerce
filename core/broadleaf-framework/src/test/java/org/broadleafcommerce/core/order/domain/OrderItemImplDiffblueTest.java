...
public class OrderItemImplDiffblueTest {
   ...
   * <ul>
   *   <li>Then return abs abs Amount is {@link BundleOrderItemImpl} (default constructor) {@link OrderItemImpl#salePrice}.</li>
   * </ul>
   * <p>
  ...
  public void testGetTotalPrice_thenReturnAbsAbsAmountIsBundleOrderItemImplSalePrice() {
    // Arrange
    BroadleafCurrencyImpl broadleafCurrencyImpl = mock(BroadleafCurrencyImpl.class);
    when(broadleafCurrencyImpl.getCurrencyCode()).thenReturn("GBP");
    Order order = mock(Order.class);
