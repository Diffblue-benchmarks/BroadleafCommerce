...
public class AbstractOrderServiceExtensionHandlerDiffblueTest {
  /**
   * Test {@link AbstractOrderServiceExtensionHandler#attachAdditionalDataToNewNamedCart(Customer, Order)}.
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#attachAdditionalDataToNewNamedCart(Customer, Order)}
   */
  @Test
  ...
  /**
   * Test {@link AbstractOrderServiceExtensionHandler#preValidateCartOperation(Order, ExtensionResultHolder)}.
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#preValidateCartOperation(Order, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractOrderServiceExtensionHandler#preValidateUpdateQuantityOperation(Order, OrderItemRequestDTO, ExtensionResultHolder)}.
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#preValidateUpdateQuantityOperation(Order, OrderItemRequestDTO, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#addOfferCodes(Order, List, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractOrderServiceExtensionHandler#findCartForCustomerWithEnhancements(Customer, Order, ExtensionResultHolder)} with {@code customer}, {@code candidateCart}, {@code erh}.
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#findCartForCustomerWithEnhancements(Customer, Order, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractOrderServiceExtensionHandler#findCartForCustomerWithEnhancements(Customer, ExtensionResultHolder)} with {@code customer}, {@code erh}.
   * <p>
   * Method under test: {@link AbstractOrderServiceExtensionHandler#findCartForCustomerWithEnhancements(Customer, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
