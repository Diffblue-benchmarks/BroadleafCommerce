...
public class CartMessageOrderItemServiceExtensionHandlerDiffblueTest {
   ...
   */
  @Test
  public void testGatherProductCartMessages2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testAddPromotionMessagesForType4() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    PromotionMessageDTO promotionMessageDTO = new PromotionMessageDTO(new PromotionMessageImpl());
    messageDTOs.add(promotionMessageDTO);
    PromotionMessageDTO promotionMessageDTO2 = new PromotionMessageDTO(new PromotionMessageImpl());
    messageDTOs.add(promotionMessageDTO2);
    ...
    assertSame(promotionMessageDTO, messageDTOs.get(0));
    assertSame(promotionMessageDTO2, messageDTOs.get(1));
  }
   ...
   */
  @Test
  public void testAddPromotionMessagesForType5() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testAddPromotionMessagesForType6() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    messages.add(promotionMessageDTO);
    PromotionMessageDTO promotionMessageDTO2 = new PromotionMessageDTO(new PromotionMessageImpl());
    messages.add(promotionMessageDTO2);
   ...
   */
  @Test
  public void testAddPromotionMessagesForType7() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
