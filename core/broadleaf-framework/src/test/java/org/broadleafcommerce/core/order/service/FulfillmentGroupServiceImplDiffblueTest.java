...
public class FulfillmentGroupServiceImplDiffblueTest {
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrder12()
    ...
    fulfillmentGroupImpl2.setFulfillmentGroupItems(fulfillmentGroupItems2);

    ArrayList<FulfillmentGroup> fulfillmentGroups2 = new ArrayList<>();
    fulfillmentGroups2.add(fulfillmentGroupImpl2);

    OrderImpl order2 = new OrderImpl();
    order2.setAdditionalOfferInformation(new HashMap<>());
    order2.setAuditable(auditable3);
    ...
    order2.setFulfillmentGroups(fulfillmentGroups2);
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrder13()
      throws PricingException {
    // Arrange
    doThrow(new IllegalArgumentException())
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrder14()
      throws PricingException {
    // Arrange
    ...
    verify(fulfillmentGroupItemImpl).getOrderItem();
    verify(orderService).save(isA(Order.class), eq(false));
    Order order3 = fulfillmentGroupItemRequest.getOrder();
    List<FulfillmentGroup> fulfillmentGroups3 = order3.getFulfillmentGroups();
    assertEquals(1, fulfillmentGroups3.size());
    FulfillmentGroup getResult = fulfillmentGroups3.get(0);
    assertTrue(getResult instanceof FulfillmentGroupImpl);
    assertTrue(actualAddItemToFulfillmentGroupResult instanceof FulfillmentGroupImpl);
    assertTrue(order3 instanceof OrderImpl);
    assertTrue(getResult.getFulfillmentGroupItems().isEmpty());
    assertEquals(
        fulfillmentGroupItems2, actualAddItemToFulfillmentGroupResult.getFulfillmentGroupItems());
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave3()
    ...
    FulfillmentGroupItemRequest fulfillmentGroupItemRequest = new FulfillmentGroupItemRequest();
    fulfillmentGroupItemRequest.setFulfillmentGroup(new FulfillmentGroupImpl());
    fulfillmentGroupItemRequest.setOrder(mock(NullOrderImpl.class));
    fulfillmentGroupItemRequest.setOrderItem(new BundleOrderItemImpl());
    fulfillmentGroupItemRequest.setQuantity(1);
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave6()
    ...
    List<FulfillmentGroupItem> fulfillmentGroupItems =
        actualAddItemToFulfillmentGroupResult.getFulfillmentGroupItems();
    assertEquals(1, fulfillmentGroupItems.size());
    FulfillmentGroupItem getResult = fulfillmentGroupItems.get(0);
    assertTrue(getResult instanceof FulfillmentGroupItemImpl);
    Order order2 = fulfillmentGroupItemRequest.getOrder();
    assertTrue(order2 instanceof OrderImpl);
    assertNull(getResult.getFulfillmentGroup());
    assertNull(getResult.getOrderItem());
    assertEquals(0, getResult.getQuantity());
    assertTrue(order2.getFulfillmentGroups().isEmpty());
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave9()
    ...
    assertNull(getResult.getOrderItem());
    assertEquals(0, getResult.getQuantity());
    List<FulfillmentGroup> fulfillmentGroups2 = order2.getFulfillmentGroups();
    assertEquals(1, fulfillmentGroups2.size());
    assertSame(fulfillmentGroups, fulfillmentGroups2);
    assertSame(fulfillmentGroupImpl, fulfillmentGroups2.get(0));
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave11()
    ...
    assertEquals(1, fulfillmentGroups2.size());
    assertSame(fulfillmentGroups, fulfillmentGroups2);
    assertSame(fulfillmentGroupImpl2, fulfillmentGroups2.get(0));
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave12()
    ...
    assertNull(getResult.getOrderItem());
    assertEquals(0, getResult.getQuantity());
    assertSame(fulfillmentGroups, order2.getFulfillmentGroups());
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave13()
      throws PricingException {
    // Arrange
    when(fulfillmentGroupItemDao.create()).thenReturn(new FulfillmentGroupItemImpl());
    ...
    verify(fulfillmentGroupItemDao).create();
    verify(fulfillmentGroupItemImpl).getOrderItem();
    List<FulfillmentGroupItem> fulfillmentGroupItems3 =
        actualAddItemToFulfillmentGroupResult.getFulfillmentGroupItems();
    assertEquals(1, fulfillmentGroupItems3.size());
    FulfillmentGroupItem getResult = fulfillmentGroupItems3.get(0);
    OrderItem orderItem2 = getResult.getOrderItem();
    ...
    assertSame(orderItem, orderItem2);
    assertSame(fulfillmentGroup, getResult.getFulfillmentGroup());
  }
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave14()
      throws PricingException {
    // Arrange
    doNothing().when(fulfillmentGroupItemDao).delete(Mockito.<FulfillmentGroupItem>any());
    when(fulfillmentGroupItemDao.create()).thenReturn(new FulfillmentGroupItemImpl());
  ...
  public void testAddItemToFulfillmentGroupWithFulfillmentGroupItemRequestPriceOrderSave15()
      throws PricingException {
    // Arrange
    doThrow(new IllegalArgumentException())
        .when(fulfillmentGroupItemDao)
   ...
   *
   * <ul>
   *   <li>Given {@link FulfillmentGroupServiceImpl} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link
   * FulfillmentGroupServiceImpl#removeOrderItemFromFullfillmentGroups(Order, OrderItem)}
  ...
  public void testRemoveOrderItemFromFullfillmentGroups_givenFulfillmentGroupServiceImpl() {
    // Arrange
    FulfillmentGroupServiceImpl fulfillmentGroupServiceImpl = new FulfillmentGroupServiceImpl();
  ...
  public void testCollapseToOneShippableFulfillmentGroup() throws PricingException {
    ...
    assertSame(fulfillmentGroupImpl2, getResult);
  }
   ...
   *
   * <ul>
   *   <li>Then return FulfillmentGroups size is one.
   * </ul>
   *
   * <p>Method under test: {@link
   * FulfillmentGroupServiceImpl#collapseToOneShippableFulfillmentGroup(Order, boolean)}
  ...
  public void testCollapseToOneShippableFulfillmentGroup_thenReturnFulfillmentGroupsSizeIsOne()
      throws PricingException {
    // Arrange
    FulfillmentGroupServiceImpl fulfillmentGroupServiceImpl = new FulfillmentGroupServiceImpl();
  ...
  public void testCollapseToOneShippableFulfillmentGroup_thenReturnNullOrderImpl()
      throws PricingException {
    // Arrange
    FulfillmentGroupServiceImpl fulfillmentGroupServiceImpl = new FulfillmentGroupServiceImpl();
    NullOrderImpl order = new NullOrderImpl();
  ...
  public void testCollapseToOneShippableFulfillmentGroup_thenReturnNullOrderImpl2()
      throws PricingException {
    // Arrange
    doNothing().when(fulfillmentGroupDao).delete(Mockito.<FulfillmentGroup>any());
    when(orderService.save(Mockito.<Order>any(), Mockito.<Boolean>any()))
  ...
  public void testGetKey_givenFulfillmentGroupServiceImpl_whenNull_thenReturn11Digital() {
    // Arrange, Act and Assert
    assertEquals(
        "-1:-1:DIGITAL",
        new FulfillmentGroupServiceImpl().getKey(null, null, FulfillmentType.DIGITAL));
  }
  ...
  public void testGetKey_givenFulfillmentGroupServiceImpl_whenNull_thenReturn111() {
    // Arrange, Act and Assert
  ...
  public void testGetKey_givenType_whenFulfillmentTypeGetTypeReturnType_thenReturn11Type() {
    ...
    // Act
    String actualKey = fulfillmentGroupServiceImpl.getKey(null, null, fulfillmentType);
  ...
  public void testRemoveAllFulfillmentGroupsFromOrder_thenReturnNullOrderImpl()
      throws PricingException {
    // Arrange
    FulfillmentGroupServiceImpl fulfillmentGroupServiceImpl = new FulfillmentGroupServiceImpl();
    NullOrderImpl order = new NullOrderImpl();
    ...
    // Assert
    assertSame(order, actualRemoveAllFulfillmentGroupsFromOrderResult);
  }
  ...
  public void testRemoveAllFulfillmentGroupsFromOrder_thenReturnNullOrderImpl2()
      throws PricingException {
    // Arrange
    doNothing().when(fulfillmentGroupDao).delete(Mockito.<FulfillmentGroup>any());
    when(orderService.save(Mockito.<Order>any(), Mockito.<Boolean>any()))
