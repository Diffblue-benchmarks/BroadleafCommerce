...
public class MergeCartServiceImplDiffblueTest {
   ...
   * <ul>
   *   <li>Given space.
   *   <li>When {@link Customer} {@link Customer#getEmailAddress()} return space.
   * </ul>
   *
   * <p>Method under test: {@link MergeCartServiceImpl#setNewCartOwnership(Order, Customer)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MergeCartServiceImpl.setNewCartOwnership(Order, Customer)"})
  public void testSetNewCartOwnership_givenSpace_whenCustomerGetEmailAddressReturnSpace() {
    // Arrange
    MergeCartServiceExtensionHandler mergeCartServiceExtensionHandler =
        mock(MergeCartServiceExtensionHandler.class);
    when(mergeCartServiceExtensionHandler.setNewCartOwnership(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MergeCartServiceImpl.setNewCartOwnership(Order, Customer)"})
  public void testSetNewCartOwnership_whenCustomerImplEmailAddressIs42MainSt() {
    // Arrange
    MergeCartServiceExtensionHandler mergeCartServiceExtensionHandler =
        mock(MergeCartServiceExtensionHandler.class);
    when(mergeCartServiceExtensionHandler.setNewCartOwnership(
   ...
   *   <li>Then {@link OrderImpl} (default constructor) Customer is {@link CustomerImpl} (default
   *       constructor).
   * </ul>
   *
   * <p>Method under test: {@link MergeCartServiceImpl#setNewCartOwnership(Order, Customer)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MergeCartServiceImpl.setNewCartOwnership(Order, Customer)"})
  public void testSetNewCartOwnership_whenCustomerImpl_thenOrderImplCustomerIsCustomerImpl() {
    // Arrange
    MergeCartServiceExtensionHandler mergeCartServiceExtensionHandler =
        mock(MergeCartServiceExtensionHandler.class);
    when(mergeCartServiceExtensionHandler.setNewCartOwnership(
