...
public class OrderItemServiceImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then {@link DiscreteOrderItemImpl} (default constructor) OrderItemAttributes Empty.
   * </ul>
   *
   * <p>Method under test: {@link OrderItemServiceImpl#populateDiscreteOrderItem(DiscreteOrderItem,
   * AbstractOrderItemRequest)}
  ...
  public void testPopulateDiscreteOrderItem_thenDiscreteOrderItemImplOrderItemAttributesEmpty() {
    // Arrange
    OrderItemServiceExtensionHandler orderItemServiceExtensionHandler =
        mock(OrderItemServiceExtensionHandler.class);
    when(orderItemServiceExtensionHandler.applyAdditionalOrderItemProperties(
    ...
    Money adjustmentValue = item.getAdjustmentValue();
    Money zeroResult = adjustmentValue.zero().abs().zero().zero();
    Money absResult = zeroResult.abs();
    assertEquals(adjustmentValue, absResult.abs());
    assertEquals(adjustmentValue, zeroResult.zero().abs());
    assertEquals(adjustmentValue, absResult.zero());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void OrderItemServiceImpl.populateProductOptionAttributes(OrderItem, Map)"})
  public void testPopulateProductOptionAttributes_givenAuditableCreatedByIsOne() {
    // Arrange
    OrderItemServiceImpl orderItemServiceImpl = new OrderItemServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void OrderItemServiceImpl.populateProductOptionAttributes(OrderItem, Map)"})
  public void testPopulateProductOptionAttributes_givenNull_whenHashMapFooIsNull() {
    // Arrange
    OrderItemServiceImpl orderItemServiceImpl = new OrderItemServiceImpl();
    BundleOrderItemImpl item = new BundleOrderItemImpl();
  ...
  public void testCreateOrderItem_givenHashMap() {
    // Arrange
    OrderItemServiceExtensionHandler orderItemServiceExtensionHandler =
        mock(OrderItemServiceExtensionHandler.class);
    when(orderItemServiceExtensionHandler.applyAdditionalOrderItemProperties(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OrderItem OrderItemServiceImpl.createOrderItem(OrderItemRequest)"})
  public void testCreateOrderItem_givenNull() {
    // Arrange
    OrderItemServiceExtensionHandler orderItemServiceExtensionHandler =
        mock(OrderItemServiceExtensionHandler.class);
    when(orderItemServiceExtensionHandler.applyAdditionalOrderItemProperties(
  ...
  public void testCreateDynamicPriceDiscreteOrderItem() {
    ...
    HashMap<String, String> itemAttributes = new HashMap<>();
    itemAttributes.put("currency.default", "currency.default");
  ...
  public void testCreateDynamicPriceDiscreteOrderItem2() {
    // Arrange
    DynamicSkuPrices dynamicSkuPrices = new DynamicSkuPrices();
    dynamicSkuPrices.setDidOverride(true);
    dynamicSkuPrices.setPriceAdjustment(new Money());
    ...
    HashMap<String, OrderItemAttribute> stringOrderItemAttributeMap = new HashMap<>();
    stringOrderItemAttributeMap.put("currency.default", new OrderItemAttributeImpl());
   ...
   *
   * <ul>
   *   <li>Given {@link HashMap#HashMap()} {@code currency.default} is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderItemServiceImpl#createDynamicPriceDiscreteOrderItem(DiscreteOrderItemRequest, HashMap)}
  ...
  public void testCreateDynamicPriceDiscreteOrderItem_givenHashMapCurrencyDefaultIsNull() {
    // Arrange
    DynamicSkuPrices dynamicSkuPrices = new DynamicSkuPrices();
    dynamicSkuPrices.setDidOverride(true);
    dynamicSkuPrices.setPriceAdjustment(new Money());
    ...
    HashMap<String, String> itemAttributes = new HashMap<>();
    itemAttributes.put("currency.default", null);
  ...
  public void testCreateDynamicPriceDiscreteOrderItem_givenNull() {
    // Arrange
    DynamicSkuPrices dynamicSkuPrices = new DynamicSkuPrices();
    dynamicSkuPrices.setDidOverride(true);
    dynamicSkuPrices.setPriceAdjustment(new Money());
   ...
   *
   * <ul>
   *   <li>Then return Quantity intValue is one.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderItemServiceImpl#buildOrderItemRequestDTOFromOrderItem(OrderItem)}
  ...
  public void testBuildOrderItemRequestDTOFromOrderItem_thenReturnQuantityIntValueIsOne() {
    // Arrange
    OrderItemServiceImpl orderItemServiceImpl = new OrderItemServiceImpl();
  ...
  public void testBuildOrderItemFromDTO() {
    ...
    NonDiscreteOrderItemRequestDTO orderItemRequestDTO =
        new NonDiscreteOrderItemRequestDTO("Item Name", 1, null);
  ...
  public void testBuildOrderItemFromDTO2() {
    // Arrange
    when(catalogService.findCategoryById(Mockito.<Long>any())).thenReturn(new CategoryImpl());
    when(catalogService.findProductById(Mockito.<Long>any())).thenReturn(new ProductBundleImpl());
    ...
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getAdjustmentValue());
    assertEquals(
        overrideRetailPrice, actualBuildOrderItemFromDTOResult.getAverageAdjustmentValue());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getAveragePrice());
    assertEquals(
        overrideRetailPrice,
        actualBuildOrderItemFromDTOResult.getFutureCreditTotalAdjustmentValue());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getPrice());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getRetailPrice());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getTaxablePrice());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getTotalAdjustmentValue());
    assertEquals(overrideRetailPrice, actualBuildOrderItemFromDTOResult.getTotalPrice());
    assertSame(bundleOrderItemImpl, actualBuildOrderItemFromDTOResult.getParentOrderItem());
  }
  ...
  public void testBuildOrderItemFromDTO3() {
    // Arrange
    when(catalogService.findCategoryById(Mockito.<Long>any())).thenReturn(new CategoryImpl());
    when(catalogService.findSkuById(Mockito.<Long>any())).thenReturn(new SkuImpl());
  ...
  public void testBuildOrderItemFromDTO4() {
    // Arrange
    when(catalogService.findProductById(Mockito.<Long>any())).thenReturn(new ProductBundleImpl());
    when(catalogService.findSkuById(Mockito.<Long>any())).thenReturn(new SkuImpl());
  ...
  public void testBuildOrderItemFromDTO5() {
    // Arrange
    when(catalogService.findCategoryById(Mockito.<Long>any())).thenReturn(new CategoryImpl());
  ...
  public void testBuildOrderItemFromDTO6() {
    // Arrange
    when(catalogService.findSkuById(Mockito.<Long>any())).thenReturn(new SkuImpl());
  ...
  public void testBuildOrderItemFromDTO_thenCallsFindCategoryById() {
    // Arrange
    when(catalogService.findCategoryById(Mockito.<Long>any())).thenReturn(new CategoryImpl());
    when(catalogService.findProductById(Mockito.<Long>any())).thenReturn(new ProductBundleImpl());
    when(catalogService.findSkuById(Mockito.<Long>any())).thenReturn(new SkuImpl());
  ...
  public void testBuildOrderItemFromDTO_thenCallsGetDefaultCategory() {
    // Arrange
  ...
  public void testBuildOrderItemFromDTO_thenOrderReturnNullOrderImpl() {
    // Arrange
    when(catalogService.findCategoryById(Mockito.<Long>any())).thenReturn(new CategoryImpl());
    when(catalogService.findProductById(Mockito.<Long>any())).thenReturn(new ProductBundleImpl());
    when(catalogService.findSkuById(Mockito.<Long>any())).thenReturn(new SkuImpl());
    ...
    verify(orderItemServiceExtensionHandler, atLeast(1))
        .applyAdditionalOrderItemProperties(isA(OrderItem.class));
    assertTrue(actualBuildOrderItemFromDTOResult instanceof BundleOrderItemImpl);
    assertTrue(actualBuildOrderItemFromDTOResult.getOrder() instanceof NullOrderImpl);
    assertNull(actualBuildOrderItemFromDTOResult.getParentOrderItem());
    assertFalse(actualBuildOrderItemFromDTOResult.isChildOrderItem());
  }
