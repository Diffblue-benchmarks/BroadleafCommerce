...
public class OrderMultishipOptionServiceImplDiffblueTest {
  ...
  public void testGetOrderMultishipOptionsFromDTOs() {
    ...
    assertSame(fulfillmentOptionImpl, getResult.getFulfillmentOption());
  }
   ...
   *
   * <ul>
   *   <li>Then first Address return {@link AddressImpl}.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderMultishipOptionServiceImpl#getOrderMultishipOptionsFromDTOs(Order, List)}
  ...
  public void testGetOrderMultishipOptionsFromDTOs_thenFirstAddressReturnAddressImpl() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then first OrderItem return {@link BundleOrderItemImpl}.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderMultishipOptionServiceImpl#getOrderMultishipOptionsFromDTOs(Order, List)}
