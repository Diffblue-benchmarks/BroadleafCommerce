...
public class OrderServiceImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OrderItem OrderServiceImpl.findLastMatchingItem(Order, Long, Long)"})
  public void testFindLastMatchingItem_givenArrayListAddBundleOrderItemImpl_whenNull() {
    // Arrange
    Auditable auditable = new Auditable();
    auditable.setCreatedBy(1L);
    auditable.setDateCreated(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OrderItem OrderServiceImpl.findLastMatchingItem(Order, Long, Long)"})
  public void testFindLastMatchingItem_givenAuditableCreatedByIsOne_whenNull_thenReturnNull() {
    // Arrange
    Auditable auditable = new Auditable();
    auditable.setCreatedBy(1L);
    auditable.setDateCreated(
   ...
   *
   * <ul>
   *   <li>Given {@link OrderServiceImpl}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OrderItem OrderServiceImpl.findLastMatchingItem(Order, Long, Long)"})
  public void testFindLastMatchingItem_givenOrderServiceImpl_whenNull_thenReturnNull() {
    // Arrange
    ...
    // Act and Assert
    assertNull(orderServiceImpl.findLastMatchingItem(order, null, 1L));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link AddToCartItem} {@link AddToCartItem#getChildOrderItems()} throw {@link
   *       RuntimeException#RuntimeException()}.
   * </ul>
   *
  ...
  public void testAddChildItems_givenAddToCartItemGetChildOrderItemsThrowRuntimeException()
    ...
    ArrayList<OrderItemRequestDTO> orderItemRequestDTOList = new ArrayList<>();
    orderItemRequestDTOList.add(addToCartItem);

    AddToCartItem orderItemRequestDTO2 = mock(AddToCartItem.class);
    when(orderItemRequestDTO2.getChildOrderItems()).thenReturn(orderItemRequestDTOList);
    ...
    assertThrows(
        RuntimeException.class,
        () ->
            orderServiceImpl.addChildItems(
                orderItemRequestDTO2, 10, 2, context, new ArrayList<>()));
    verify(addToCartItem).getChildOrderItems();
    verify(orderItemRequestDTO2, atLeast(1)).getChildOrderItems();
  ...
  public void testAddChildItems_thenCallsGetChildOrderItems() throws WorkflowException {
    ...
    orderItemRequestDTO2.setQuantity(0);
    orderItemRequestDTO2.setChildOrderItems(childOrderItems);

    ArrayList<OrderItemRequestDTO> orderItemRequestDTOList = new ArrayList<>();
    orderItemRequestDTOList.add(orderItemRequestDTO2);

    AddToCartItem orderItemRequestDTO3 = mock(AddToCartItem.class);
    when(orderItemRequestDTO3.getChildOrderItems()).thenReturn(orderItemRequestDTOList);
    ...
    // Act
    orderServiceImpl.addChildItems(orderItemRequestDTO3, 10, 2, context, new ArrayList<>());

    // Assert
    verify(orderItemRequestDTO3, atLeast(1)).getChildOrderItems();
    verify(cartOperationRequest).getOrderItem();
  }
  ...
  public void testFindAllChildrenToRemove_thenArrayListSizeIsOne() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void OrderServiceImpl.findAllChildrenToRemove(List, OrderItem)"})
  public void testFindAllChildrenToRemove_thenArrayListSizeIsThree() {
    // Arrange
    ArrayList<Long> childrenToRemove = new ArrayList<>();
  ...
  public void testCompareAttributes_givenHashMap() {
    // Arrange
    OrderItemRequestDTO item2 = new OrderItemRequestDTO(1L, 1);
    item2.setItemAttributes(new HashMap<>());

    // Act
    boolean actualCompareAttributesResult = orderServiceImpl.compareAttributes(null, item2);

    // Assert
    assertTrue(actualCompareAttributesResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean OrderServiceImpl.compareAttributes(Map, OrderItemRequestDTO)"})
  public void testCompareAttributes_givenNull_whenHashMapFooIsNull_thenReturnFalse() {
    // Arrange
    HashMap<String, OrderItemAttribute> item1Attributes = new HashMap<>();
    item1Attributes.put("foo", null);

    TreeMap<String, String> stringStringMap = new TreeMap<>();
    stringStringMap.put("foo", "foo");

    AddToCartItem item2 = mock(AddToCartItem.class);
    when(item2.getItemAttributes()).thenReturn(stringStringMap);

    // Act
    boolean actualCompareAttributesResult =
        orderServiceImpl.compareAttributes(item1Attributes, item2);

    // Assert
    verify(item2, atLeast(1)).getItemAttributes();
    assertFalse(actualCompareAttributesResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link OrderItemAttributeImpl} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link OrderServiceImpl#compareAttributes(Map, OrderItemRequestDTO)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean OrderServiceImpl.compareAttributes(Map, OrderItemRequestDTO)"})
  public void testCompareAttributes_givenOrderItemAttributeImpl() {
    // Arrange
    HashMap<String, OrderItemAttribute> item1Attributes = new HashMap<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean OrderServiceImpl.compareAttributes(Map, OrderItemRequestDTO)"})
  public void testCompareAttributes_givenOrderItemAttributeImpl_whenOrderItemRequestDTO() {
    // Arrange
    HashMap<String, OrderItemAttribute> item1Attributes = new HashMap<>();
    item1Attributes.put("foo", new OrderItemAttributeImpl());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean OrderServiceImpl.compareAttributes(Map, OrderItemRequestDTO)"})
  public void testCompareAttributes_thenThrowRuntimeException() {
    // Arrange
    OrderItemAttributeImpl orderItemAttributeImpl = mock(OrderItemAttributeImpl.class);
    when(orderItemAttributeImpl.getValue()).thenThrow(new RuntimeException());

    HashMap<String, OrderItemAttribute> item1Attributes = new HashMap<>();
    item1Attributes.put("foo", orderItemAttributeImpl);
    ...
    // Act and Assert
    assertThrows(
        RuntimeException.class, () -> orderServiceImpl.compareAttributes(item1Attributes, item2));
    verify(orderItemAttributeImpl).getValue();
    verify(item2, atLeast(1)).getItemAttributes();
  }
   ...
   *
   * <ul>
   *   <li>When {@link AddToCartItem} {@link AddToCartItem#getItemAttributes()} return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link OrderServiceImpl#compareAttributes(Map, OrderItemRequestDTO)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean OrderServiceImpl.compareAttributes(Map, OrderItemRequestDTO)"})
  public void testCompareAttributes_whenAddToCartItemGetItemAttributesReturnNull() {
    // Arrange
    HashMap<String, OrderItemAttribute> item1Attributes = new HashMap<>();
    item1Attributes.put("foo", new OrderItemAttributeImpl());

    AddToCartItem item2 = mock(AddToCartItem.class);
    when(item2.getItemAttributes()).thenReturn(null);
    ...
    // Assert
    verify(item2).getItemAttributes();
    assertFalse(actualCompareAttributesResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OrderItem OrderServiceImpl.findMatchingItem(Order, OrderItemRequestDTO)"})
  public void testFindMatchingItem_givenNull_whenNull_thenReturnNull() {
    // Arrange
    OrderItemRequestDTO itemToFind = new OrderItemRequestDTO(1L, 1);
    itemToFind.setSkuId(null);
    itemToFind.setProductId(null);
    itemToFind.setItemAttributes(null);

    // Act
    OrderItem actualFindMatchingItemResult = orderServiceImpl.findMatchingItem(null, itemToFind);
   ...
   *
   * <ul>
   *   <li>Given {@link OrderDao} {@link OrderDao#acquireLock(Order)} return {@code false}.
   *   <li>Then return {@code false}.
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>Given {@link OrderDao} {@link OrderDao#acquireLock(Order)} return {@code true}.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link OrderServiceImpl#acquireLock(Order)}
