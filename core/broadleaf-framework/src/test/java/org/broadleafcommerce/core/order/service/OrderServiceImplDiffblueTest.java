...
public class OrderServiceImplDiffblueTest {
   ...
   */
  @Test
  public void testAddItemFromNamedOrder() throws AddToCartException, RemoveFromCartException, UpdateCartException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
  ...
  public void testFindAllChildrenToRemove() {
    ...
    assertTrue(orderItem.getDiscreteOrderItems().isEmpty());
    assertTrue(orderItem.getCandidateItemOffers().isEmpty());
    assertTrue(orderItem.getChildOrderItems().isEmpty());
    assertTrue(orderItem.getOrderItemAdjustments().isEmpty());
    assertTrue(orderItem.getOrderItemPriceDetails().isEmpty());
    assertTrue(orderItem.getOrderItemQualifiers().isEmpty());
    assertTrue(orderItem.getProratedOrderItemAdjustments().isEmpty());
  }
   ...
   */
  @Test
  public void testFindAllChildrenToRemove2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    orderItem.setOrderItemAdjustments(orderItemAdjustments);
    ...
    orderItem.setOrderItemQualifiers(orderItemQualifiers);
    ...
    ArrayList<ProratedOrderItemAdjustment> proratedOrderItemAdjustments = new ArrayList<>();
    orderItem.setProratedOrderItemAdjustments(proratedOrderItemAdjustments);
    ...
    List<DiscreteOrderItem> discreteOrderItems2 = orderItem.getDiscreteOrderItems();
    assertTrue(discreteOrderItems2.isEmpty());
    List<CandidateItemOffer> candidateItemOffers2 = orderItem.getCandidateItemOffers();
    assertTrue(candidateItemOffers2.isEmpty());
    List<String> cartMessages = orderItem.getCartMessages();
    assertTrue(cartMessages.isEmpty());
    List<OrderItemAdjustment> orderItemAdjustments2 = orderItem.getOrderItemAdjustments();
    ...
    assertTrue(orderItemPriceDetails2.isEmpty());
    List<OrderItemQualifier> orderItemQualifiers2 = orderItem.getOrderItemQualifiers();
    assertTrue(orderItemQualifiers2.isEmpty());
    List<ProratedOrderItemAdjustment> proratedOrderItemAdjustments2 = orderItem.getProratedOrderItemAdjustments();
    assertTrue(proratedOrderItemAdjustments2.isEmpty());
    assertSame(discreteOrderItems, discreteOrderItems2);
    assertSame(candidateItemOffers, candidateItemOffers2);
    assertSame(cartMessage, cartMessages);
    assertSame(childOrderItems4, orderItem.getChildOrderItems());
    assertSame(orderItemAdjustments, orderItemAdjustments2);
    assertSame(orderItemPriceDetails, orderItemPriceDetails2);
    assertSame(orderItemQualifiers, orderItemQualifiers2);
    assertSame(proratedOrderItemAdjustments, proratedOrderItemAdjustments2);
    assertSame(parentOrderItem, orderItem.getParentOrderItem());
    assertSame(giftWrapOrderItem, orderItem.getGiftWrapOrderItem());
  }
   ...
   */
  @Test
  public void testFindAllChildrenToRemove3() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    ...
    assertSame(candidateItemOffers, candidateItemOffers2);
    assertSame(cartMessage, cartMessages);
    assertSame(childOrderItems2, orderItem.getChildOrderItems());
    assertSame(orderItemAdjustments, orderItemAdjustments2);
    assertSame(orderItemPriceDetails, orderItemPriceDetails2);
    assertSame(orderItemQualifiers, orderItemQualifiers2);
    assertSame(proratedOrderItemAdjustments, proratedOrderItemAdjustments2);
   ...
   */
  @Test
  public void testFindAllChildrenToRemove4() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testGetCartOperationExceptionRootCause2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testGetCartOperationExceptionRootCause3() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
