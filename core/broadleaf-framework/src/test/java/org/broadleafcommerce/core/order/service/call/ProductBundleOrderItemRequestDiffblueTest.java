...
public class ProductBundleOrderItemRequestDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ProductBundleOrderItemRequest.<init>()",
    "Category ProductBundleOrderItemRequest.getCategory()",
    "Map ProductBundleOrderItemRequest.getItemAttributes()",
    "String ProductBundleOrderItemRequest.getName()",
    "Order ProductBundleOrderItemRequest.getOrder()",
    "ProductBundle ProductBundleOrderItemRequest.getProductBundle()",
    "int ProductBundleOrderItemRequest.getQuantity()",
    "Money ProductBundleOrderItemRequest.getRetailPriceOverride()",
    "Money ProductBundleOrderItemRequest.getSalePriceOverride()",
    "Sku ProductBundleOrderItemRequest.getSku()",
  ...
  public void testGettersAndSetters() {
    // Arrange and Act
    ProductBundleOrderItemRequest actualProductBundleOrderItemRequest =
        new ProductBundleOrderItemRequest();
    CategoryImpl category = new CategoryImpl();
    ProductBundleOrderItemRequest actualSetCategoryResult =
        actualProductBundleOrderItemRequest.setCategory(category);
    HashMap<String, String> itemAttributes = new HashMap<>();
    ProductBundleOrderItemRequest actualSetItemAttributesResult =
        actualProductBundleOrderItemRequest.setItemAttributes(itemAttributes);
    ProductBundleOrderItemRequest actualSetNameResult =
        actualProductBundleOrderItemRequest.setName("Name");
    NullOrderImpl order = new NullOrderImpl();
    ProductBundleOrderItemRequest actualSetOrderResult =
        actualProductBundleOrderItemRequest.setOrder(order);
    ProductBundleImpl productBundle = new ProductBundleImpl();
    ProductBundleOrderItemRequest actualSetProductBundleResult =
        actualProductBundleOrderItemRequest.setProductBundle(productBundle);
    ProductBundleOrderItemRequest actualSetQuantityResult =
        actualProductBundleOrderItemRequest.setQuantity(1);
    ...
    ProductBundleOrderItemRequest actualSetSkuResult =
        actualProductBundleOrderItemRequest.setSku(sku);
    Category actualCategory = actualProductBundleOrderItemRequest.getCategory();
    Map<String, String> actualItemAttributes =
        actualProductBundleOrderItemRequest.getItemAttributes();
