...
public class MinQuantityNotFulfilledExceptionDiffblueTest {
  ...
  @MethodsUnderTest({"void MinQuantityNotFulfilledException.<init>(String)",
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link MinQuantityNotFulfilledException#MinQuantityNotFulfilledException(String, Throwable)}
   *   <li>{@link MinQuantityNotFulfilledException#setProductId(Long)}
   *   <li>{@link MinQuantityNotFulfilledException#getProductId()}
   * </ul>
   */
   ...
   * <p>
   * Method under test: {@link MinQuantityNotFulfilledException#MinQuantityNotFulfilledException(String, Long)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
