...
public class RequiredAttributeNotProvidedExceptionDiffblueTest {
   ...
   * RequiredAttributeNotProvidedException#RequiredAttributeNotProvidedException(String, String)}
   */
  @Test
  ...
  public void testNewRequiredAttributeNotProvidedException() {
    // Arrange and Act
    RequiredAttributeNotProvidedException actualRequiredAttributeNotProvidedException =
        new RequiredAttributeNotProvidedException("An error occurred", "Attribute Name");

    // Assert
    assertEquals(
        "An error occurred", actualRequiredAttributeNotProvidedException.getLocalizedMessage());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void RequiredAttributeNotProvidedException.<init>(String, String, Throwable)"
  })
  public void testNewRequiredAttributeNotProvidedException2() {
    ...
    // Act
    RequiredAttributeNotProvidedException actualRequiredAttributeNotProvidedException =
        new RequiredAttributeNotProvidedException("An error occurred", "Attribute Name", cause);
  ...
  /**
   * Test {@link
   * RequiredAttributeNotProvidedException#RequiredAttributeNotProvidedException(String)}.
   *
   * <ul>
  ...
  public void testNewRequiredAttributeNotProvidedException_thenReturnAttributeName() {
    // Arrange and Act
    RequiredAttributeNotProvidedException actualRequiredAttributeNotProvidedException =
        new RequiredAttributeNotProvidedException("Attribute Name");

    // Assert
    assertEquals("Attribute Name", actualRequiredAttributeNotProvidedException.getAttributeName());
    assertEquals(
        "The attribute Attribute Name was not provided",
   ...
   *
   * <ul>
   *   <li>Then return ProductId is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link
   * RequiredAttributeNotProvidedException#RequiredAttributeNotProvidedException(String, String,
  ...
  public void testNewRequiredAttributeNotProvidedException_thenReturnProductIdIs42() {
    // Arrange and Act
    RequiredAttributeNotProvidedException actualRequiredAttributeNotProvidedException =
        new RequiredAttributeNotProvidedException("An error occurred", "Attribute Name", "42");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String RequiredAttributeNotProvidedException.getAttributeName()",
  ...
  public void testGettersAndSetters() {
    // Arrange
    RequiredAttributeNotProvidedException requiredAttributeNotProvidedException =
        new RequiredAttributeNotProvidedException("Attribute Name");
