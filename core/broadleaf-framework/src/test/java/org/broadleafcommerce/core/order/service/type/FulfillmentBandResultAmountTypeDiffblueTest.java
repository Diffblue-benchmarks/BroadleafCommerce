...
public class FulfillmentBandResultAmountTypeDiffblueTest {
  @Autowired private FulfillmentBandResultAmountType fulfillmentBandResultAmountType;
   ...
   * FulfillmentBandResultAmountType#FulfillmentBandResultAmountType(String, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
