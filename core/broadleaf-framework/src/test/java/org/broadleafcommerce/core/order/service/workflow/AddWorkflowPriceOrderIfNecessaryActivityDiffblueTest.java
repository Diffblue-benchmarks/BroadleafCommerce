...
public class AddWorkflowPriceOrderIfNecessaryActivityDiffblueTest {
   ...
   */
  @Test
  public void testUpdateChildOrderItem2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
   ...
   */
  @Test
  public void testUpdateChildOrderItem3() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
  ...
  public void testCheckAndUpdateChildren() {
    ...
    List<OrderItem> childOrderItems2 = orderItem.getChildOrderItems();
    assertTrue(childOrderItems2.isEmpty());
    assertSame(childOrderItems, childOrderItems2);
   ...
   */
  @Test
  public void testCheckAndUpdateChildren2() {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
