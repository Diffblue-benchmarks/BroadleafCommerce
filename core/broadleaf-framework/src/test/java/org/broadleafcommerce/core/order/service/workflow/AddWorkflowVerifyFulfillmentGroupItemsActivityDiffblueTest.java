...
public class AddWorkflowVerifyFulfillmentGroupItemsActivityDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AddWorkflowVerifyFulfillmentGroupItemsActivity#execute(ProcessContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ProcessContext AddWorkflowVerifyFulfillmentGroupItemsActivity.execute(ProcessContext)"})
  public void testExecute() throws Exception {
    ...
    // Act
    ProcessContext<CartOperationRequest> actualExecuteResult = addWorkflowVerifyFulfillmentGroupItemsActivity
        .execute(context);
