...
public class CheckAddAvailabilityActivityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link BundleOrderItemImpl} {@link BundleOrderItemImpl#getQuantity()} return one.
   *   <li>Then calls {@link BundleOrderItemImpl#getQuantity()}.
   * </ul>
   *
   * <p>Method under test: {@link CheckAddAvailabilityActivity#execute(ProcessContext)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext CheckAddAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenBundleOrderItemImplGetQuantityReturnOne_thenCallsGetQuantity()
      throws Exception {
    // Arrange
    doNothing()
        .when(contextualInventoryService)
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext CheckAddAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenBundleOrderItemImplGetQuantityReturnOne_thenCallsGetQuantity2()
      throws Exception {
    // Arrange
    doNothing()
        .when(contextualInventoryService)
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext CheckAddAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenCatalogServiceFindSkuByIdReturnNull_thenCallsFindSkuById()
      throws Exception {
    // Arrange
    doNothing()
        .when(contextualInventoryService)
   ...
   *
   * <ul>
   *   <li>Given {@link CheckAddAvailabilityActivity} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link CheckAddAvailabilityActivity#execute(ProcessContext)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext CheckAddAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenCheckAddAvailabilityActivity() throws Exception {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext CheckAddAvailabilityActivity.execute(ProcessContext)"})
  public void testExecute_givenOrderItemImplAuditableIsAuditable_thenCallsGetQuantity()
      throws Exception {
    // Arrange
    doNothing()
        .when(contextualInventoryService)
