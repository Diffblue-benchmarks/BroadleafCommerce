...
public class CheckUpdateAvailabilityActivityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link CheckUpdateAvailabilityActivity} (default constructor).
   * </ul>
   *
  ...
  public void testExecute_givenCheckUpdateAvailabilityActivity() throws Exception {
    // Arrange
    CheckUpdateAvailabilityActivity checkUpdateAvailabilityActivity =
        new CheckUpdateAvailabilityActivity();
