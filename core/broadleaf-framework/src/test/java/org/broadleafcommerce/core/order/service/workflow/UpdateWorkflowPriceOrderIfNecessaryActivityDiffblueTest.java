...
public class UpdateWorkflowPriceOrderIfNecessaryActivityDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UpdateWorkflowPriceOrderIfNecessaryActivity#execute(ProcessContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ProcessContext UpdateWorkflowPriceOrderIfNecessaryActivity.execute(ProcessContext)"})
  public void testExecute_givenAuditableCreatedByIsOne_thenCallsGetDiscreteOrderItems() throws Exception {
    ...
    // Act
    ProcessContext<CartOperationRequest> actualExecuteResult = updateWorkflowPriceOrderIfNecessaryActivity
        .execute(context);
