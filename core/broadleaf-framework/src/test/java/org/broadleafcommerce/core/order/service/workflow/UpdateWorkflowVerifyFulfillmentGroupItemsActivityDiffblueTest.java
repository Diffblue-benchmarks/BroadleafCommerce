...
public class UpdateWorkflowVerifyFulfillmentGroupItemsActivityDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UpdateWorkflowVerifyFulfillmentGroupItemsActivity#execute(ProcessContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ProcessContext UpdateWorkflowVerifyFulfillmentGroupItemsActivity.execute(ProcessContext)"})
  public void testExecute() throws Exception {
    ...
    // Act
    ProcessContext<CartOperationRequest> actualExecuteResult = updateWorkflowVerifyFulfillmentGroupItemsActivity
        .execute(context);
