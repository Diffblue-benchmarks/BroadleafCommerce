...
public class AddFulfillmentGroupItemActivityDiffblueTest {
  @InjectMocks
  private AddFulfillmentGroupItemActivity addFulfillmentGroupItemActivity;
   ...
   * <p>
   * Method under test: {@link AddFulfillmentGroupItemActivity#execute(ProcessContext)}
   */
  @Test
  ...
  public void testExecute() throws Exception {
    ...
    // Act
    ProcessContext<CartOperationRequest> actualExecuteResult = addFulfillmentGroupItemActivity.execute(context);
