...
public class RemoveOrderItemActivityDiffblueTest {
  @InjectMocks private RemoveOrderItemActivity removeOrderItemActivity;
  ...
  public void testExecute_givenAuditableCreatedByIsOne_thenReturnSeedDataOisToDeleteSizeIsFour()
      throws Exception {
    // Arrange
  ...
  public void testRemoveItemAndChildren_thenArrayListSizeIsFour() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void RemoveOrderItemActivity.removeItemAndChildren(List, OrderItem)"})
  public void testRemoveItemAndChildren_thenArrayListSizeIsTwo() {
    // Arrange
    ArrayList<OrderItem> oisToDelete = new ArrayList<>();
