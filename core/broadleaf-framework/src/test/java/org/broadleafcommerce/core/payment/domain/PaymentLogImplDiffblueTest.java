...
public class PaymentLogImplDiffblueTest {
   ...
   *
   * <p>Method under test: {@link PaymentLogImpl#getTransactionType()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"PaymentTransactionType PaymentLogImpl.getTransactionType()"})
  public void testGetTransactionType() {
    // Arrange, Act and Assert
    assertNull(paymentLogImpl.getTransactionType());
  }
   ...
   *
   * <ul>
   *   <li>Then {@link PaymentLogImpl} {@link PaymentLogImpl#transactionType} is {@code null}.
   * </ul>
   *
  ...
  public void testSetTransactionType_thenPaymentLogImplTransactionTypeIsNull() {
    // Arrange and Act
    paymentLogImpl.setTransactionType(new PaymentTransactionType());

    // Assert that nothing has changed
    assertNull(paymentLogImpl.transactionType);
  }
   ...
   *
   * <ul>
   *   <li>When {@link PaymentLogEventType#PaymentLogEventType()}.
   *   <li>Then {@link PaymentLogImpl} {@link PaymentLogImpl#logType} is {@code null}.
   * </ul>
   *
  ...
  public void testSetLogType_whenPaymentLogEventType_thenPaymentLogImplLogTypeIsNull() {
    // Arrange and Act
    paymentLogImpl.setLogType(new PaymentLogEventType());

    // Assert that nothing has changed
    assertNull(paymentLogImpl.logType);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Money PaymentLogImpl.getAmountPaid()"})
  public void testGetAmountPaid_thenReturnCurrencyDisplayNameIsBritishPoundSterling() {
    // Arrange
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    paymentLogImpl2.setLogType(new PaymentLogEventType());
    ...
    paymentLogImpl2.setTransactionTimestamp(
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant()));
    paymentLogImpl2.setTransactionType(new PaymentTransactionType());
