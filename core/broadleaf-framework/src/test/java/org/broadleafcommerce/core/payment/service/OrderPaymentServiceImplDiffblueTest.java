...
public class OrderPaymentServiceImplDiffblueTest {
  ...
  public void testCreateOrderPaymentFromCustomerPayment() {
    ...
    when(customerPayment.getPaymentGatewayType()).thenReturn(new PaymentGatewayType());
  ...
  public void testCreateOrderPaymentFromCustomerPayment_givenCustomerImpl() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    OrderPaymentImpl orderPaymentImpl = new OrderPaymentImpl();
    when(orderPaymentDao.save(Mockito.<OrderPayment>any())).thenReturn(orderPaymentImpl);
    ...
    customerPayment.setPaymentGatewayType(new PaymentGatewayType());
    customerPayment.setPaymentToken("ABC123");
    customerPayment.setPaymentType(new PaymentType("Type", "Friendly Type"));
    customerPayment.setAdditionalFields(new HashMap<>());
   ...
   *
   * <ul>
   *   <li>Given {@link PaymentType#PaymentType()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderPaymentServiceImpl#createOrderPaymentFromCustomerPayment(Order, CustomerPayment, Money)}
  ...
  public void testCreateOrderPaymentFromCustomerPayment_givenPaymentType() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    OrderPaymentImpl orderPaymentImpl = new OrderPaymentImpl();
    when(orderPaymentDao.save(Mockito.<OrderPayment>any())).thenReturn(orderPaymentImpl);
    ...
    when(customerPayment.getAdditionalFields()).thenReturn(new HashMap<>());
    when(customerPayment.getPaymentGatewayType()).thenReturn(new PaymentGatewayType());
    when(customerPayment.getPaymentType()).thenReturn(new PaymentType());
    when(customerPayment.getBillingAddress()).thenReturn(new AddressImpl());
   ...
   *
   * <ul>
   *   <li>Then calls {@link OrderPayment#getTransactions()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * OrderPaymentServiceImpl#createOrderPaymentFromCustomerPayment(Order, CustomerPayment, Money)}
  ...
  public void testCreateOrderPaymentFromCustomerPayment_thenCallsGetTransactions() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
  ...
  public void testCreateOrderPaymentFromCustomerPayment_whenCustomerPaymentImpl() {
    // Arrange
    when(addressService.copyAddress(Mockito.<Address>any())).thenReturn(new AddressImpl());
    OrderPaymentImpl orderPaymentImpl = new OrderPaymentImpl();
    when(orderPaymentDao.save(Mockito.<OrderPayment>any())).thenReturn(orderPaymentImpl);
