...
public class OrderToPaymentRequestDTOServiceImplDiffblueTest {
  ...
  public void testTranslateOrder_whenNullOrderImpl_thenReturnNull() {
    // Arrange
    OrderToPaymentRequestDTOServiceImpl orderToPaymentRequestDTOServiceImpl =
        new OrderToPaymentRequestDTOServiceImpl();
  ...
  public void testRefreshTransaction_thenReturnPaymentTransactionImpl() {
    ...
    paymentTransactionImpl.setType(new PaymentTransactionType());
    when(postLoaderDao.find(eq(PaymentTransactionImpl.class), Mockito.<Object>any()))
   ...
   *
   * <ul>
   *   <li>When {@link Order} {@link Order#getSubTotal()} return {@link Money#Money()}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testPopulateDefaultLineItemsAndSubtotal_whenOrderGetSubTotalReturnMoney() {
    // Arrange
    OrderToPaymentRequestDTOServiceImpl orderToPaymentRequestDTOServiceImpl =
        new OrderToPaymentRequestDTOServiceImpl();
    ...
    // Assert
    verify(requestDTO).orderSubtotal("0.00");
    verify(order, atLeast(1)).getSubTotal();
  }
  ...
  public void testPopulateDefaultLineItemsAndSubtotal_whenOrderImpl_thenCallsOrderSubtotal() {
    // Arrange
    OrderToPaymentRequestDTOServiceImpl orderToPaymentRequestDTOServiceImpl =
        new OrderToPaymentRequestDTOServiceImpl();
    OrderImpl order = new OrderImpl();
