...
public class SecureOrderPaymentServiceImplDiffblueTest {
  ...
  public void testCreate_thenCallsCreateCreditCardPayment() {
    ...
    PaymentType paymentType = new PaymentType("Type", "Type", true, true);
   ...
   *
   * <ul>
   *   <li>When {@link PaymentType#BANK_ACCOUNT}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Referenced SecureOrderPaymentServiceImpl.create(PaymentType)"})
  public void testCreate_whenBank_account_thenCallsCreateBankAccountPayment() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>When {@link PaymentType#PaymentType(String, String)} with type is {@code BANK_ACCOUNT}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Referenced SecureOrderPaymentServiceImpl.create(PaymentType)"})
  public void testCreate_whenPaymentTypeWithTypeIsBankAccountAndFriendlyType() {
    // Arrange
    when(secureOrderPaymentDao.createBankAccountPayment())
        .thenReturn(mock(BankAccountPayment.class));
  ...
  public void testFindSecurePaymentInfo_givenFalse_thenCallsIsCreditCardType()
  ...
  public void testFindSecurePaymentInfo_whenPaymentTypeWithTypeAndFriendlyType_thenReturnNull()
    ...
    // Arrange and Act
    Referenced actualFindSecurePaymentInfoResult =
        secureOrderPaymentServiceImpl.findSecurePaymentInfo(
            "42", new PaymentType("Type", "Friendly Type"));
  ...
  public void testFindAndRemoveSecurePaymentInfo_givenFalse_thenCallsIsCreditCardType()
      throws WorkflowException {
    // Arrange
    PaymentType paymentType = mock(PaymentType.class);
    when(paymentType.isCreditCardType()).thenReturn(false);
