...
public class TaxServiceImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TaxServiceImpl} TaxProviders is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link TaxServiceImpl#calculateTaxForOrder(Order)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Order TaxServiceImpl.calculateTaxForOrder(Order)"})
  public void testCalculateTaxForOrder_givenTaxServiceImplTaxProvidersIsArrayList()
      throws TaxException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(
            Mockito.<ModuleConfigurationType>any()))
   ...
   *
   * <ul>
   *   <li>Given {@link TaxServiceImpl} TaxProviders is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link TaxServiceImpl#calculateTaxForOrder(Order)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Order TaxServiceImpl.calculateTaxForOrder(Order)"})
  public void testCalculateTaxForOrder_givenTaxServiceImplTaxProvidersIsNull() throws TaxException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(
            Mockito.<ModuleConfigurationType>any()))
        .thenReturn(new ArrayList<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Order TaxServiceImpl.commitTaxForOrder(Order)"})
  public void testCommitTaxForOrder_givenTaxServiceImplTaxProvidersIsArrayList()
      throws TaxException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(
            Mockito.<ModuleConfigurationType>any()))
    ...
    ArrayList<TaxProvider> providers = new ArrayList<>();
    providers.add(new SimpleTaxProvider());
    taxServiceImpl.setTaxProviders(providers);
    taxServiceImpl.setMustCalculate(true);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Order TaxServiceImpl.commitTaxForOrder(Order)"})
  public void testCommitTaxForOrder_givenTaxServiceImplTaxProvidersIsNull() throws TaxException {
    // Arrange
    ArrayList<ModuleConfiguration> moduleConfigurationList = new ArrayList<>();
    moduleConfigurationList.add(new SiteMapConfigurationImpl());
    when(moduleConfigurationService.findActiveConfigurationsByType(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TaxServiceImpl.cancelTax(Order)"})
  public void testCancelTax_givenTaxServiceImplTaxProvidersIsArrayList_thenThrowTaxException()
      throws TaxException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(
            Mockito.<ModuleConfigurationType>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TaxServiceImpl.cancelTax(Order)"})
  public void testCancelTax_givenTaxServiceImplTaxProvidersIsNull() throws TaxException {
    // Arrange
    ArrayList<ModuleConfiguration> moduleConfigurationList = new ArrayList<>();
    moduleConfigurationList.add(new SiteMapConfigurationImpl());
    when(moduleConfigurationService.findActiveConfigurationsByType(
