...
public class FulfillmentGroupMerchandiseTotalActivityDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FulfillmentGroupMerchandiseTotalActivity#execute(ProcessContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ProcessContext FulfillmentGroupMerchandiseTotalActivity.execute(ProcessContext)"})
