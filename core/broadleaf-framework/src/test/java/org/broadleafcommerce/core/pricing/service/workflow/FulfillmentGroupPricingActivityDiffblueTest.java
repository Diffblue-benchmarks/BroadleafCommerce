...
public class FulfillmentGroupPricingActivityDiffblueTest {
  ...
  public void testExecute5() throws Exception {
    ...
    FulfillmentGroupImpl fulfillmentGroupImpl = mock(FulfillmentGroupImpl.class);
    when(fulfillmentGroupImpl.getFulfillmentPrice()).thenReturn(new Money());
    FulfillmentPricingService fulfillmentPricingService = mock(FulfillmentPricingService.class);
    ...
    FulfillmentGroupPricingActivity fulfillmentGroupPricingActivity = new FulfillmentGroupPricingActivity();
    fulfillmentGroupPricingActivity.setFulfillmentPricingService(fulfillmentPricingService);
    FulfillmentGroupImpl fulfillmentGroupImpl2 = mock(FulfillmentGroupImpl.class);
    when(fulfillmentGroupImpl2.getFulfillmentPrice()).thenReturn(mock(Money.class));

    ArrayList<FulfillmentGroup> fulfillmentGroupList = new ArrayList<>();
    fulfillmentGroupList.add(new FulfillmentGroupImpl());
    fulfillmentGroupList.add(fulfillmentGroupImpl2);
