...
public class FulfillmentGroupPricingActivityDiffblueTest {
  ...
  public void testExecute_givenArrayListAddNull_thenReturnDefaultProcessContextImpl()
      throws Exception {
    // Arrange
    FulfillmentGroupPricingActivity fulfillmentGroupPricingActivity =
        new FulfillmentGroupPricingActivity();
   ...
   *
   * <ul>
   *   <li>Given {@link FulfillmentGroupImpl} {@link FulfillmentGroupImpl#getFulfillmentPrice()}
   *       return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link FulfillmentGroupPricingActivity#execute(ProcessContext)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext FulfillmentGroupPricingActivity.execute(ProcessContext)"})
  public void testExecute_givenFulfillmentGroupImplGetFulfillmentPriceReturnNull()
      throws Exception {
    // Arrange
    FulfillmentGroupPricingActivity fulfillmentGroupPricingActivity =
        new FulfillmentGroupPricingActivity();
   ...
   *
   * <ul>
   *   <li>Then calls {@link FulfillmentGroupImpl#getFulfillmentPrice()}.
   * </ul>
   *
   * <p>Method under test: {@link FulfillmentGroupPricingActivity#execute(ProcessContext)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ProcessContext FulfillmentGroupPricingActivity.execute(ProcessContext)"})
  public void testExecute_thenCallsGetFulfillmentPrice() throws Exception {
    // Arrange
    FulfillmentGroupPricingActivity fulfillmentGroupPricingActivity =
        new FulfillmentGroupPricingActivity();
