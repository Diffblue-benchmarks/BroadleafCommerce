...
public class FulfillmentItemPricingActivityDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Money} {@link Money#lessThan(Money)} return {@code true}.
   *   <li>Then calls {@link Money#lessThan(Money)}.
   * </ul>
   *
   * <p>Method under test: {@link FulfillmentItemPricingActivity#getOrderSavingsToDistribute(Order)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Money FulfillmentItemPricingActivity.getOrderSavingsToDistribute(Order)"})
  public void testGetOrderSavingsToDistribute_givenMoneyLessThanReturnTrue_thenCallsLessThan() {
    // Arrange
    FulfillmentItemPricingActivity fulfillmentItemPricingActivity =
        new FulfillmentItemPricingActivity();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Money FulfillmentItemPricingActivity.getOrderSavingsToDistribute(Order)"})
  public void testGetOrderSavingsToDistribute_thenReturnCurrencyDisplayNameIsBritishPound() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Money FulfillmentItemPricingActivity.getOrderSavingsToDistribute(Order)"})
  public void testGetOrderSavingsToDistribute_thenReturnCurrencyDisplayNameIsBritishPound2() {
    // Arrange
    Auditable auditable = new Auditable();
    auditable.setCreatedBy(1L);
    auditable.setDateCreated(
   ...
   *
   * <ul>
   *   <li>When {@link Order} {@link Order#getOrderAdjustmentsValue()} return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link FulfillmentItemPricingActivity#getOrderSavingsToDistribute(Order)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Money FulfillmentItemPricingActivity.getOrderSavingsToDistribute(Order)"})
  public void testGetOrderSavingsToDistribute_whenOrderGetOrderAdjustmentsValueReturnNull() {
    // Arrange
    FulfillmentItemPricingActivity fulfillmentItemPricingActivity =
        new FulfillmentItemPricingActivity();
    ...
    assertEquals(Money.ZERO, actualOrderSavingsToDistribute);
  }
  ...
  public void testExecute_givenArrayListAddFulfillmentGroupImpl() throws Exception {
    // Arrange
  ...
  public void testDistributeOrderSavingsToItems_thenReturnCurrencyDisplayNameIsBritishPound() {
    // Arrange
    BroadleafCurrency currency = mock(BroadleafCurrency.class);
    when(currency.getCurrencyCode()).thenReturn("GBP");
