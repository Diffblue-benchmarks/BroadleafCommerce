...
public class PromotionMessagePlacementTypeDiffblueTest {
  ...
  @MethodsUnderTest({"void PromotionMessagePlacementType.<init>()",
      "String PromotionMessagePlacementType.getFriendlyType()", "int PromotionMessagePlacementType.getOrder()",
      "String PromotionMessagePlacementType.getType()", "void PromotionMessagePlacementType.setOrder(int)"})
   ...
   * <p>
   * Method under test: {@link PromotionMessagePlacementType#PromotionMessagePlacementType(String, String, int)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   *   <li>Then {@link PromotionMessagePlacementType#BROWSE} Type is {@code TypeType}.</li>
   * </ul>
   * <p>
   ...
   *   <li>Then {@link PromotionMessagePlacementType#BROWSE} Type is {@code Type}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PromotionMessagePlacementType#setType(String)}
   */
  ...
  /**
   * Test {@link PromotionMessagePlacementType#equals(Object)}, and {@link PromotionMessagePlacementType#hashCode()}.
   * <ul>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean PromotionMessagePlacementType.equals(Object)",
  ...
  /**
   * Test {@link PromotionMessagePlacementType#compareTo(PromotionMessagePlacementType)} with {@code PromotionMessagePlacementType}.
   * <ul>
   *   <li>When {@link PromotionMessagePlacementType#BROWSE}.</li>
   *   <li>Then return zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link PromotionMessagePlacementType#compareTo(PromotionMessagePlacementType)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
