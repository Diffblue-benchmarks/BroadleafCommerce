...
public class FieldImplDiffblueTest {
  ...
  @MethodsUnderTest({"String FieldImpl.getQualifiedFieldName()"})
  public void testGetQualifiedFieldName_thenReturnCategoryPropertyName() {
    ...
    // Act and Assert
    assertEquals("Category.Property Name", fieldImpl2.getQualifiedFieldName());
  }
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"FieldEntity FieldImpl.getEntityType()"})
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void FieldImpl.<init>()", "String FieldImpl.getAbbreviation()", "Long FieldImpl.getId()",
      "String FieldImpl.getPropertyName()", "void FieldImpl.setAbbreviation(String)",
      "void FieldImpl.setFriendlyName(String)", "void FieldImpl.setId(Long)", "void FieldImpl.setPropertyName(String)",
      "void FieldImpl.setTranslatable(Boolean)"})
