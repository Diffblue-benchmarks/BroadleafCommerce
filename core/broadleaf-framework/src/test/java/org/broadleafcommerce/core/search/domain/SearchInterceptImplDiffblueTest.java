...
public class SearchInterceptImplDiffblueTest {
  ...
  @MethodsUnderTest({"void SearchInterceptImpl.<init>()", "Long SearchInterceptImpl.getId()",
      "String SearchInterceptImpl.getRedirect()", "String SearchInterceptImpl.getTerm()",
      "void SearchInterceptImpl.setId(Long)", "void SearchInterceptImpl.setRedirect(String)",
