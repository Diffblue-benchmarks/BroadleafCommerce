...
public class SearchRedirectServiceImplDiffblueTest {
  ...
  @InjectMocks
  private SearchRedirectServiceImpl searchRedirectServiceImpl;
   ...
   * </ul>
   * <p>
   * Method under test: {@link SearchRedirectServiceImpl#findSearchRedirectBySearchTerm(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"SearchRedirect SearchRedirectServiceImpl.findSearchRedirectBySearchTerm(String)"})
  public void testFindSearchRedirectBySearchTerm_thenReturnNull() {
    ...
    // Act
    SearchRedirect actualFindSearchRedirectBySearchTermResult = searchRedirectServiceImpl
        .findSearchRedirectBySearchTerm("Uri");

    // Assert
    verify(searchRedirectDao).findSearchRedirectBySearchTerm(eq("Uri"));
   ...
   * Test {@link SearchRedirectServiceImpl#findSearchRedirectBySearchTerm(String)}.
   * <ul>
   *   <li>Then return {@link SearchRedirectImpl} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link SearchRedirectServiceImpl#findSearchRedirectBySearchTerm(String)}
   */
  ...
  public void testFindSearchRedirectBySearchTerm_thenReturnSearchRedirectImpl() {
    ...
    when(searchRedirectDao.findSearchRedirectBySearchTerm(Mockito.<String>any())).thenReturn(searchRedirectImpl);
