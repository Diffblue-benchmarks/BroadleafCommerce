...
public class AbstractSolrSearchServiceExtensionHandlerDiffblueTest {
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#filterSearchFacetRanges(SearchFacetDTO, List)}.
   * <ul>
   *   <li>Given {@link SearchFacetRangeImpl} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#filterSearchFacetRanges(SearchFacetDTO, List)}
   */
  @Test
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#modifySolrQuery(SearchContextDTO, SolrQuery, String, List, SearchCriteria, String)} with {@code context}, {@code query}, {@code qualifiedSolrQuery}, {@code facets}, {@code searchCriteria}, {@code defaultSort}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#modifySolrQuery(SearchContextDTO, SolrQuery, String, List, SearchCriteria, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#modifySolrQuery(SolrQuery, String, List, SearchCriteria, String)} with {@code query}, {@code qualifiedSolrQuery}, {@code facets}, {@code searchCriteria}, {@code defaultSort}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#modifySolrQuery(SolrQuery, String, List, SearchCriteria, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#getQueryField(SolrQuery, SearchCriteria, IndexFieldType, ExtensionResultHolder)}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getQueryField(SolrQuery, SearchCriteria, IndexFieldType, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#modifySearchResults(List, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   *   <li>When {@link ArrayList#ArrayList()} add {@link SolrDocument#SolrDocument()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#modifySearchResults(List, List)}
   */
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getSearchFacets(List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ExtensionResultStatusType AbstractSolrSearchServiceExtensionHandler.getSearchFacets(List)"})
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#attachFacet(SolrQuery, String, SearchFacetDTO)} with {@code query}, {@code indexField}, {@code dto}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#attachFacet(SolrQuery, String, SearchFacetDTO)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#attachFacet(SolrQuery, String, SearchFacetDTO, SearchCriteria)} with {@code query}, {@code indexField}, {@code dto}, {@code searchCriteria}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#attachFacet(SolrQuery, String, SearchFacetDTO, SearchCriteria)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#setFacetResults(Map, QueryResponse)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#buildActiveFacetFilter(FieldEntity, String, String[], List)} with {@code entityType}, {@code solrKey}, {@code selectedValues}, {@code valueStrings}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#buildActiveFacetFilter(FieldEntity, String, String[], List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#buildActiveFacetFilter(SearchFacet, String[], List)} with {@code facet}, {@code selectedValues}, {@code valueStrings}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#buildActiveFacetFilter(SearchFacet, String[], List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#addAdditionalCategoryIds(Category, SearchCriteria, List)}.
   * <ul>
   *   <li>Given one.</li>
   *   <li>When {@link ArrayList#ArrayList()} add one.</li>
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#addAdditionalCategoryIds(org.broadleafcommerce.core.catalog.domain.Category, SearchCriteria, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getCategorySearchFacets(org.broadleafcommerce.core.catalog.domain.Category, List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getSearchableIndexFields(List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getCategoryId(org.broadleafcommerce.core.catalog.domain.Category, Long[])}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#batchFetchCatalogData(List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"ExtensionResultStatusType AbstractSolrSearchServiceExtensionHandler.batchFetchCatalogData(List)"})
  ...
  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#attachSortField(SolrQuery, String, ORDER)}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#attachSortField(SolrQuery, String, SolrQuery.ORDER)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
  ...
  public void testAttachSortField() {
    ...
    // Act and Assert
    assertEquals(ExtensionResultStatusType.NOT_HANDLED, i18nSolrSearchServiceExtensionHandler
        .attachSortField(new SolrQuery("foo"), "Requested Sort Field Name", ORDER.desc));
  }

  /**
   * Test {@link AbstractSolrSearchServiceExtensionHandler#getPropertyNameForIndexField(IndexField, FieldType, String, ExtensionResultHolder)}.
   * <p>
   * Method under test: {@link AbstractSolrSearchServiceExtensionHandler#getPropertyNameForIndexField(IndexField, FieldType, String, ExtensionResultHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
