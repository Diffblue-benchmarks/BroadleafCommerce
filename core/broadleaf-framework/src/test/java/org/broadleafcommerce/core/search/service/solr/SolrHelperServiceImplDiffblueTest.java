...
public class SolrHelperServiceImplDiffblueTest {
  ...
  public void testGetPropertyNameForIndexFieldWithFieldFieldTypePrefix_thenReturnPrefixB() {
    // Arrange
    when(solrSearchServiceExtensionManager.getProxy())
        .thenReturn(new I18nSolrSearchServiceExtensionHandler());
    ...
    assertEquals("Prefix__b", actualPropertyNameForIndexField);
  }
  ...
  public void testGetCategoryIdWithLong_thenReturnLongValueIsOne() {
    ...
    when(genericEntityDao.readGenericEntity(eq(CategoryImpl.class), Mockito.<Object>any()))
  ...
  public void testGetCurrentProductId_givenDimensionContainerIsContainerShapeType() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    SkuImpl indexable = new SkuImpl();
    indexable.setActiveEndDate(
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant()));
    indexable.setActiveStartDate(
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant()));
    indexable.setAvailable(true);
    indexable.setCost(new Money());
    indexable.setCurrency(new BroadleafCurrencyImpl());
    indexable.setDefaultProduct(new ProductBundleImpl());
    indexable.setDescription("The characteristics of someone or something");
    indexable.setDimension(dimension);
    indexable.setDiscountable(true);
    indexable.setDisplayTemplate("Display Template");
    indexable.setExcludedFulfillmentOptions(new ArrayList<>());
    indexable.setExternalId("42");
    indexable.setFees(new ArrayList<>());
    indexable.setFulfillmentFlatRates(new HashMap<>());
    indexable.setFulfillmentType(FulfillmentType.DIGITAL);
    indexable.setId(1L);
    indexable.setInventoryType(InventoryType.ALWAYS_AVAILABLE);
    indexable.setIsMachineSortable(true);
    indexable.setListPrice(new Money());
    indexable.setLongDescription("Long Description");
    indexable.setMachineSortable(true);
    indexable.setName("Name");
    indexable.setProduct(new ProductBundleImpl());
    indexable.setProductOptionValueXrefs(new HashSet<>());
    indexable.setQuantityAvailable(1);
    indexable.setRetailPrice(new Money());
    indexable.setSalePrice(new Money());
    indexable.setSkuAttributes(new HashMap<>());
    indexable.setSkuMediaXref(new HashMap<>());
    indexable.setTaxCode("Tax Code");
    indexable.setTaxable(true);
    indexable.setUpc("Upc");
    indexable.setUrlKey("https://example.org/example");
    indexable.setWeight(weight);

    // Act and Assert
    assertNull(solrHelperServiceImpl.getCurrentProductId(indexable));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link SolrHelperServiceImpl} (default constructor).
  ...
  public void testGetProductForIndexable_givenSolrHelperServiceImpl_whenSkuImpl_thenReturnNull() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testGetDocumentType_givenSolrHelperServiceImpl_thenReturnProduct() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testGetPropertyValueWithObjectField_givenSolrHelperServiceImpl_thenReturnNull()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object SolrHelperServiceImpl.getPropertyValue(Object, Field)"})
  public void testGetPropertyValueWithObjectField_givenSolrHelperServiceImpl_thenReturnNull2()
      throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testGetPropertyValueWithObjectPropertyName_thenReturnNull()
      throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object SolrHelperServiceImpl.getPropertyValue(Object, String)"})
  public void testGetPropertyValueWithObjectPropertyName_thenReturnNull2()
      throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    // Arrange, Act and Assert
  ...
  public void testScrubFacetValue_whenFacetValue_thenReturnFacetValue18() {
    // Arrange, Act and Assert
    assertEquals(
        "Facet Value\\\\\\?", new SolrHelperServiceImpl().scrubFacetValue("Facet Value\\?"));
  }
   ...
   * <ul>
   *   <li>When {@code null}.
   *   <li>Then return {@code Field Name:[2.3 TO *]}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#getSolrRangeString(String, BigDecimal,
   * BigDecimal)}
  ...
  public void testGetSolrRangeString_whenNull_thenReturnFieldName23To() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    assertEquals(
        "Field Name:[2.3 TO *]",
        solrHelperServiceImpl.getSolrRangeString("Field Name", new BigDecimal("2.3"), null));
  }
   ...
   * <ul>
   *   <li>When {@code null}.
   *   <li>Then return {@code Field Name:[* TO 2.3]}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#getSolrRangeString(String, BigDecimal,
   * BigDecimal)}
  ...
  public void testGetSolrRangeString_whenNull_thenReturnFieldNameTo23() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    assertEquals(
        "Field Name:[* TO 2.3]",
        solrHelperServiceImpl.getSolrRangeString("Field Name", null, new BigDecimal("2.3")));
  }
  ...
  public void testGetSolrRangeFunctionString_thenReturnFrangeInclFalseL23() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testGetSolrFieldTag_givenOne_whenSpace_thenReturnEmptyString() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    // Act and Assert
    assertEquals("", solrHelperServiceImpl.getSolrFieldTag(" ", " ", range));
  }
  ...
  public void testGetSolrFieldTag_givenOne_whenSpace_thenReturnEmptyString2() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    // Act and Assert
    assertEquals("", solrHelperServiceImpl.getSolrFieldTag(null, " ", range));
  }
  ...
  public void testGetSolrFieldTag_givenSolrHelperServiceImpl_whenNull_thenReturnParamFieldName() {
    // Arrange, Act and Assert
    assertEquals(
        "{!Param=Field Name}",
        new SolrHelperServiceImpl().getSolrFieldTag("Field Name", "Param", null));
  }
  ...
  public void testGetSolrFieldTag_thenReturnExFieldNameParamFieldName23FrangeInclFalseL23() {
    ...
    assertEquals(
        "{!ex=Field Name Param=Field Name[2.3:*] frange incl=false l=2.3}", actualSolrFieldTag);
  }
   ...
   *
   * <ul>
   *   <li>When {@link SearchFacetRangeImpl}.
   *   <li>Then return empty string.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#getSolrFieldTag(String, String,
  ...
  public void testGetSolrFieldTag_whenSearchFacetRangeImpl_thenReturnEmptyString() {
    // Arrange, Act and Assert
    assertEquals(
        "",
        new SolrHelperServiceImpl()
            .getSolrFieldTag("Field Name", null, mock(SearchFacetRangeImpl.class)));
  }
  ...
  public void testBuildSolrFacetField_whenNull_thenReturnExFieldName() {
    // Arrange, Act and Assert
    assertEquals(
        "{!ex=Field Name}", new SolrHelperServiceImpl().buildSolrFacetField("Field Name", null));
  }
  ...
  public void testBuildSolrFacetField_whenSpace_thenReturnExFieldName() {
    // Arrange, Act and Assert
    assertEquals(
        "{!ex=Field Name}", new SolrHelperServiceImpl().buildSolrFacetField("Field Name", " "));
  }
   ...
   * <ul>
   *   <li>When {@code false}.
   *   <li>Then return {@code {Param=Field Name[2.3:*] frange incl=false l=2.3}}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#buildSolrFacetQuery(String,
   * SearchFacetRange, Boolean, String)}
  ...
  public void testBuildSolrFacetQuery_whenFalse_thenReturnParamFieldName23FrangeInclFalseL23() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    // Act and Assert
    assertEquals(
        "{Param=Field Name[2.3:*] frange incl=false l=2.3}",
        solrHelperServiceImpl.buildSolrFacetQuery("Field Name", range, false, "Param"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrHelperServiceImpl.setFacetResults(Map, QueryResponse)"})
  public void testSetFacetResults_givenArrayList_whenHashMap_thenCallsGetFacetFields() {
    // Arrange
    when(solrSearchServiceExtensionManager.getProxy())
        .thenReturn(new I18nSolrSearchServiceExtensionHandler());
    HashMap<String, SearchFacetDTO> namedFacetMap = new HashMap<>();
   ...
   *
   * <ul>
   *   <li>Given {@link SearchFacetDTO} (default constructor) Abbreviation is {@code 42}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrHelperServiceImpl.setFacetResults(Map, QueryResponse)"})
  public void testSetFacetResults_givenSearchFacetDTOAbbreviationIs42_thenHashMapSizeIsOne() {
    // Arrange
    when(solrSearchServiceExtensionManager.getProxy())
        .thenReturn(new I18nSolrSearchServiceExtensionHandler());

    SearchFacetDTO searchFacetDTO = new SearchFacetDTO();
    searchFacetDTO.setAbbreviation("42");
    ...
    HashMap<String, SearchFacetDTO> namedFacetMap = new HashMap<>();
    namedFacetMap.put("42", searchFacetDTO);
    ...
    when(facetField.getName()).thenReturn("42");
    ...
    assertSame(facetValues, namedFacetMap.get("42").getFacetValues());
  }
  ...
  public void testAttachFacetsWithQueryNamedFacetMapSearchCriteria_givenSolrHelperServiceImpl() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();

    SolrQuery query = mock(SolrQuery.class);
    when(query.setFacet(anyBoolean())).thenReturn(new SolrQuery());
    HashMap<String, SearchFacetDTO> namedFacetMap = new HashMap<>();
  ...
  public void testAttachFacetsWithQueryNamedFacetMapSearchCriteria_thenCallsAddFacetField() {
    ...
    SolrQuery query = mock(SolrQuery.class);
    when(query.addFacetField((String[]) Mockito.any())).thenReturn(new SolrQuery());
    when(query.setFacet(anyBoolean())).thenReturn(new SolrQuery());
  ...
  public void testAttachFacetsWithQueryNamedFacetMap_givenSolrHelperServiceImpl() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testGetSolrTaggedFieldString() {
    ...
    // Act
    String actualSolrTaggedFieldString =
  ...
  public void testGetSolrTaggedFieldString_givenOne_thenReturnField() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    // Act and Assert
    assertEquals("field( )", solrHelperServiceImpl.getSolrTaggedFieldString(" ", " ", range));
  }
   ...
   * <ul>
   *   <li>Given one.
   *   <li>Then return {@code field(null)}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#getSolrTaggedFieldString(String, String,
   * SearchFacetRange)}
  ...
  public void testGetSolrTaggedFieldString_givenOne_thenReturnFieldNull() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ...
    // Act and Assert
    assertEquals("field(null)", solrHelperServiceImpl.getSolrTaggedFieldString(null, " ", range));
  }
   ...
   * <ul>
   *   <li>When {@link SearchFacetRangeImpl}.
   *   <li>Then return {@code field(Index Field)}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#getSolrTaggedFieldString(String, String,
   * SearchFacetRange)}
  ...
  public void testGetSolrTaggedFieldString_whenSearchFacetRangeImpl_thenReturnFieldIndexField() {
    // Arrange, Act and Assert
    assertEquals(
        "field(Index Field)",
        new SolrHelperServiceImpl()
            .getSolrTaggedFieldString("Index Field", null, mock(SearchFacetRangeImpl.class)));
  }
  ...
  public void testGetSolrTaggedFieldString_whenSpace_thenReturnSpace() {
    // Arrange, Act and Assert
    assertEquals(" ", new SolrHelperServiceImpl().getSolrTaggedFieldString(" ", " ", null));
  }
  ...
  public void testGetSortableFieldTypes_givenSolrHelperServiceImpl_thenReturnSizeIsFive() {
    // Arrange and Act
   ...
   * <ul>
   *   <li>Given {@code desc}.
   *   <li>Then {@link SolrQuery#SolrQuery()} SortField is {@code , desc,Default asc}.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#attachSortClause(SolrQuery, SearchCriteria,
   * String)}
  ...
  public void testAttachSortClause_givenDesc_thenSolrQuerySortFieldIsDescDefaultAsc() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link SolrQuery#SolrQuery()}.
  ...
  public void testAttachSortClause_givenSolrQuery_thenCallsAddSort() {
    // Arrange
    when(indexFieldDao.getIndexFieldTypesByAbbreviation(Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
    when(solrSearchServiceExtensionManager.getProxy())
    ...
    SolrQuery query = mock(SolrQuery.class);
    when(query.addSort(Mockito.<SortClause>any())).thenReturn(new SolrQuery());
  ...
  public void testAttachSortClause_givenSolrQuery_thenCallsAddSort2() {
    // Arrange
    when(indexFieldDao.getIndexFieldTypesByAbbreviation(Mockito.<String>any()))
        .thenReturn(new ArrayList<>());
    when(solrSearchServiceExtensionManager.getProxy())
   ...
   *   <li>Then {@link SolrQuery#SolrQuery()} Sorts Empty.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#attachSortClause(SolrQuery, SearchCriteria,
   * String)}
  ...
  public void testAttachSortClause_givenSpace_whenEmptyString_thenSolrQuerySortsEmpty() {
    // Arrange
    SolrQuery query = new SolrQuery();
  ...
  public void testGetSortOrder_whenArrayOfStringWithSortFieldsSegmentsAndDesc_thenReturnDesc() {
    ...
    assertEquals(
        ORDER.desc,
        new SolrHelperServiceImpl()
            .getSortOrder(new String[] {"Sort Fields Segments", "desc"}, "Sort Query"));
  }
  ...
  public void testGetSortOrder_whenArrayOfStringWithSortFieldsSegments_thenReturnAsc() {
    ...
    assertEquals(
        ORDER.asc,
        new SolrHelperServiceImpl()
            .getSortOrder(new String[] {"Sort Fields Segments"}, "Sort Query"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Map SolrHelperServiceImpl.getSolrFieldKeyMap(SearchCriteria, List)"})
  public void testGetSolrFieldKeyMap_givenSolrHelperServiceImpl_whenArrayList_thenReturnEmpty() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    SearchCriteria searchCriteria = new SearchCriteria();
  ...
  public void testGetNamedFacetMap_givenSolrHelperServiceImpl_whenArrayList_thenReturnEmpty() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
  ...
  public void testAttachActiveFacetFilters_givenSolrHelperServiceImpl() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    SolrQuery query = new SolrQuery();
   ...
   *
   * <ul>
   *   <li>Then {@link SolrQuery#SolrQuery()} size is zero.
   * </ul>
   *
   * <p>Method under test: {@link SolrHelperServiceImpl#attachActiveFacetFilters(SolrQuery, Map,
   * SearchCriteria)}
  ...
  public void testAttachActiveFacetFilters_thenSolrQuerySizeIsZero() {
    // Arrange
    SolrQuery query = new SolrQuery();
    ...
    SearchCriteria searchCriteria = new SearchCriteria();
    searchCriteria.setFilterCriteria(null);
    ...
    assertFalse(query.getParameterNamesIterator().hasNext());
    assertFalse(copy.getParameterNamesIterator().hasNext());
    Stream<Entry<String, String[]>> streamResult = query.stream();
    assertTrue(streamResult.limit(5).collect(Collectors.toList()).isEmpty());
    Stream<Entry<String, String[]>> streamResult2 = copy.stream();
    assertTrue(streamResult2.limit(5).collect(Collectors.toList()).isEmpty());
    assertTrue(query.getMap().isEmpty());
    assertTrue(query.getParameterNames().isEmpty());
  }
  ...
  public void testGetPropertyValueInternal_givenSolrHelperServiceImpl_whenNull_thenReturnNull()
      throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    // Arrange, Act and Assert
    assertNull(
        new SolrHelperServiceImpl().getPropertyValueInternal(null, new String[] {"Components"}, 1));
  }
  ...
  public void testGetPropertyValueInternal_givenSolrHelperServiceImpl_whenZero_thenReturnNull()
      throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    // Arrange, Act and Assert
    assertNull(
        new SolrHelperServiceImpl()
            .getPropertyValueInternal("Object", new String[] {"Components"}, 0));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrHelperServiceImpl.copyPropertyToCollection(Collection, Object)"})
  public void testCopyPropertyToCollection_when42_thenArrayListSizeIsOne() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ArrayList<Object> collection = new ArrayList<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrHelperServiceImpl.copyPropertyToCollection(Collection, Object)"})
  public void testCopyPropertyToCollection_whenArrayList_thenArrayListEmpty() {
    // Arrange
    SolrHelperServiceImpl solrHelperServiceImpl = new SolrHelperServiceImpl();
    ArrayList<Object> collection = new ArrayList<>();

    // Act
    solrHelperServiceImpl.copyPropertyToCollection(collection, new ArrayList<>());
