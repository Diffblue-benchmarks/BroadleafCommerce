...
public class SolrHelperServiceImplDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"org.broadleafcommerce.common.locale.domain.Locale SolrHelperServiceImpl.getDefaultLocale()"})
  public void testGetDefaultLocale() {
    // Arrange, Act and Assert
    assertSame(solrHelperServiceImpl.defaultLocale, solrHelperServiceImpl.getDefaultLocale());
  }
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"org.broadleafcommerce.common.locale.domain.Locale SolrHelperServiceImpl.getDefaultLocale()"})
  public void testGetDefaultLocale2() {
    // Arrange, Act and Assert
    assertSame(solrHelperServiceImpl.defaultLocale, solrHelperServiceImpl.getDefaultLocale());
  }
  ...
  public void testGetSolrTaggedFieldString_whenSearchFacetRangeImpl_thenReturnField() {
    // Arrange, Act and Assert
    assertEquals("field( )", solrHelperServiceImpl.getSolrTaggedFieldString(" ", " ", new SearchFacetRangeImpl()));
  }
  ...
  public void testGetSolrTaggedFieldString_whenSpace_thenReturnIndexField() {
    // Arrange, Act and Assert
    assertEquals("Index Field", solrHelperServiceImpl.getSolrTaggedFieldString("Index Field", " ", null));
  }
  ...
  public void testGetSortableFieldTypes_givenEnvironment_thenReturnSizeIsOne() {
    // Arrange
   ...
   * Test {@link SolrHelperServiceImpl#getSortableFieldTypes()}.
   * <ul>
   *   <li>Given {@link SolrHelperServiceImpl} (default constructor).</li>
