...
public class SolrIndexServiceImplDiffblueTest {
  ...
  /**
   * Test {@link SolrIndexServiceImpl#deleteAllNamespaceDocuments(String, SolrClient)} with {@code
   * collection}, {@code server}.
   *
   * <p>Method under test: {@link SolrIndexServiceImpl#deleteAllNamespaceDocuments(String,
   * SolrClient)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testDeleteAllNamespaceDocumentsWithCollectionServer() throws ServiceException {
    // Arrange
    when(solrHelperService.getNamespaceFieldName()).thenThrow(new IllegalStateException());

    // Act and Assert
    assertThrows(
        ServiceException.class,
        () -> solrIndexServiceImpl.deleteAllNamespaceDocuments("Collection", null));
   ...
   *
   * <ul>
   *   <li>Then calls {@link SolrConfiguration#getNamespace()}.
   * </ul>
   *
   * <p>Method under test: {@link SolrIndexServiceImpl#deleteAllNamespaceDocuments(String,
   * SolrClient)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrIndexServiceImpl.deleteAllNamespaceDocuments(String, SolrClient)"})
  public void testDeleteAllNamespaceDocumentsWithCollectionServer_thenCallsGetNamespace()
      throws ServiceException {
    // Arrange
    when(solrHelperService.getNamespaceFieldName()).thenReturn("Namespace Field Name");
    when(solrConfiguration.getNamespace()).thenThrow(new IllegalStateException());
   ...
   *
   * <p>Method under test: {@link SolrIndexServiceImpl#deleteAllNamespaceDocuments(SolrClient)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testDeleteAllNamespaceDocumentsWithServer() throws ServiceException {
    ...
    // Act and Assert
    assertThrows(
        ServiceException.class, () -> solrIndexServiceImpl.deleteAllNamespaceDocuments(null));
    verify(solrHelperService).getNamespaceFieldName();
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SolrIndexServiceImpl.deleteAllNamespaceDocuments(SolrClient)"})
  public void testDeleteAllNamespaceDocumentsWithServer_thenCallsGetNamespace()
      throws ServiceException {
    //   Diffblue Cover was unable to create a Spring-specific test for this Spring method.
    //   Run dcover create --keep-partial-tests to gain insights into why
    //   a non-Spring test was created.
  ...
  public void testAttachIndexableDocumentFields_givenLocaleImpl_whenArrayListAddLocaleImpl() {
    ...
    assertThrows(
        IllegalStateException.class,
        () -> solrIndexServiceImpl.attachIndexableDocumentFields(null, indexable, fields, locales));
   ...
   *
   * <ul>
   *   <li>Given {@link SolrIndexServiceImpl} (default constructor).
   *   <li>Then does not throw.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testAttachIndexableDocumentFields_givenSolrIndexServiceImpl_thenDoesNotThrow() {
    // Arrange
    SolrIndexServiceImpl solrIndexServiceImpl = new SolrIndexServiceImpl();
    ProductBundleImpl indexable = new ProductBundleImpl();
    ArrayList<IndexField> fields = new ArrayList<>();
  ...
  public void testConvertToMappedProperty_whenBackslashDot_thenReturnEmptyString() {
    ...
    assertEquals(
        "",
        new SolrIndexServiceImpl()
            .convertToMappedProperty("\\.", "List Property Name", "Map Property Name"));
  }
  ...
  public void testConvertToMappedProperty_whenJavaLangLong_thenReturnJavaLangLong() {
    ...
    assertEquals(
        "java.lang.Long",
        new SolrIndexServiceImpl()
            .convertToMappedProperty("java.lang.Long", "List Property Name", "Map Property Name"));
  }
  ...
  public void testConvertToMappedProperty_whenJava_thenReturnMapPropertyNameLangValueLong() {
    ...
    assertEquals(
        ...
        new SolrIndexServiceImpl()
            .convertToMappedProperty("java.lang.Long", "java", "Map Property Name"));
  }
  ...
  public void testConvertToMappedProperty_whenPropertyName_thenReturnPropertyName() {
    ...
    assertEquals(
        "Property Name",
        new SolrIndexServiceImpl()
            .convertToMappedProperty("Property Name", "List Property Name", "Map Property Name"));
  }
  ...
  public void testOptimizeIndexWithCollectionServer() throws IOException, ServiceException {
    ...
    // Act
    solrIndexServiceImpl.optimizeIndex("Collection", null);

    // Assert
    verify(solrHelperService).optimizeIndex(eq("Collection"), isNull());
  }
  ...
  public void testOptimizeIndexWithCollectionServer_thenThrowIllegalStateException()
    ...
    // Act and Assert
    assertThrows(
        IllegalStateException.class, () -> solrIndexServiceImpl.optimizeIndex("Collection", null));
    verify(solrHelperService).optimizeIndex(eq("Collection"), isNull());
  }
  ...
  public void testOptimizeIndexWithServer_givenSolrHelperServiceOptimizeIndexDoesNothing()
    ...
    // Act
    solrIndexServiceImpl.optimizeIndex(null);

    // Assert
    verify(solrHelperService).optimizeIndex(isNull(), isNull());
  }
  ...
  public void testOptimizeIndexWithServer_thenThrowIllegalStateException()
    ...
    // Act and Assert
    assertThrows(IllegalStateException.class, () -> solrIndexServiceImpl.optimizeIndex(null));
    verify(solrHelperService).optimizeIndex(isNull(), isNull());
  }
