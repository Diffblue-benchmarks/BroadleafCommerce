...
public class AbstractSolrIndexUpdateCommandHandlerImplDiffblueTest {
  ...
  public void testExecuteCommandInternalWithCommand2() throws ServiceException {
    // Arrange
    when(solrConfiguration.getPrimaryName()).thenReturn("Primary Name");
    IncrementalUpdateCommand command = new IncrementalUpdateCommand(null, new ArrayList<>());
  ...
  public void testExecuteCommandInternalWithCommand3() throws ServiceException {
    // Arrange
    when(solrConfiguration.getPrimaryName()).thenReturn("Primary Name");
    IncrementalUpdateCommand command = new IncrementalUpdateCommand(new ArrayList<>(), null);
