...
public class IncrementalUpdateCommandDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link IncrementalUpdateCommand#IncrementalUpdateCommand(List, List)} with docs is
   *       {@code null} and deleteQueries is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link IncrementalUpdateCommand#toString()}
   */
  ...
  public void testToString_givenIncrementalUpdateCommandWithDocsIsNullAndDeleteQueriesIsNull() {
    // Arrange
    IncrementalUpdateCommand incrementalUpdateCommand = new IncrementalUpdateCommand(null, null);
