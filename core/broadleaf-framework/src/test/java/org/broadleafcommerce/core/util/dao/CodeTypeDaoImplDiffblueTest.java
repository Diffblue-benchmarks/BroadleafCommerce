...
public class CodeTypeDaoImplDiffblueTest {
  @InjectMocks
  private CodeTypeDaoImpl codeTypeDaoImpl;
   ...
   * <p>
   * Method under test: {@link CodeTypeDaoImpl#create()}
   */
  @Test
  ...
  public void testCreate() {
    ...
    // Assert
    verify(entityConfiguration).createEntityInstance(eq("org.broadleafcommerce.core.util.domain.CodeType"));
