...
public class DeleteStatementGeneratorImplDiffblueTest {
   ...
   */
  @Test
  public void testOperationStackHolderGettersAndSetters() {
    // Arrange
    Stack<DeleteStatementGeneratorImpl.PathElement> stack = new Stack<>();
   ...
   */
  @Test
  public void testOperationStackHolderGettersAndSetters2() {
    // Arrange
    Stack<DeleteStatementGeneratorImpl.PathElement> stack = new Stack<>();
   ...
   */
  @Test
  public void testOperationStackHolderGettersAndSetters3() {
    // Arrange
    Stack<DeleteStatementGeneratorImpl.PathElement> stack = new Stack<>();
   ...
   */
  @Test
  public void testOperationStackHolderGettersAndSetters4() {
    // Arrange
    Stack<DeleteStatementGeneratorImpl.PathElement> stack = new Stack<>();
   ...
   */
  @Test
  public void testOperationStackHolderGettersAndSetters5() {
    // Arrange
    Stack<DeleteStatementGeneratorImpl.PathElement> stack = new Stack<>();
   ...
   */
  @Test
  public void testPathElementGettersAndSetters2() {
    // Arrange and Act
    DeleteStatementGeneratorImpl.PathElement actualPathElement = new DeleteStatementGeneratorImpl.PathElement("Name",
