...
public class ResourcePurgeServiceImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ResourcePurgeServiceImpl} (default constructor).
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.purgeCarts(Map)"})
  public void testPurgeCarts_givenResourcePurgeServiceImpl_whenHashMap() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.purgeCarts(Map)"})
  public void testPurgeCarts_givenResourcePurgeServiceImpl_whenNull() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> new ResourcePurgeServiceImpl().purgeCarts(null));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.notifyCarts(Map)"})
  public void testNotifyCarts_givenResourcePurgeServiceImpl_whenHashMap() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.notifyCarts(Map)"})
  public void testNotifyCarts_givenResourcePurgeServiceImpl_whenNull() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> new ResourcePurgeServiceImpl().notifyCarts(null));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.purgeCustomers(Map)"})
  public void testPurgeCustomers_givenResourcePurgeServiceImpl_whenHashMap() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.purgeCustomers(Map)"})
  public void testPurgeCustomers_givenResourcePurgeServiceImpl_whenNull() {
    // Arrange, Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> new ResourcePurgeServiceImpl().purgeCustomers(null));
  }
  ...
  public void testGetCartsInErrorToIgnore_givenResourcePurgeServiceImpl_thenReturnEmpty() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
   ...
   *   <li>Given one.
   *   <li>When {@link ArrayList#ArrayList()} add one.
   *   <li>Then calls {@link CartPurgeParams#getBatchSize()}.
   * </ul>
   *
   * <p>Method under test: {@link ResourcePurgeServiceImpl#getCartsToPurgeLength(CartPurgeParams,
   * List)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.notifyCart(Order)"})
  public void testNotifyCart3() throws ServiceException {
    // Arrange
    doNothing().when(notificationDispatcher).dispatchNotification(Mockito.<Notification>any());
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerImpl} (default constructor) EmailAddress is {@code null}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.notifyCart(Order)"})
  public void testNotifyCart_givenCustomerImplEmailAddressIsNull_thenDoesNotThrow() {
    // Arrange
    Auditable auditable = new Auditable();
    auditable.setCreatedBy(1L);
    auditable.setDateCreated(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ResourcePurgeServiceImpl.notifyCart(Order)"})
  public void testNotifyCart_whenNullOrderImpl_thenDoesNotThrow() {
    // Arrange, Act and Assert
    resourcePurgeServiceImpl.notifyCart(new NullOrderImpl());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourcePurgeServiceImpl.getEmailForCart(Order)"})
  public void testGetEmailForCart_givenCustomerImplEmailAddressIsCart_thenReturnCart() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ResourcePurgeServiceImpl.getEmailForCart(Order)"})
  public void testGetEmailForCart_givenCustomerImplEmailAddressIsNull_thenReturnNull() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
  ...
  public void testGetCustomersInErrorToIgnore_givenResourcePurgeServiceImpl_thenReturnEmpty() {
    // Arrange
    ResourcePurgeServiceImpl resourcePurgeServiceImpl = new ResourcePurgeServiceImpl();
   ...
   *   <li>Given one.
   *   <li>When {@link ArrayList#ArrayList()} add one.
   *   <li>Then calls {@link CustomerPurgeParams#getBatchSize()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * ResourcePurgeServiceImpl#getCustomersToPurgeLength(CustomerPurgeParams, List)}
