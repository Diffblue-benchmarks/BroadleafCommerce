...
public class DefaultProcessContextImplDiffblueTest {
  ...
  @MethodsUnderTest({"void DefaultProcessContextImpl.<init>()", "List DefaultProcessContextImpl.getActivityMessages()",
      "Object DefaultProcessContextImpl.getSeedData()", "boolean DefaultProcessContextImpl.isStopped()",
      "void DefaultProcessContextImpl.setActivityMessages(List)", "void DefaultProcessContextImpl.setSeedData(Object)",
