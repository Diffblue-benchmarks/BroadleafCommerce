...
class PhoneFormatterImplDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test formatPhoneNumber(Phone)")
  ...
  void testFormatPhoneNumber() {
    ...
    //   public class DiffblueFakeClass2111 {
    //     @org.springframework.beans.factory.annotation.Autowired org.broadleafcommerce.profile.web.core.util.PhoneFormatterImpl phoneFormatterImpl;
    ...
    // Arrange
    PhoneFormatterImpl phoneFormatterImpl2 = new PhoneFormatterImpl();

    // Act
    phoneFormatterImpl2.formatPhoneNumber(new PhoneImpl());
  }
