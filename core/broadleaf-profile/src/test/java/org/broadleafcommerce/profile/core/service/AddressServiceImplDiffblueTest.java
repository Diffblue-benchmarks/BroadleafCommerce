...
public class AddressServiceImplDiffblueTest {
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenListIsEmptyReturnTrue_thenReturnFirstIsAddressImpl()
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_whenAddressImpl_thenFirstReturnAddressImpl2() throws AddressVerificationException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(Mockito.<ModuleConfigurationType>any()))
        .thenReturn(new ArrayList<>());
    when(list.isEmpty()).thenReturn(false);
  ...
  public void testPopulateAddressISOCountrySub() {
    ...
    address.setIsoCountrySubdivision(null);
    ...
    // Assert
    verify(countrySubdivisionService).findSubdivisionByCountryAndAltAbbreviation(isNull(), eq("42 Main St"));
  }
  ...
  public void testPopulateAddressISOCountrySub_thenCallsFindSubdivisionByCountryAndName() {
    ...
    // Assert
    verify(countrySubdivisionService).findSubdivisionByCountryAndAltAbbreviation(isNull(), eq("42 Main St"));
    verify(countrySubdivisionService).findSubdivisionByCountryAndName(isNull(), eq("42 Main St"));
  }
}
