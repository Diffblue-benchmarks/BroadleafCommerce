...
public class AddressServiceImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenAddressServiceImpl_whenAddressImpl_thenReturnSizeIsOne()
      throws AddressVerificationException {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenArrayListAddSiteMapConfigurationImpl_thenCallsIterator()
      throws AddressVerificationException {
    // Arrange
    ArrayList<ModuleConfiguration> moduleConfigurationList = new ArrayList<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenListIsEmptyReturnTrue_whenAddressImpl_thenCallsIsEmpty()
      throws AddressVerificationException {
    // Arrange
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link AddressImpl} (default constructor) Standardized is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link AddressServiceImpl#verifyAddress(Address)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenNull_whenAddressImplStandardizedIsNull()
      throws AddressVerificationException {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();
   ...
   * <ul>
   *   <li>Given {@code true}.
   *   <li>When {@link AddressImpl} (default constructor) Standardized is {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link AddressServiceImpl#verifyAddress(Address)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_givenTrue_whenAddressImplStandardizedIsTrue()
      throws AddressVerificationException {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AddressServiceImpl.verifyAddress(Address)"})
  public void testVerifyAddress_thenCallsFindActiveConfigurationsByType()
      throws AddressVerificationException {
    // Arrange
    when(moduleConfigurationService.findActiveConfigurationsByType(
            Mockito.<ModuleConfigurationType>any()))
  ...
  public void testCopyAddressWithDestOrig_givenAddressServiceImpl_whenNull_thenReturnNull() {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AddressServiceImpl.populateAddressISOCountrySub(Address)"})
  public void testPopulateAddressISOCountrySub_givenEmptyString_thenCallsGetIsoCountryAlpha2() {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();

    AddressImpl address = mock(AddressImpl.class);
    when(address.getIsoCountrySubdivision()).thenReturn("");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AddressServiceImpl.populateAddressISOCountrySub(Address)"})
  public void testPopulateAddressISOCountrySub_givenGb() {
    // Arrange
    AddressServiceImpl addressServiceImpl = new AddressServiceImpl();
