...
public class CustomerServiceImplDiffblueTest {
  ...
  public void testSaveCustomerWithCustomer5() {
    ...
    customer.setUnencodedPassword("Customer");
   ...
   *
   * <ul>
   *   <li>Then {@link CustomerImpl} (default constructor) Username is {@code 1}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#saveCustomer(Customer, boolean)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer, boolean)"})
  public void testSaveCustomerWithCustomerRegister_thenCustomerImplUsernameIs1() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>When {@link CustomerImpl} (default constructor) UnencodedPassword is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#saveCustomer(Customer, boolean)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer, boolean)"})
  public void testSaveCustomerWithCustomerRegister_whenCustomerImplUnencodedPasswordIsNull() {
    // Arrange
    when(passwordEncoder.encode(Mockito.<CharSequence>any()))
        .thenThrow(new IllegalArgumentException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer)"})
  public void testSaveCustomerWithCustomer_givenCustomerDaoReadCustomerByIdReturnCustomerImpl() {
    // Arrange
    when(customerDao.readCustomerById(Mockito.<Long>any())).thenReturn(new CustomerImpl());
    when(idGenerationService.findNextId(Mockito.<String>any())).thenReturn(1L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer)"})
  public void testSaveCustomerWithCustomer_givenCustomerDaoReadCustomerByIdReturnNull() {
    // Arrange
    when(customerDao.readCustomerById(Mockito.<Long>any())).thenReturn(null);
    when(customerDao.save(Mockito.<Customer>any())).thenThrow(new IllegalArgumentException());
    when(passwordEncoder.encode(Mockito.<CharSequence>any())).thenReturn("secret");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer)"})
  public void testSaveCustomerWithCustomer_givenCustomerServiceImpl_thenCallsGetId() {
    // Arrange
    CustomerServiceImpl customerServiceImpl = new CustomerServiceImpl();

    Customer customer = mock(Customer.class);
    when(customer.getUnencodedPassword()).thenThrow(new IllegalArgumentException());
    when(customer.isRegistered()).thenReturn(false);
    when(customer.getId()).thenReturn(1L);
    when(customer.getUsername()).thenReturn("janedoe");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.saveCustomer(Customer)"})
  public void testSaveCustomerWithCustomer_whenCustomerImplUnencodedPasswordIsNull() {
    // Arrange
    when(passwordEncoder.encode(Mockito.<CharSequence>any()))
        .thenThrow(new IllegalArgumentException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.registerCustomer(Customer, String, String)"})
  public void testRegisterCustomer_thenCustomerImplUsernameIs1() {
    // Arrange
    when(customerDao.readCustomerById(Mockito.<Long>any())).thenReturn(null);
    when(customerDao.save(Mockito.<Customer>any())).thenReturn(new CustomerImpl());
    doNothing()
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerDaoImpl} {@link CustomerDaoImpl#readCustomerById(Long)} return
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.changePassword(PasswordChange)"})
  public void testChangePassword_givenCustomerDaoImplReadCustomerByIdReturnCustomerImpl() {
    // Arrange
    CustomerImpl customerImpl = mock(CustomerImpl.class);
    when(customerImpl.isRegistered()).thenReturn(true);
    when(customerImpl.getId()).thenReturn(1L);
  ...
  public void testResetPassword() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> customerServiceImpl.resetPassword(new PasswordReset()));
    verify(customerDao).readCustomerByUsername(null);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.resetPassword(PasswordReset)"})
  public void testResetPassword_givenZero() {
    // Arrange
    CustomerImpl customerImpl = mock(CustomerImpl.class);
    when(customerImpl.getChallengeAnswer()).thenReturn("Challenge Answer");
    doNothing().when(customerImpl).setChallengeAnswer(Mockito.<String>any());
    ...
    passwordReset.setPasswordLength(0);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void CustomerServiceImpl.notifyPostRegisterListeners(Customer)"})
  public void testNotifyPostRegisterListeners_givenCustomerServiceImpl_thenDoesNotThrow() {
    // Arrange
    CustomerServiceImpl customerServiceImpl = new CustomerServiceImpl();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Customer CustomerServiceImpl.createCustomerFromId(Long)"})
  public void testCreateCustomerFromId_givenCustomerDaoImplReadCustomerByIdReturnCustomerImpl() {
    // Arrange
    CustomerDaoImpl customerDao = mock(CustomerDaoImpl.class);
    CustomerImpl customerImpl = new CustomerImpl();
   ...
   *
   * <ul>
   *   <li>Then calls {@link CustomerDaoImpl#create()}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#createCustomerFromId(Long)}
   */
   ...
   *
   * <ul>
   *   <li>Given {@link CustomerDaoImpl} {@link CustomerDaoImpl#detach(Customer)} does nothing.
   *   <li>Then calls {@link CustomerDaoImpl#detach(Customer)}.
   * </ul>
   *
  ...
  public void testCustomerPassesCustomerRule3() {
    ...
    assertFalse(
        customerServiceImpl.customerPassesCustomerRule(
            customer, new CustomerRuleHolder("getProductAttributes()[xx]")));
  }
  ...
  public void testCustomerPassesCustomerRule5() {
    ...
    assertFalse(
        customerServiceImpl.customerPassesCustomerRule(
            customer, new CustomerRuleHolder("customergetProductAttributes")));
  }
  ...
  public void testCustomerPassesCustomerRule6() {
    ...
    assertFalse(
        customerServiceImpl.customerPassesCustomerRule(
            customer,
            new CustomerRuleHolder("getProductAttributes()[xx]getAdditionalFields()[xx]")));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"GenericResponse CustomerServiceImpl.sendForgotUsernameNotification(String)"})
  public void testSendForgotUsernameNotification_givenCustomerServiceImpl_whenNull() {
    // Arrange and Act
    GenericResponse actualSendForgotUsernameNotificationResult =
        new CustomerServiceImpl().sendForgotUsernameNotification(null);
  ...
  public void testSendForgotPasswordNotification7() {
    // Arrange
    CustomerImpl customerImpl = new CustomerImpl();
    customerImpl.setEmailAddress("42 Main St");
    when(customerDao.readCustomerByUsername(Mockito.<String>any())).thenReturn(customerImpl);
  ...
  public void testSendForcedPasswordChangeNotification9() {
    // Arrange
    CustomerImpl customerImpl = new CustomerImpl();
    customerImpl.setEmailAddress("42 Main St");
    when(customerDao.readCustomerByUsername(Mockito.<String>any())).thenReturn(customerImpl);
  ...
  public void testCheckPasswordResetTokenWithTokenCustomer() {
    ...
    GenericResponse actualCheckPasswordResetTokenResult =
        customerServiceImpl.checkPasswordResetToken(null, new CustomerImpl());
  ...
  public void testCheckPasswordResetTokenWithTokenCustomer7() {
    // Arrange
    CustomerForgotPasswordSecurityToken customerForgotPasswordSecurityToken =
        mock(CustomerForgotPasswordSecurityToken.class);
    when(customerForgotPasswordSecurityToken.isTokenUsedFlag())
        .thenThrow(new IllegalArgumentException());
    when(customerForgotPasswordSecurityTokenDao.readToken(Mockito.<String>any()))
        .thenReturn(customerForgotPasswordSecurityToken);
    when(passwordEncoder.encode(Mockito.<CharSequence>any())).thenReturn("secret");
  ...
  public void testCheckPasswordResetTokenWithTokenCustomerResponse6() {
    // Arrange
    CustomerForgotPasswordSecurityToken customerForgotPasswordSecurityToken =
        mock(CustomerForgotPasswordSecurityToken.class);
    when(customerForgotPasswordSecurityToken.isTokenUsedFlag()).thenReturn(true);
    ...
    // Act
    customerServiceImpl.checkPasswordResetToken("ABC123", null, response);
  ...
  public void testCheckPasswordResetTokenWithTokenCustomerResponse7() {
    // Arrange
    CustomerForgotPasswordSecurityToken customerForgotPasswordSecurityToken =
        mock(CustomerForgotPasswordSecurityToken.class);
    when(customerForgotPasswordSecurityToken.isTokenUsedFlag())
  ...
  public void testCheckPasswordResetTokenWithTokenCustomerResponse8() {
    // Arrange
    GenericResponse response = new GenericResponse();

    // Act
    CustomerForgotPasswordSecurityToken actualCheckPasswordResetTokenResult =
        customerServiceImpl.checkPasswordResetToken(null, null, response);
   ...
   *
   * <ul>
   *   <li>Then calls {@link CustomerForgotPasswordSecurityToken#getCreateDate()}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#checkPasswordResetToken(String, Customer,
   * GenericResponse)}
   ...
   *
   * <ul>
   *   <li>Then calls {@link CustomerForgotPasswordSecurityToken#getToken()}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#checkPasswordResetToken(String, Customer,
   * GenericResponse)}
  ...
  public void testCheckPasswordResetTokenWithTokenCustomerResponse_thenCallsGetToken() {
    // Arrange
    CustomerForgotPasswordSecurityToken customerForgotPasswordSecurityToken =
        mock(CustomerForgotPasswordSecurityToken.class);
    when(customerForgotPasswordSecurityToken.isTokenUsedFlag()).thenReturn(true);
  ...
  public void testCheckPasswordResetTokenWithTokenCustomer_thenCallsGetToken() {
    // Arrange
    CustomerForgotPasswordSecurityToken customerForgotPasswordSecurityToken =
        mock(CustomerForgotPasswordSecurityToken.class);
    when(customerForgotPasswordSecurityToken.isTokenUsedFlag()).thenReturn(true);
  ...
  public void testCheckPasswordResetTokenWithTokenCustomer_whenSpace() {
    ...
    // Act
    GenericResponse actualCheckPasswordResetTokenResult =
        customerServiceImpl.checkPasswordResetToken(" ", new CustomerImpl());
   ...
   *
   * <ul>
   *   <li>Then return ErrorCodesList second is {@code invalidToken}.
   * </ul>
   *
   * <p>Method under test: {@link CustomerServiceImpl#resetPasswordUsingToken(String, String,
   * String, String)}
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSecondIsInvalidToken() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new CustomerServiceImpl().resetPasswordUsingToken(null, " ", "iloveyou", "iloveyou");
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSecondIsPasswordMismatch() {
    ...
    List<String> errorCodesList =
        new CustomerServiceImpl()
            .resetPasswordUsingToken(null, " ", "iloveyou", "invalidCustomer")
            .getErrorCodesList();
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree() {
    // Arrange, Act and Assert
    List<String> errorCodesList =
        new CustomerServiceImpl().resetPasswordUsingToken(null, " ", " ", " ").getErrorCodesList();
    assertEquals(3, errorCodesList.size());
    assertEquals("invalidCustomer", errorCodesList.get(0));
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree2() {
    // Arrange, Act and Assert
    List<String> errorCodesList =
        new CustomerServiceImpl().resetPasswordUsingToken(null, null, " ", " ").getErrorCodesList();
    assertEquals(3, errorCodesList.size());
    assertEquals("invalidCustomer", errorCodesList.get(0));
    assertEquals("invalidPassword", errorCodesList.get(1));
    assertEquals("invalidToken", errorCodesList.get(2));
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsThree3() {
    // Arrange, Act and Assert
    List<String> errorCodesList =
        new CustomerServiceImpl()
            .resetPasswordUsingToken(null, " ", "iloveyou", " ")
            .getErrorCodesList();
    assertEquals(3, errorCodesList.size());
    assertEquals("invalidCustomer", errorCodesList.get(0));
    assertEquals("invalidPassword", errorCodesList.get(1));
  ...
  public void testResetPasswordUsingToken_thenReturnErrorCodesListSizeIsTwo() {
    // Arrange and Act
    GenericResponse actualResetPasswordUsingTokenResult =
        new CustomerServiceImpl().resetPasswordUsingToken(null, "ABC123", " ", " ");
  ...
  public void testCheckPassword_givenCustomerServiceImpl_thenNotGenericResponseHasErrors() {
    // Arrange
    CustomerServiceImpl customerServiceImpl = new CustomerServiceImpl();
    GenericResponse response = new GenericResponse();
