...
public class CustomerUserDetailsDiffblueTest {
   ...
   */
  @Test
  public void testNewCustomerUserDetails() {
    // Arrange and Act
   ...
   */
  @Test
  public void testNewCustomerUserDetails2() {
    // Arrange
   ...
   */
  @Test
  public void testNewCustomerUserDetails3() {
    // Arrange and Act
   ...
   */
  @Test
  public void testNewCustomerUserDetails4() {
    // Arrange
    ArrayList<GrantedAuthority> authorities = new ArrayList<>();
    authorities.add(new SimpleGrantedAuthority("Role"));
    authorities.add(new SimpleGrantedAuthority("Role"));
