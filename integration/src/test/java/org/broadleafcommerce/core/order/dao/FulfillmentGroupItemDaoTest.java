...
public class FulfillmentGroupItemDaoTest extends TestNGSiteIntegrationSetup {
  ...
  public void createFulfillmentGroupItem(DiscreteOrderItem orderItem) throws PricingException {
    ...
    FulfillmentGroupItem fgi =
        fulfillmentGroup
            ...
            .get(fulfillmentGroup.getFulfillmentGroupItems().size() - 1);
  ...
  public void readFulfillmentGroupItemsForFulfillmentGroup() {
    List<FulfillmentGroupItem> fgis =
        fulfillmentGroupItemDao.readFulfillmentGroupItemsForFulfillmentGroup(fulfillmentGroup);
    assert fgis != null;
    assert fgis.size() > 0;
  }
  ...
  public void readFulfillmentGroupItemsById() {
    FulfillmentGroupItem fgi =
        fulfillmentGroupItemDao.readFulfillmentGroupItemById(fulfillmentGroupItemId);
    assert fgi != null;
    assert fgi.getId() != null;
  }
}
