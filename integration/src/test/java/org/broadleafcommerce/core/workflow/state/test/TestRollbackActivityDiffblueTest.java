...
public class TestRollbackActivityDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link TestRollbackActivity}
   */
  @Test(testName = "Test new TestRollbackActivity (default constructor)", groups = "MaintainedByDiffblue")
