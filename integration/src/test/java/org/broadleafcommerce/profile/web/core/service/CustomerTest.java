...
public class CustomerTest extends TestNGSiteIntegrationSetup {
  ...
  public void createCustomerIdGeneration() {
    IdGenerationImpl gen =
        em.find(IdGenerationImpl.class, "org.broadleafcommerce.profile.core.domain.Customer");
    if (gen == null) {
  ...
  @Test(
      groups = {"readCustomer"},
      dependsOnGroups = {"createCustomers", "createCustomerIdGeneration"})
